...
! Auto-generated at 2026-04-28 18:43:09.217401 by ops-translator
SUBROUTINE fincom

  USE ops_fortran_declarations
  USE ops_fortran_rt_support
  USE fincom_kernel_main_module
  ...
  CALL fincom_kernel_main_host("fincom_main", senga_grid, 3, rangexyz, &
