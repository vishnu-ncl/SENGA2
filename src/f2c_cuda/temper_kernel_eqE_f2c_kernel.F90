! Auto-generated at 2026-04-28 18:44:05.338254 by ops-translator
...
SUBROUTINE temper_kernel_eqE_host_c(name, args, nargs, dim, range, block) BIND(C,name='temper_kernel_eqE_host_c')
...
END SUBROUTINE temper_kernel_eqE_host_c
...
SUBROUTINE temper_kernel_eqE_host( userSubroutine, block, dim, range, &
    ...
    CALL temper_kernel_eqE_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    11, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE temper_kernel_eqE_host
