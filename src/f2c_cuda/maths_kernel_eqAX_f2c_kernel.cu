// Auto-generated at 2026-04-28 18:44:04.701442 by ops-translator

__constant__ int dims_maths_kernel_eqAX[9][3];
static int dims_maths_kernel_eqAX_h[9][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void maths_kernel_eqAX_gpu(ACC<double> &out_arr1, ACC<double> &out_arr2, ACC<double> &out_arr3, const ACC<double> &in_arr1, const ACC<double> &in_arr2, const double *racnst, const double *rncnst, const double *reovrr, const double *flcnst) {
...
//  ============================
__global__ void ops_maths_kernel_eqAX(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_maths_kernel_eqAX[0][0] + idx_z * zstride_0 * dims_maths_kernel_eqAX[0][0] * dims_maths_kernel_eqAX[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_maths_kernel_eqAX[1][0] + idx_z * zstride_1 * dims_maths_kernel_eqAX[1][0] * dims_maths_kernel_eqAX[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_maths_kernel_eqAX[2][0] + idx_z * zstride_2 * dims_maths_kernel_eqAX[2][0] * dims_maths_kernel_eqAX[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_maths_kernel_eqAX[3][0] + idx_z * zstride_3 * dims_maths_kernel_eqAX[3][0] * dims_maths_kernel_eqAX[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_maths_kernel_eqAX[4][0] + idx_z * zstride_4 * dims_maths_kernel_eqAX[4][0] * dims_maths_kernel_eqAX[4][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_maths_kernel_eqAX[0][0], dims_maths_kernel_eqAX[0][1], arg0);
        ACC<double> argp1(dims_maths_kernel_eqAX[1][0], dims_maths_kernel_eqAX[1][1], arg1);
        ACC<double> argp2(dims_maths_kernel_eqAX[2][0], dims_maths_kernel_eqAX[2][1], arg2);
        const ACC<double> argp3(dims_maths_kernel_eqAX[3][0], dims_maths_kernel_eqAX[3][1], arg3);
        const ACC<double> argp4(dims_maths_kernel_eqAX[4][0], dims_maths_kernel_eqAX[4][1], arg4);

        maths_kernel_eqAX_gpu(argp0, argp1, argp2, argp3, argp4, &arg5, &arg6, &arg7, &arg8);
...
//  ======================================================
    ...
    if (xdim0 != dims_maths_kernel_eqAX_h[0][0] || ydim0 != dims_maths_kernel_eqAX_h[0][1] || zdim0 != dims_maths_kernel_eqAX_h[0][2] || xdim1 != dims_maths_kernel_eqAX_h[1][0] || ydim1 != dims_maths_kernel_eqAX_h[1][1] || zdim1 != dims_maths_kernel_eqAX_h[1][2] || xdim2 != dims_maths_kernel_eqAX_h[2][0] || ydim2 != dims_maths_kernel_eqAX_h[2][1] || zdim2 != dims_maths_kernel_eqAX_h[2][2] || xdim3 != dims_maths_kernel_eqAX_h[3][0] || ydim3 != dims_maths_kernel_eqAX_h[3][1] || zdim3 != dims_maths_kernel_eqAX_h[3][2] || xdim4 != dims_maths_kernel_eqAX_h[4][0] || ydim4 != dims_maths_kernel_eqAX_h[4][1] || zdim4 != dims_maths_kernel_eqAX_h[4][2]) {
        dims_maths_kernel_eqAX_h[0][0] = xdim0;
        dims_maths_kernel_eqAX_h[0][1] = ydim0;
        dims_maths_kernel_eqAX_h[0][2] = zdim0;
        dims_maths_kernel_eqAX_h[1][0] = xdim1;
        dims_maths_kernel_eqAX_h[1][1] = ydim1;
        dims_maths_kernel_eqAX_h[1][2] = zdim1;
        dims_maths_kernel_eqAX_h[2][0] = xdim2;
        dims_maths_kernel_eqAX_h[2][1] = ydim2;
        dims_maths_kernel_eqAX_h[2][2] = zdim2;
        dims_maths_kernel_eqAX_h[3][0] = xdim3;
        dims_maths_kernel_eqAX_h[3][1] = ydim3;
        dims_maths_kernel_eqAX_h[3][2] = zdim3;
        dims_maths_kernel_eqAX_h[4][0] = xdim4;
        dims_maths_kernel_eqAX_h[4][1] = ydim4;
        dims_maths_kernel_eqAX_h[4][2] = zdim4;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_maths_kernel_eqAX, dims_maths_kernel_eqAX_h, sizeof(dims_maths_kernel_eqAX)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_maths_kernel_eqAX<<<grid, tblock >>> (
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqAX", args, 9, 539, dim, 1, range, block, maths_kernel_eqAX_execute);
}
#endif
