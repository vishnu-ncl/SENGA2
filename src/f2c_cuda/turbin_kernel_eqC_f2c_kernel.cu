// Auto-generated at 2026-04-28 18:44:05.145921 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_turbin_kernel_eqC_h[0][0] || ydim0 != dims_turbin_kernel_eqC_h[0][1] || zdim0 != dims_turbin_kernel_eqC_h[0][2]) {
        ...
        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_turbin_kernel_eqC, dims_turbin_kernel_eqC_h, sizeof(dims_turbin_kernel_eqC)));
    }
