// Auto-generated at 2026-04-28 18:44:05.304022 by ops-translator

__constant__ int dims_temper_kernel_eqD[9][3];
static int dims_temper_kernel_eqD_h[9][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void temper_kernel_eqD_gpu(ACC<double> &trun, const ACC<double> &tcoeff, const ACC<double> &tderiv, const ACC<double> &drhs, const ACC<double> &urhs, const ACC<double> &vrhs, const ACC<double> &wrhs, const ACC<double> &erhs, const int *idx) {
...
int ntitrs = 100;
    ...
    tempor = trun(0, 0, 0);
    ititrs = 1;
    tfpoly = tcoeff(nctmax + 1-1, 0, 0, 0);
    tdpoly = tderiv(nctmax-1, 0, 0, 0);
...
//  ============================
__global__ void ops_temper_kernel_eqD(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_temper_kernel_eqD[0][0] + idx_z * zstride_0 * dims_temper_kernel_eqD[0][0] * dims_temper_kernel_eqD[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_temper_kernel_eqD[1][0] + idx_z * zstride_1 * dims_temper_kernel_eqD[1][0] * dims_temper_kernel_eqD[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_temper_kernel_eqD[2][0] + idx_z * zstride_2 * dims_temper_kernel_eqD[2][0] * dims_temper_kernel_eqD[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_temper_kernel_eqD[3][0] + idx_z * zstride_3 * dims_temper_kernel_eqD[3][0] * dims_temper_kernel_eqD[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_temper_kernel_eqD[4][0] + idx_z * zstride_4 * dims_temper_kernel_eqD[4][0] * dims_temper_kernel_eqD[4][1];
    arg5 += idx_x * xstride_5 + idx_y * ystride_5 * dims_temper_kernel_eqD[5][0] + idx_z * zstride_5 * dims_temper_kernel_eqD[5][0] * dims_temper_kernel_eqD[5][1];
    arg6 += idx_x * xstride_6 + idx_y * ystride_6 * dims_temper_kernel_eqD[6][0] + idx_z * zstride_6 * dims_temper_kernel_eqD[6][0] * dims_temper_kernel_eqD[6][1];
    arg7 += idx_x * xstride_7 + idx_y * ystride_7 * dims_temper_kernel_eqD[7][0] + idx_z * zstride_7 * dims_temper_kernel_eqD[7][0] * dims_temper_kernel_eqD[7][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_temper_kernel_eqD[0][0], dims_temper_kernel_eqD[0][1], arg0);
        const ACC<double> argp1(6, dims_temper_kernel_eqD[1][0], dims_temper_kernel_eqD[1][1], dims_temper_kernel_eqD[1][2], arg1);
        const ACC<double> argp2(5, dims_temper_kernel_eqD[2][0], dims_temper_kernel_eqD[2][1], dims_temper_kernel_eqD[2][2], arg2);
        const ACC<double> argp3(dims_temper_kernel_eqD[3][0], dims_temper_kernel_eqD[3][1], arg3);
        const ACC<double> argp4(dims_temper_kernel_eqD[4][0], dims_temper_kernel_eqD[4][1], arg4);
        const ACC<double> argp5(dims_temper_kernel_eqD[5][0], dims_temper_kernel_eqD[5][1], arg5);
        const ACC<double> argp6(dims_temper_kernel_eqD[6][0], dims_temper_kernel_eqD[6][1], arg6);
        const ACC<double> argp7(dims_temper_kernel_eqD[7][0], dims_temper_kernel_eqD[7][1], arg7);

        temper_kernel_eqD_gpu(argp0, argp1, argp2, argp3, argp4, argp5, argp6, argp7, arg_idx);
...
//  ======================================================
    ...
    if (xdim0 != dims_temper_kernel_eqD_h[0][0] || ydim0 != dims_temper_kernel_eqD_h[0][1] || zdim0 != dims_temper_kernel_eqD_h[0][2] || xdim1 != dims_temper_kernel_eqD_h[1][0] || ydim1 != dims_temper_kernel_eqD_h[1][1] || zdim1 != dims_temper_kernel_eqD_h[1][2] || xdim2 != dims_temper_kernel_eqD_h[2][0] || ydim2 != dims_temper_kernel_eqD_h[2][1] || zdim2 != dims_temper_kernel_eqD_h[2][2] || xdim3 != dims_temper_kernel_eqD_h[3][0] || ydim3 != dims_temper_kernel_eqD_h[3][1] || zdim3 != dims_temper_kernel_eqD_h[3][2] || xdim4 != dims_temper_kernel_eqD_h[4][0] || ydim4 != dims_temper_kernel_eqD_h[4][1] || zdim4 != dims_temper_kernel_eqD_h[4][2] || xdim5 != dims_temper_kernel_eqD_h[5][0] || ydim5 != dims_temper_kernel_eqD_h[5][1] || zdim5 != dims_temper_kernel_eqD_h[5][2] || xdim6 != dims_temper_kernel_eqD_h[6][0] || ydim6 != dims_temper_kernel_eqD_h[6][1] || zdim6 != dims_temper_kernel_eqD_h[6][2] || xdim7 != dims_temper_kernel_eqD_h[7][0] || ydim7 != dims_temper_kernel_eqD_h[7][1] || zdim7 != dims_temper_kernel_eqD_h[7][2]) {
        dims_temper_kernel_eqD_h[0][0] = xdim0;
        dims_temper_kernel_eqD_h[0][1] = ydim0;
        dims_temper_kernel_eqD_h[0][2] = zdim0;
        dims_temper_kernel_eqD_h[1][0] = xdim1;
        dims_temper_kernel_eqD_h[1][1] = ydim1;
        dims_temper_kernel_eqD_h[1][2] = zdim1;
        dims_temper_kernel_eqD_h[2][0] = xdim2;
        dims_temper_kernel_eqD_h[2][1] = ydim2;
        dims_temper_kernel_eqD_h[2][2] = zdim2;
        dims_temper_kernel_eqD_h[3][0] = xdim3;
        dims_temper_kernel_eqD_h[3][1] = ydim3;
        dims_temper_kernel_eqD_h[3][2] = zdim3;
        dims_temper_kernel_eqD_h[4][0] = xdim4;
        dims_temper_kernel_eqD_h[4][1] = ydim4;
        dims_temper_kernel_eqD_h[4][2] = zdim4;
        dims_temper_kernel_eqD_h[5][0] = xdim5;
        dims_temper_kernel_eqD_h[5][1] = ydim5;
        dims_temper_kernel_eqD_h[5][2] = zdim5;
        dims_temper_kernel_eqD_h[6][0] = xdim6;
        dims_temper_kernel_eqD_h[6][1] = ydim6;
        dims_temper_kernel_eqD_h[6][2] = zdim6;
        dims_temper_kernel_eqD_h[7][0] = xdim7;
        dims_temper_kernel_eqD_h[7][1] = ydim7;
        dims_temper_kernel_eqD_h[7][2] = zdim7;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_temper_kernel_eqD, dims_temper_kernel_eqD_h, sizeof(dims_temper_kernel_eqD)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_temper_kernel_eqD<<<grid, tblock >>> (
