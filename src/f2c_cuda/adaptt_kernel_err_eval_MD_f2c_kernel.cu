// Auto-generated at 2026-04-28 18:43:56.247325 by ops-translator
...
//  ==============================
    for(int d = 0; d < 1; d++)
        ops_reduction_cuda<OPS_MAX>(&arg4[d+(blockIdx.x + blockIdx.y*gridDim.x + blockIdx.z*gridDim.x*gridDim.y)*1],arg4_l[d]);
...
//  ======================================================
    ...
    if (xdim0 != dims_adaptt_kernel_err_eval_MD_h[0][0] || ydim0 != dims_adaptt_kernel_err_eval_MD_h[0][1] || zdim0 != dims_adaptt_kernel_err_eval_MD_h[0][2] || xdim1 != dims_adaptt_kernel_err_eval_MD_h[1][0] || ydim1 != dims_adaptt_kernel_err_eval_MD_h[1][1] || zdim1 != dims_adaptt_kernel_err_eval_MD_h[1][2]) {
        ...
        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_adaptt_kernel_err_eval_MD, dims_adaptt_kernel_err_eval_MD_h, sizeof(dims_adaptt_kernel_err_eval_MD)));
    }
