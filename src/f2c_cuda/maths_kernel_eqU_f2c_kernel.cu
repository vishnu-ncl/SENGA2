// Auto-generated at 2026-04-28 18:44:04.980409 by ops-translator

__constant__ int dims_maths_kernel_eqU[3][3];
static int dims_maths_kernel_eqU_h[3][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void maths_kernel_eqU_gpu(ACC<double> &out_arr, const ACC<double> &in_arr1, const ACC<double> &in_arr2) {
...
//  ============================
__global__ void ops_maths_kernel_eqU(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_maths_kernel_eqU[0][0] + idx_z * zstride_0 * dims_maths_kernel_eqU[0][0] * dims_maths_kernel_eqU[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_maths_kernel_eqU[1][0] + idx_z * zstride_1 * dims_maths_kernel_eqU[1][0] * dims_maths_kernel_eqU[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_maths_kernel_eqU[2][0] + idx_z * zstride_2 * dims_maths_kernel_eqU[2][0] * dims_maths_kernel_eqU[2][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_maths_kernel_eqU[0][0], dims_maths_kernel_eqU[0][1], arg0);
        const ACC<double> argp1(dims_maths_kernel_eqU[1][0], dims_maths_kernel_eqU[1][1], arg1);
        const ACC<double> argp2(dims_maths_kernel_eqU[2][0], dims_maths_kernel_eqU[2][1], arg2);

        maths_kernel_eqU_gpu(argp0, argp1, argp2);
...
//  ======================================================
    ...
    if (xdim0 != dims_maths_kernel_eqU_h[0][0] || ydim0 != dims_maths_kernel_eqU_h[0][1] || zdim0 != dims_maths_kernel_eqU_h[0][2] || xdim1 != dims_maths_kernel_eqU_h[1][0] || ydim1 != dims_maths_kernel_eqU_h[1][1] || zdim1 != dims_maths_kernel_eqU_h[1][2] || xdim2 != dims_maths_kernel_eqU_h[2][0] || ydim2 != dims_maths_kernel_eqU_h[2][1] || zdim2 != dims_maths_kernel_eqU_h[2][2]) {
        dims_maths_kernel_eqU_h[0][0] = xdim0;
        dims_maths_kernel_eqU_h[0][1] = ydim0;
        dims_maths_kernel_eqU_h[0][2] = zdim0;
        dims_maths_kernel_eqU_h[1][0] = xdim1;
        dims_maths_kernel_eqU_h[1][1] = ydim1;
        dims_maths_kernel_eqU_h[1][2] = zdim1;
        dims_maths_kernel_eqU_h[2][0] = xdim2;
        dims_maths_kernel_eqU_h[2][1] = ydim2;
        dims_maths_kernel_eqU_h[2][2] = zdim2;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_maths_kernel_eqU, dims_maths_kernel_eqU_h, sizeof(dims_maths_kernel_eqU)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_maths_kernel_eqU<<<grid, tblock >>> (
