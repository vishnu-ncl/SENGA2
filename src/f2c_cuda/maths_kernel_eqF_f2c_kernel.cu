// Auto-generated at 2026-04-28 18:44:04.914595 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_maths_kernel_eqF_h[0][0] || ydim0 != dims_maths_kernel_eqF_h[0][1] || zdim0 != dims_maths_kernel_eqF_h[0][2]) {
        ...
        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_maths_kernel_eqF, dims_maths_kernel_eqF_h, sizeof(dims_maths_kernel_eqF)));
    }
