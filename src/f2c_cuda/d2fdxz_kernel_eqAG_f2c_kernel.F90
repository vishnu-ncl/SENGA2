! Auto-generated at 2026-04-28 18:43:48.981967 by ops-translator
...
SUBROUTINE d2fdxz_kernel_eqAG_host_c(name, args, nargs, dim, range, block) BIND(C,name='d2fdxz_kernel_eqAG_host_c')
...
END SUBROUTINE d2fdxz_kernel_eqAG_host_c
...
SUBROUTINE d2fdxz_kernel_eqAG_host( userSubroutine, block, dim, range, &
    ...
    CALL d2fdxz_kernel_eqAG_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE d2fdxz_kernel_eqAG_host
