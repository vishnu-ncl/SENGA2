// Auto-generated at 2026-04-28 18:44:04.413330 by ops-translator

__constant__ int dims_boundt_kernel_eqF_ydir[14][3];
static int dims_boundt_kernel_eqF_ydir_h[14][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void boundt_kernel_eqF_ydir_gpu(ACC<double> &erhs, ACC<double> &yrhs, const ACC<int> &itndex, const ACC<double> &drhs, const ACC<double> &strty, const ACC<double> &stryy, const double *amasch, const double *rgspec, const int *ncpoly, const int *ncpom1, const int *ncenth, const int *ispec, const int *icoef1, const int *icoef2) {
...
//  ============================
__global__ void ops_boundt_kernel_eqF_ydir(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_boundt_kernel_eqF_ydir[0][0] + idx_z * zstride_0 * dims_boundt_kernel_eqF_ydir[0][0] * dims_boundt_kernel_eqF_ydir[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_boundt_kernel_eqF_ydir[1][0] + idx_z * zstride_1 * dims_boundt_kernel_eqF_ydir[1][0] * dims_boundt_kernel_eqF_ydir[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_boundt_kernel_eqF_ydir[2][0] + idx_z * zstride_2 * dims_boundt_kernel_eqF_ydir[2][0] * dims_boundt_kernel_eqF_ydir[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_boundt_kernel_eqF_ydir[3][0] + idx_z * zstride_3 * dims_boundt_kernel_eqF_ydir[3][0] * dims_boundt_kernel_eqF_ydir[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_boundt_kernel_eqF_ydir[4][0] + idx_z * zstride_4 * dims_boundt_kernel_eqF_ydir[4][0] * dims_boundt_kernel_eqF_ydir[4][1];
    arg5 += idx_x * xstride_5 + idx_y * ystride_5 * dims_boundt_kernel_eqF_ydir[5][0] + idx_z * zstride_5 * dims_boundt_kernel_eqF_ydir[5][0] * dims_boundt_kernel_eqF_ydir[5][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_boundt_kernel_eqF_ydir[0][0], dims_boundt_kernel_eqF_ydir[0][1], arg0);
        ACC<double> argp1(dims_boundt_kernel_eqF_ydir[1][0], dims_boundt_kernel_eqF_ydir[1][1], arg1);
        const ACC<int> argp2(dims_boundt_kernel_eqF_ydir[2][0], dims_boundt_kernel_eqF_ydir[2][1], arg2);
        const ACC<double> argp3(dims_boundt_kernel_eqF_ydir[3][0], dims_boundt_kernel_eqF_ydir[3][1], arg3);
        const ACC<double> argp4(dims_boundt_kernel_eqF_ydir[4][0], dims_boundt_kernel_eqF_ydir[4][1], arg4);
        const ACC<double> argp5(dims_boundt_kernel_eqF_ydir[5][0], dims_boundt_kernel_eqF_ydir[5][1], arg5);

        boundt_kernel_eqF_ydir_gpu(argp0, argp1, argp2, argp3, argp4, argp5, arg6, arg7, arg8, arg9, arg10, &arg11, &arg12, &arg13);
...
//  ======================================================
    ...
    if (xdim0 != dims_boundt_kernel_eqF_ydir_h[0][0] || ydim0 != dims_boundt_kernel_eqF_ydir_h[0][1] || zdim0 != dims_boundt_kernel_eqF_ydir_h[0][2] || xdim1 != dims_boundt_kernel_eqF_ydir_h[1][0] || ydim1 != dims_boundt_kernel_eqF_ydir_h[1][1] || zdim1 != dims_boundt_kernel_eqF_ydir_h[1][2] || xdim2 != dims_boundt_kernel_eqF_ydir_h[2][0] || ydim2 != dims_boundt_kernel_eqF_ydir_h[2][1] || zdim2 != dims_boundt_kernel_eqF_ydir_h[2][2] || xdim3 != dims_boundt_kernel_eqF_ydir_h[3][0] || ydim3 != dims_boundt_kernel_eqF_ydir_h[3][1] || zdim3 != dims_boundt_kernel_eqF_ydir_h[3][2] || xdim4 != dims_boundt_kernel_eqF_ydir_h[4][0] || ydim4 != dims_boundt_kernel_eqF_ydir_h[4][1] || zdim4 != dims_boundt_kernel_eqF_ydir_h[4][2] || xdim5 != dims_boundt_kernel_eqF_ydir_h[5][0] || ydim5 != dims_boundt_kernel_eqF_ydir_h[5][1] || zdim5 != dims_boundt_kernel_eqF_ydir_h[5][2]) {
        dims_boundt_kernel_eqF_ydir_h[0][0] = xdim0;
        dims_boundt_kernel_eqF_ydir_h[0][1] = ydim0;
        dims_boundt_kernel_eqF_ydir_h[0][2] = zdim0;
        dims_boundt_kernel_eqF_ydir_h[1][0] = xdim1;
        dims_boundt_kernel_eqF_ydir_h[1][1] = ydim1;
        dims_boundt_kernel_eqF_ydir_h[1][2] = zdim1;
        dims_boundt_kernel_eqF_ydir_h[2][0] = xdim2;
        dims_boundt_kernel_eqF_ydir_h[2][1] = ydim2;
        dims_boundt_kernel_eqF_ydir_h[2][2] = zdim2;
        dims_boundt_kernel_eqF_ydir_h[3][0] = xdim3;
        dims_boundt_kernel_eqF_ydir_h[3][1] = ydim3;
        dims_boundt_kernel_eqF_ydir_h[3][2] = zdim3;
        dims_boundt_kernel_eqF_ydir_h[4][0] = xdim4;
        dims_boundt_kernel_eqF_ydir_h[4][1] = ydim4;
        dims_boundt_kernel_eqF_ydir_h[4][2] = zdim4;
        dims_boundt_kernel_eqF_ydir_h[5][0] = xdim5;
        dims_boundt_kernel_eqF_ydir_h[5][1] = ydim5;
        dims_boundt_kernel_eqF_ydir_h[5][2] = zdim5;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_boundt_kernel_eqF_ydir, dims_boundt_kernel_eqF_ydir_h, sizeof(dims_boundt_kernel_eqF_ydir)));
    }
...
//  =======================
    ...
    double * __restrict__ stryy_p = (double *)(args[5].data_d) + base5 - 1; // Subtracting 1 to convert to C-style
    p_a[5] = (char *)stryy_p;
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_boundt_kernel_eqF_ydir<<<grid, tblock >>> (
    ...
    )
{
    ...
    create_kerneldesc_and_enque("boundt_kernel_eqF_ydir", args, 14, 526, dim, 1, range, block, boundt_kernel_eqF_ydir_execute);
}
#endif
