! Auto-generated at 2026-04-28 18:43:54.759337 by ops-translator
...
SUBROUTINE hf_kernel_eqN_host_c(name, args, nargs, dim, range, block) BIND(C,name='hf_kernel_eqN_host_c')
...
END SUBROUTINE hf_kernel_eqN_host_c
...
SUBROUTINE hf_kernel_eqN_host( userSubroutine, block, dim, range, &
    ...
    CALL hf_kernel_eqN_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    10, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE hf_kernel_eqN_host
