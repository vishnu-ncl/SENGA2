// Auto-generated at 2026-04-28 18:44:00.071919 by ops-translator

__constant__ int dims_bounds_kernel_eqW_yl[8][3];
static int dims_bounds_kernel_eqW_yl_h[8][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void bounds_kernel_eqW_yl_gpu(ACC<double> &drhs, ACC<double> &urhs, ACC<double> &vrhs, ACC<double> &wrhs, ACC<double> &erhs, const ACC<double> &bcl2yl, const ACC<double> &bcl5yl, const ACC<double> &ova2yl) {
...
//  ============================
__global__ void ops_bounds_kernel_eqW_yl(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_bounds_kernel_eqW_yl[0][0] + idx_z * zstride_0 * dims_bounds_kernel_eqW_yl[0][0] * dims_bounds_kernel_eqW_yl[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_bounds_kernel_eqW_yl[1][0] + idx_z * zstride_1 * dims_bounds_kernel_eqW_yl[1][0] * dims_bounds_kernel_eqW_yl[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_bounds_kernel_eqW_yl[2][0] + idx_z * zstride_2 * dims_bounds_kernel_eqW_yl[2][0] * dims_bounds_kernel_eqW_yl[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_bounds_kernel_eqW_yl[3][0] + idx_z * zstride_3 * dims_bounds_kernel_eqW_yl[3][0] * dims_bounds_kernel_eqW_yl[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_bounds_kernel_eqW_yl[4][0] + idx_z * zstride_4 * dims_bounds_kernel_eqW_yl[4][0] * dims_bounds_kernel_eqW_yl[4][1];
    arg5 += idx_x * xstride_5 + idx_y * ystride_5 * dims_bounds_kernel_eqW_yl[5][0] + idx_z * zstride_5 * dims_bounds_kernel_eqW_yl[5][0] * dims_bounds_kernel_eqW_yl[5][1];
    arg6 += idx_x * xstride_6 + idx_y * ystride_6 * dims_bounds_kernel_eqW_yl[6][0] + idx_z * zstride_6 * dims_bounds_kernel_eqW_yl[6][0] * dims_bounds_kernel_eqW_yl[6][1];
    arg7 += idx_x * xstride_7 + idx_y * ystride_7 * dims_bounds_kernel_eqW_yl[7][0] + idx_z * zstride_7 * dims_bounds_kernel_eqW_yl[7][0] * dims_bounds_kernel_eqW_yl[7][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_bounds_kernel_eqW_yl[0][0], dims_bounds_kernel_eqW_yl[0][1], arg0);
        ACC<double> argp1(dims_bounds_kernel_eqW_yl[1][0], dims_bounds_kernel_eqW_yl[1][1], arg1);
        ACC<double> argp2(dims_bounds_kernel_eqW_yl[2][0], dims_bounds_kernel_eqW_yl[2][1], arg2);
        ACC<double> argp3(dims_bounds_kernel_eqW_yl[3][0], dims_bounds_kernel_eqW_yl[3][1], arg3);
        ACC<double> argp4(dims_bounds_kernel_eqW_yl[4][0], dims_bounds_kernel_eqW_yl[4][1], arg4);
        const ACC<double> argp5(dims_bounds_kernel_eqW_yl[5][0], dims_bounds_kernel_eqW_yl[5][1], arg5);
        const ACC<double> argp6(dims_bounds_kernel_eqW_yl[6][0], dims_bounds_kernel_eqW_yl[6][1], arg6);
        const ACC<double> argp7(dims_bounds_kernel_eqW_yl[7][0], dims_bounds_kernel_eqW_yl[7][1], arg7);

        bounds_kernel_eqW_yl_gpu(argp0, argp1, argp2, argp3, argp4, argp5, argp6, argp7);
...
//  ======================================================
    ...
    if (xdim0 != dims_bounds_kernel_eqW_yl_h[0][0] || ydim0 != dims_bounds_kernel_eqW_yl_h[0][1] || zdim0 != dims_bounds_kernel_eqW_yl_h[0][2] || xdim1 != dims_bounds_kernel_eqW_yl_h[1][0] || ydim1 != dims_bounds_kernel_eqW_yl_h[1][1] || zdim1 != dims_bounds_kernel_eqW_yl_h[1][2] || xdim2 != dims_bounds_kernel_eqW_yl_h[2][0] || ydim2 != dims_bounds_kernel_eqW_yl_h[2][1] || zdim2 != dims_bounds_kernel_eqW_yl_h[2][2] || xdim3 != dims_bounds_kernel_eqW_yl_h[3][0] || ydim3 != dims_bounds_kernel_eqW_yl_h[3][1] || zdim3 != dims_bounds_kernel_eqW_yl_h[3][2] || xdim4 != dims_bounds_kernel_eqW_yl_h[4][0] || ydim4 != dims_bounds_kernel_eqW_yl_h[4][1] || zdim4 != dims_bounds_kernel_eqW_yl_h[4][2] || xdim5 != dims_bounds_kernel_eqW_yl_h[5][0] || ydim5 != dims_bounds_kernel_eqW_yl_h[5][1] || zdim5 != dims_bounds_kernel_eqW_yl_h[5][2] || xdim6 != dims_bounds_kernel_eqW_yl_h[6][0] || ydim6 != dims_bounds_kernel_eqW_yl_h[6][1] || zdim6 != dims_bounds_kernel_eqW_yl_h[6][2] || xdim7 != dims_bounds_kernel_eqW_yl_h[7][0] || ydim7 != dims_bounds_kernel_eqW_yl_h[7][1] || zdim7 != dims_bounds_kernel_eqW_yl_h[7][2]) {
        dims_bounds_kernel_eqW_yl_h[0][0] = xdim0;
        dims_bounds_kernel_eqW_yl_h[0][1] = ydim0;
        dims_bounds_kernel_eqW_yl_h[0][2] = zdim0;
        dims_bounds_kernel_eqW_yl_h[1][0] = xdim1;
        dims_bounds_kernel_eqW_yl_h[1][1] = ydim1;
        dims_bounds_kernel_eqW_yl_h[1][2] = zdim1;
        dims_bounds_kernel_eqW_yl_h[2][0] = xdim2;
        dims_bounds_kernel_eqW_yl_h[2][1] = ydim2;
        dims_bounds_kernel_eqW_yl_h[2][2] = zdim2;
        dims_bounds_kernel_eqW_yl_h[3][0] = xdim3;
        dims_bounds_kernel_eqW_yl_h[3][1] = ydim3;
        dims_bounds_kernel_eqW_yl_h[3][2] = zdim3;
        dims_bounds_kernel_eqW_yl_h[4][0] = xdim4;
        dims_bounds_kernel_eqW_yl_h[4][1] = ydim4;
        dims_bounds_kernel_eqW_yl_h[4][2] = zdim4;
        dims_bounds_kernel_eqW_yl_h[5][0] = xdim5;
        dims_bounds_kernel_eqW_yl_h[5][1] = ydim5;
        dims_bounds_kernel_eqW_yl_h[5][2] = zdim5;
        dims_bounds_kernel_eqW_yl_h[6][0] = xdim6;
        dims_bounds_kernel_eqW_yl_h[6][1] = ydim6;
        dims_bounds_kernel_eqW_yl_h[6][2] = zdim6;
        dims_bounds_kernel_eqW_yl_h[7][0] = xdim7;
        dims_bounds_kernel_eqW_yl_h[7][1] = ydim7;
        dims_bounds_kernel_eqW_yl_h[7][2] = zdim7;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_bounds_kernel_eqW_yl, dims_bounds_kernel_eqW_yl_h, sizeof(dims_bounds_kernel_eqW_yl)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_bounds_kernel_eqW_yl<<<grid, tblock >>> (
