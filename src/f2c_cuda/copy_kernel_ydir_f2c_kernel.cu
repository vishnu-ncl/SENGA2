// Auto-generated at 2026-04-28 18:43:53.857442 by ops-translator

__constant__ int dims_copy_kernel_ydir[2][3];
static int dims_copy_kernel_ydir_h[2][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void copy_kernel_ydir_gpu(ACC<double> &out_arr, const ACC<double> &in_arr) {
...
//  ============================
__global__ void ops_copy_kernel_ydir(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_copy_kernel_ydir[0][0] + idx_z * zstride_0 * dims_copy_kernel_ydir[0][0] * dims_copy_kernel_ydir[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_copy_kernel_ydir[1][0] + idx_z * zstride_1 * dims_copy_kernel_ydir[1][0] * dims_copy_kernel_ydir[1][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_copy_kernel_ydir[0][0], dims_copy_kernel_ydir[0][1], arg0);
        const ACC<double> argp1(dims_copy_kernel_ydir[1][0], dims_copy_kernel_ydir[1][1], arg1);

        copy_kernel_ydir_gpu(argp0, argp1);
...
//  ======================================================
    ...
    if (xdim0 != dims_copy_kernel_ydir_h[0][0] || ydim0 != dims_copy_kernel_ydir_h[0][1] || zdim0 != dims_copy_kernel_ydir_h[0][2] || xdim1 != dims_copy_kernel_ydir_h[1][0] || ydim1 != dims_copy_kernel_ydir_h[1][1] || zdim1 != dims_copy_kernel_ydir_h[1][2]) {
        dims_copy_kernel_ydir_h[0][0] = xdim0;
        dims_copy_kernel_ydir_h[0][1] = ydim0;
        dims_copy_kernel_ydir_h[0][2] = zdim0;
        dims_copy_kernel_ydir_h[1][0] = xdim1;
        dims_copy_kernel_ydir_h[1][1] = ydim1;
        dims_copy_kernel_ydir_h[1][2] = zdim1;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_copy_kernel_ydir, dims_copy_kernel_ydir_h, sizeof(dims_copy_kernel_ydir)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_copy_kernel_ydir<<<grid, tblock >>> (
    ...
    )
{
    ...
    create_kerneldesc_and_enque("copy_kernel_ydir", args, 2, 224, dim, 1, range, block, copy_kernel_ydir_execute);
}
#endif
