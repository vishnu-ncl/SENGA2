// Auto-generated at 2026-04-28 18:43:56.472910 by ops-translator

__constant__ int dims_bcut_kernel_xdir_eqI[18][3];
static int dims_bcut_kernel_xdir_eqI_h[18][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void bcut_kernel_xdir_eqI_gpu(ACC<double> &strux, ACC<double> &strvx, ACC<double> &strwx, ACC<double> &dudtx, ACC<double> &dvdtx, ACC<double> &dwdtx, const ACC<double> &ustead, const ACC<double> &uinf1, const ACC<double> &vinf1, const ACC<double> &winf1, const ACC<double> &uinf2, const ACC<double> &vinf2, const ACC<double> &winf2, const double *rxlprm_1, const double *vfac, const double *coflow, const double *tstep, const double *dvfdt) {
...
//  ============================
__global__ void ops_bcut_kernel_xdir_eqI(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_bcut_kernel_xdir_eqI[0][0] + idx_z * zstride_0 * dims_bcut_kernel_xdir_eqI[0][0] * dims_bcut_kernel_xdir_eqI[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_bcut_kernel_xdir_eqI[1][0] + idx_z * zstride_1 * dims_bcut_kernel_xdir_eqI[1][0] * dims_bcut_kernel_xdir_eqI[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_bcut_kernel_xdir_eqI[2][0] + idx_z * zstride_2 * dims_bcut_kernel_xdir_eqI[2][0] * dims_bcut_kernel_xdir_eqI[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_bcut_kernel_xdir_eqI[3][0] + idx_z * zstride_3 * dims_bcut_kernel_xdir_eqI[3][0] * dims_bcut_kernel_xdir_eqI[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_bcut_kernel_xdir_eqI[4][0] + idx_z * zstride_4 * dims_bcut_kernel_xdir_eqI[4][0] * dims_bcut_kernel_xdir_eqI[4][1];
    arg5 += idx_x * xstride_5 + idx_y * ystride_5 * dims_bcut_kernel_xdir_eqI[5][0] + idx_z * zstride_5 * dims_bcut_kernel_xdir_eqI[5][0] * dims_bcut_kernel_xdir_eqI[5][1];
    arg6 += idx_x * xstride_6 + idx_y * ystride_6 * dims_bcut_kernel_xdir_eqI[6][0] + idx_z * zstride_6 * dims_bcut_kernel_xdir_eqI[6][0] * dims_bcut_kernel_xdir_eqI[6][1];
    arg7 += idx_x * xstride_7 + idx_y * ystride_7 * dims_bcut_kernel_xdir_eqI[7][0] + idx_z * zstride_7 * dims_bcut_kernel_xdir_eqI[7][0] * dims_bcut_kernel_xdir_eqI[7][1];
    arg8 += idx_x * xstride_8 + idx_y * ystride_8 * dims_bcut_kernel_xdir_eqI[8][0] + idx_z * zstride_8 * dims_bcut_kernel_xdir_eqI[8][0] * dims_bcut_kernel_xdir_eqI[8][1];
    arg9 += idx_x * xstride_9 + idx_y * ystride_9 * dims_bcut_kernel_xdir_eqI[9][0] + idx_z * zstride_9 * dims_bcut_kernel_xdir_eqI[9][0] * dims_bcut_kernel_xdir_eqI[9][1];
    arg10 += idx_x * xstride_10 + idx_y * ystride_10 * dims_bcut_kernel_xdir_eqI[10][0] + idx_z * zstride_10 * dims_bcut_kernel_xdir_eqI[10][0] * dims_bcut_kernel_xdir_eqI[10][1];
    arg11 += idx_x * xstride_11 + idx_y * ystride_11 * dims_bcut_kernel_xdir_eqI[11][0] + idx_z * zstride_11 * dims_bcut_kernel_xdir_eqI[11][0] * dims_bcut_kernel_xdir_eqI[11][1];
    arg12 += idx_x * xstride_12 + idx_y * ystride_12 * dims_bcut_kernel_xdir_eqI[12][0] + idx_z * zstride_12 * dims_bcut_kernel_xdir_eqI[12][0] * dims_bcut_kernel_xdir_eqI[12][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_bcut_kernel_xdir_eqI[0][0], dims_bcut_kernel_xdir_eqI[0][1], arg0);
        ACC<double> argp1(dims_bcut_kernel_xdir_eqI[1][0], dims_bcut_kernel_xdir_eqI[1][1], arg1);
        ACC<double> argp2(dims_bcut_kernel_xdir_eqI[2][0], dims_bcut_kernel_xdir_eqI[2][1], arg2);
        ACC<double> argp3(dims_bcut_kernel_xdir_eqI[3][0], dims_bcut_kernel_xdir_eqI[3][1], arg3);
        ACC<double> argp4(dims_bcut_kernel_xdir_eqI[4][0], dims_bcut_kernel_xdir_eqI[4][1], arg4);
        ACC<double> argp5(dims_bcut_kernel_xdir_eqI[5][0], dims_bcut_kernel_xdir_eqI[5][1], arg5);
        const ACC<double> argp6(dims_bcut_kernel_xdir_eqI[6][0], dims_bcut_kernel_xdir_eqI[6][1], arg6);
        const ACC<double> argp7(dims_bcut_kernel_xdir_eqI[7][0], dims_bcut_kernel_xdir_eqI[7][1], arg7);
        const ACC<double> argp8(dims_bcut_kernel_xdir_eqI[8][0], dims_bcut_kernel_xdir_eqI[8][1], arg8);
        const ACC<double> argp9(dims_bcut_kernel_xdir_eqI[9][0], dims_bcut_kernel_xdir_eqI[9][1], arg9);
        const ACC<double> argp10(dims_bcut_kernel_xdir_eqI[10][0], dims_bcut_kernel_xdir_eqI[10][1], arg10);
        const ACC<double> argp11(dims_bcut_kernel_xdir_eqI[11][0], dims_bcut_kernel_xdir_eqI[11][1], arg11);
        const ACC<double> argp12(dims_bcut_kernel_xdir_eqI[12][0], dims_bcut_kernel_xdir_eqI[12][1], arg12);

        bcut_kernel_xdir_eqI_gpu(argp0, argp1, argp2, argp3, argp4, argp5, argp6, argp7, argp8, argp9, argp10, argp11, argp12, &arg13, &arg14, &arg15, &arg16, &arg17);
...
//  ======================================================
    ...
    if (xdim0 != dims_bcut_kernel_xdir_eqI_h[0][0] || ydim0 != dims_bcut_kernel_xdir_eqI_h[0][1] || zdim0 != dims_bcut_kernel_xdir_eqI_h[0][2] || xdim1 != dims_bcut_kernel_xdir_eqI_h[1][0] || ydim1 != dims_bcut_kernel_xdir_eqI_h[1][1] || zdim1 != dims_bcut_kernel_xdir_eqI_h[1][2] || xdim2 != dims_bcut_kernel_xdir_eqI_h[2][0] || ydim2 != dims_bcut_kernel_xdir_eqI_h[2][1] || zdim2 != dims_bcut_kernel_xdir_eqI_h[2][2] || xdim3 != dims_bcut_kernel_xdir_eqI_h[3][0] || ydim3 != dims_bcut_kernel_xdir_eqI_h[3][1] || zdim3 != dims_bcut_kernel_xdir_eqI_h[3][2] || xdim4 != dims_bcut_kernel_xdir_eqI_h[4][0] || ydim4 != dims_bcut_kernel_xdir_eqI_h[4][1] || zdim4 != dims_bcut_kernel_xdir_eqI_h[4][2] || xdim5 != dims_bcut_kernel_xdir_eqI_h[5][0] || ydim5 != dims_bcut_kernel_xdir_eqI_h[5][1] || zdim5 != dims_bcut_kernel_xdir_eqI_h[5][2] || xdim6 != dims_bcut_kernel_xdir_eqI_h[6][0] || ydim6 != dims_bcut_kernel_xdir_eqI_h[6][1] || zdim6 != dims_bcut_kernel_xdir_eqI_h[6][2] || xdim7 != dims_bcut_kernel_xdir_eqI_h[7][0] || ydim7 != dims_bcut_kernel_xdir_eqI_h[7][1] || zdim7 != dims_bcut_kernel_xdir_eqI_h[7][2] || xdim8 != dims_bcut_kernel_xdir_eqI_h[8][0] || ydim8 != dims_bcut_kernel_xdir_eqI_h[8][1] || zdim8 != dims_bcut_kernel_xdir_eqI_h[8][2] || xdim9 != dims_bcut_kernel_xdir_eqI_h[9][0] || ydim9 != dims_bcut_kernel_xdir_eqI_h[9][1] || zdim9 != dims_bcut_kernel_xdir_eqI_h[9][2] || xdim10 != dims_bcut_kernel_xdir_eqI_h[10][0] || ydim10 != dims_bcut_kernel_xdir_eqI_h[10][1] || zdim10 != dims_bcut_kernel_xdir_eqI_h[10][2] || xdim11 != dims_bcut_kernel_xdir_eqI_h[11][0] || ydim11 != dims_bcut_kernel_xdir_eqI_h[11][1] || zdim11 != dims_bcut_kernel_xdir_eqI_h[11][2] || xdim12 != dims_bcut_kernel_xdir_eqI_h[12][0] || ydim12 != dims_bcut_kernel_xdir_eqI_h[12][1] || zdim12 != dims_bcut_kernel_xdir_eqI_h[12][2]) {
        dims_bcut_kernel_xdir_eqI_h[0][0] = xdim0;
        dims_bcut_kernel_xdir_eqI_h[0][1] = ydim0;
        dims_bcut_kernel_xdir_eqI_h[0][2] = zdim0;
        dims_bcut_kernel_xdir_eqI_h[1][0] = xdim1;
        dims_bcut_kernel_xdir_eqI_h[1][1] = ydim1;
        dims_bcut_kernel_xdir_eqI_h[1][2] = zdim1;
        dims_bcut_kernel_xdir_eqI_h[2][0] = xdim2;
        dims_bcut_kernel_xdir_eqI_h[2][1] = ydim2;
        dims_bcut_kernel_xdir_eqI_h[2][2] = zdim2;
        dims_bcut_kernel_xdir_eqI_h[3][0] = xdim3;
        dims_bcut_kernel_xdir_eqI_h[3][1] = ydim3;
        dims_bcut_kernel_xdir_eqI_h[3][2] = zdim3;
        dims_bcut_kernel_xdir_eqI_h[4][0] = xdim4;
        dims_bcut_kernel_xdir_eqI_h[4][1] = ydim4;
        dims_bcut_kernel_xdir_eqI_h[4][2] = zdim4;
        dims_bcut_kernel_xdir_eqI_h[5][0] = xdim5;
        dims_bcut_kernel_xdir_eqI_h[5][1] = ydim5;
        dims_bcut_kernel_xdir_eqI_h[5][2] = zdim5;
        dims_bcut_kernel_xdir_eqI_h[6][0] = xdim6;
        dims_bcut_kernel_xdir_eqI_h[6][1] = ydim6;
        dims_bcut_kernel_xdir_eqI_h[6][2] = zdim6;
        dims_bcut_kernel_xdir_eqI_h[7][0] = xdim7;
        dims_bcut_kernel_xdir_eqI_h[7][1] = ydim7;
        dims_bcut_kernel_xdir_eqI_h[7][2] = zdim7;
        dims_bcut_kernel_xdir_eqI_h[8][0] = xdim8;
        dims_bcut_kernel_xdir_eqI_h[8][1] = ydim8;
        dims_bcut_kernel_xdir_eqI_h[8][2] = zdim8;
        dims_bcut_kernel_xdir_eqI_h[9][0] = xdim9;
        dims_bcut_kernel_xdir_eqI_h[9][1] = ydim9;
        dims_bcut_kernel_xdir_eqI_h[9][2] = zdim9;
        dims_bcut_kernel_xdir_eqI_h[10][0] = xdim10;
        dims_bcut_kernel_xdir_eqI_h[10][1] = ydim10;
        dims_bcut_kernel_xdir_eqI_h[10][2] = zdim10;
        dims_bcut_kernel_xdir_eqI_h[11][0] = xdim11;
        dims_bcut_kernel_xdir_eqI_h[11][1] = ydim11;
        dims_bcut_kernel_xdir_eqI_h[11][2] = zdim11;
        dims_bcut_kernel_xdir_eqI_h[12][0] = xdim12;
        dims_bcut_kernel_xdir_eqI_h[12][1] = ydim12;
        dims_bcut_kernel_xdir_eqI_h[12][2] = zdim12;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_bcut_kernel_xdir_eqI, dims_bcut_kernel_xdir_eqI_h, sizeof(dims_bcut_kernel_xdir_eqI)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_bcut_kernel_xdir_eqI<<<grid, tblock >>> (
