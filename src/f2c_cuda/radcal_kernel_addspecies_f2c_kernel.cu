// Auto-generated at 2026-04-28 18:44:04.615550 by ops-translator

__constant__ int dims_radcal_kernel_addspecies[6][3];
static int dims_radcal_kernel_addspecies_h[6][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void radcal_kernel_addspecies_gpu(ACC<double> &store1, const ACC<double> &yrhs, const ACC<double> &trun, const ACC<double> &store2, const double *rgspec, const int *ispec) {
...
//  ============================
__global__ void ops_radcal_kernel_addspecies(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_radcal_kernel_addspecies[0][0] + idx_z * zstride_0 * dims_radcal_kernel_addspecies[0][0] * dims_radcal_kernel_addspecies[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_radcal_kernel_addspecies[1][0] + idx_z * zstride_1 * dims_radcal_kernel_addspecies[1][0] * dims_radcal_kernel_addspecies[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_radcal_kernel_addspecies[2][0] + idx_z * zstride_2 * dims_radcal_kernel_addspecies[2][0] * dims_radcal_kernel_addspecies[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_radcal_kernel_addspecies[3][0] + idx_z * zstride_3 * dims_radcal_kernel_addspecies[3][0] * dims_radcal_kernel_addspecies[3][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_radcal_kernel_addspecies[0][0], dims_radcal_kernel_addspecies[0][1], arg0);
        const ACC<double> argp1(dims_radcal_kernel_addspecies[1][0], dims_radcal_kernel_addspecies[1][1], arg1);
        const ACC<double> argp2(dims_radcal_kernel_addspecies[2][0], dims_radcal_kernel_addspecies[2][1], arg2);
        const ACC<double> argp3(dims_radcal_kernel_addspecies[3][0], dims_radcal_kernel_addspecies[3][1], arg3);

        radcal_kernel_addspecies_gpu(argp0, argp1, argp2, argp3, arg4, &arg5);
...
//  ======================================================
    ...
    if (xdim0 != dims_radcal_kernel_addspecies_h[0][0] || ydim0 != dims_radcal_kernel_addspecies_h[0][1] || zdim0 != dims_radcal_kernel_addspecies_h[0][2] || xdim1 != dims_radcal_kernel_addspecies_h[1][0] || ydim1 != dims_radcal_kernel_addspecies_h[1][1] || zdim1 != dims_radcal_kernel_addspecies_h[1][2] || xdim2 != dims_radcal_kernel_addspecies_h[2][0] || ydim2 != dims_radcal_kernel_addspecies_h[2][1] || zdim2 != dims_radcal_kernel_addspecies_h[2][2] || xdim3 != dims_radcal_kernel_addspecies_h[3][0] || ydim3 != dims_radcal_kernel_addspecies_h[3][1] || zdim3 != dims_radcal_kernel_addspecies_h[3][2]) {
        dims_radcal_kernel_addspecies_h[0][0] = xdim0;
        dims_radcal_kernel_addspecies_h[0][1] = ydim0;
        dims_radcal_kernel_addspecies_h[0][2] = zdim0;
        dims_radcal_kernel_addspecies_h[1][0] = xdim1;
        dims_radcal_kernel_addspecies_h[1][1] = ydim1;
        dims_radcal_kernel_addspecies_h[1][2] = zdim1;
        dims_radcal_kernel_addspecies_h[2][0] = xdim2;
        dims_radcal_kernel_addspecies_h[2][1] = ydim2;
        dims_radcal_kernel_addspecies_h[2][2] = zdim2;
        dims_radcal_kernel_addspecies_h[3][0] = xdim3;
        dims_radcal_kernel_addspecies_h[3][1] = ydim3;
        dims_radcal_kernel_addspecies_h[3][2] = zdim3;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_radcal_kernel_addspecies, dims_radcal_kernel_addspecies_h, sizeof(dims_radcal_kernel_addspecies)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_radcal_kernel_addspecies<<<grid, tblock >>> (
