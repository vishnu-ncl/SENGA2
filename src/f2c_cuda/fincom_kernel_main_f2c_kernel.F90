! Auto-generated at 2026-04-28 18:43:56.207850 by ops-translator
...
SUBROUTINE fincom_kernel_main_host_c(name, args, nargs, dim, range, block) BIND(C,name='fincom_kernel_main_host_c')
...
END SUBROUTINE fincom_kernel_main_host_c
...
SUBROUTINE fincom_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL fincom_kernel_main_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE fincom_kernel_main_host
