// Auto-generated at 2026-04-28 18:43:54.800632 by ops-translator

__constant__ int dims_hf_kernel_eqO[10][3];
static int dims_hf_kernel_eqO_h[10][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void hf_kernel_eqO_gpu(ACC<double> &rate, ACC<double> &erhs, ACC<double> &vtmp, const ACC<double> &trun, const ACC<double> &tdrmix, const ACC<double> &utmp, const ACC<double> &store7, const ACC<double> &td1y, const double *deltay, const double *rgspec_ispec) {
...
//  ============================
__global__ void ops_hf_kernel_eqO(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_hf_kernel_eqO[0][0] + idx_z * zstride_0 * dims_hf_kernel_eqO[0][0] * dims_hf_kernel_eqO[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_hf_kernel_eqO[1][0] + idx_z * zstride_1 * dims_hf_kernel_eqO[1][0] * dims_hf_kernel_eqO[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_hf_kernel_eqO[2][0] + idx_z * zstride_2 * dims_hf_kernel_eqO[2][0] * dims_hf_kernel_eqO[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_hf_kernel_eqO[3][0] + idx_z * zstride_3 * dims_hf_kernel_eqO[3][0] * dims_hf_kernel_eqO[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_hf_kernel_eqO[4][0] + idx_z * zstride_4 * dims_hf_kernel_eqO[4][0] * dims_hf_kernel_eqO[4][1];
    arg5 += idx_x * xstride_5 + idx_y * ystride_5 * dims_hf_kernel_eqO[5][0] + idx_z * zstride_5 * dims_hf_kernel_eqO[5][0] * dims_hf_kernel_eqO[5][1];
    arg6 += idx_x * xstride_6 + idx_y * ystride_6 * dims_hf_kernel_eqO[6][0] + idx_z * zstride_6 * dims_hf_kernel_eqO[6][0] * dims_hf_kernel_eqO[6][1];
    arg7 += idx_x * xstride_7 + idx_y * ystride_7 * dims_hf_kernel_eqO[7][0] + idx_z * zstride_7 * dims_hf_kernel_eqO[7][0] * dims_hf_kernel_eqO[7][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_hf_kernel_eqO[0][0], dims_hf_kernel_eqO[0][1], arg0);
        ACC<double> argp1(dims_hf_kernel_eqO[1][0], dims_hf_kernel_eqO[1][1], arg1);
        ACC<double> argp2(dims_hf_kernel_eqO[2][0], dims_hf_kernel_eqO[2][1], arg2);
        const ACC<double> argp3(dims_hf_kernel_eqO[3][0], dims_hf_kernel_eqO[3][1], arg3);
        const ACC<double> argp4(dims_hf_kernel_eqO[4][0], dims_hf_kernel_eqO[4][1], arg4);
        const ACC<double> argp5(dims_hf_kernel_eqO[5][0], dims_hf_kernel_eqO[5][1], arg5);
        const ACC<double> argp6(dims_hf_kernel_eqO[6][0], dims_hf_kernel_eqO[6][1], arg6);
        const ACC<double> argp7(dims_hf_kernel_eqO[7][0], dims_hf_kernel_eqO[7][1], arg7);

        hf_kernel_eqO_gpu(argp0, argp1, argp2, argp3, argp4, argp5, argp6, argp7, &arg8, &arg9);
...
//  ======================================================
    ...
    if (xdim0 != dims_hf_kernel_eqO_h[0][0] || ydim0 != dims_hf_kernel_eqO_h[0][1] || zdim0 != dims_hf_kernel_eqO_h[0][2] || xdim1 != dims_hf_kernel_eqO_h[1][0] || ydim1 != dims_hf_kernel_eqO_h[1][1] || zdim1 != dims_hf_kernel_eqO_h[1][2] || xdim2 != dims_hf_kernel_eqO_h[2][0] || ydim2 != dims_hf_kernel_eqO_h[2][1] || zdim2 != dims_hf_kernel_eqO_h[2][2] || xdim3 != dims_hf_kernel_eqO_h[3][0] || ydim3 != dims_hf_kernel_eqO_h[3][1] || zdim3 != dims_hf_kernel_eqO_h[3][2] || xdim4 != dims_hf_kernel_eqO_h[4][0] || ydim4 != dims_hf_kernel_eqO_h[4][1] || zdim4 != dims_hf_kernel_eqO_h[4][2] || xdim5 != dims_hf_kernel_eqO_h[5][0] || ydim5 != dims_hf_kernel_eqO_h[5][1] || zdim5 != dims_hf_kernel_eqO_h[5][2] || xdim6 != dims_hf_kernel_eqO_h[6][0] || ydim6 != dims_hf_kernel_eqO_h[6][1] || zdim6 != dims_hf_kernel_eqO_h[6][2] || xdim7 != dims_hf_kernel_eqO_h[7][0] || ydim7 != dims_hf_kernel_eqO_h[7][1] || zdim7 != dims_hf_kernel_eqO_h[7][2]) {
        dims_hf_kernel_eqO_h[0][0] = xdim0;
        dims_hf_kernel_eqO_h[0][1] = ydim0;
        dims_hf_kernel_eqO_h[0][2] = zdim0;
        dims_hf_kernel_eqO_h[1][0] = xdim1;
        dims_hf_kernel_eqO_h[1][1] = ydim1;
        dims_hf_kernel_eqO_h[1][2] = zdim1;
        dims_hf_kernel_eqO_h[2][0] = xdim2;
        dims_hf_kernel_eqO_h[2][1] = ydim2;
        dims_hf_kernel_eqO_h[2][2] = zdim2;
        dims_hf_kernel_eqO_h[3][0] = xdim3;
        dims_hf_kernel_eqO_h[3][1] = ydim3;
        dims_hf_kernel_eqO_h[3][2] = zdim3;
        dims_hf_kernel_eqO_h[4][0] = xdim4;
        dims_hf_kernel_eqO_h[4][1] = ydim4;
        dims_hf_kernel_eqO_h[4][2] = zdim4;
        dims_hf_kernel_eqO_h[5][0] = xdim5;
        dims_hf_kernel_eqO_h[5][1] = ydim5;
        dims_hf_kernel_eqO_h[5][2] = zdim5;
        dims_hf_kernel_eqO_h[6][0] = xdim6;
        dims_hf_kernel_eqO_h[6][1] = ydim6;
        dims_hf_kernel_eqO_h[6][2] = zdim6;
        dims_hf_kernel_eqO_h[7][0] = xdim7;
        dims_hf_kernel_eqO_h[7][1] = ydim7;
        dims_hf_kernel_eqO_h[7][2] = zdim7;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_hf_kernel_eqO, dims_hf_kernel_eqO_h, sizeof(dims_hf_kernel_eqO)));
    }
    ...
    )
{
    ...
    create_kerneldesc_and_enque("hf_kernel_eqO", args, 10, 259, dim, 1, range, block, hf_kernel_eqO_execute);
}
#endif
