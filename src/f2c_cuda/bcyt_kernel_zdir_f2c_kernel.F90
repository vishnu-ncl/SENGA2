! Auto-generated at 2026-04-28 18:43:56.651877 by ops-translator
...
SUBROUTINE bcyt_kernel_zdir_host_c(name, args, nargs, dim, range, block) BIND(C,name='bcyt_kernel_zdir_host_c')
...
END SUBROUTINE bcyt_kernel_zdir_host_c
...
SUBROUTINE bcyt_kernel_zdir_host( userSubroutine, block, dim, range, &
    ...
    CALL bcyt_kernel_zdir_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE bcyt_kernel_zdir_host
