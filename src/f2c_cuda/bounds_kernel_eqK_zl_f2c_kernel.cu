// Auto-generated at 2026-04-28 18:44:01.894880 by ops-translator

__constant__ int dims_bounds_kernel_eqK_zl[14][3];
static int dims_bounds_kernel_eqK_zl_h[14][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void bounds_kernel_eqK_zl_gpu(ACC<double> &bcl1zl, ACC<double> &bcl2zl, ACC<double> &bcl5zl, const ACC<double> &strdzl, const ACC<double> &acouzl, const ACC<double> &strwzl, const ACC<double> &ova2zl, const ACC<double> &dwdtzl, const ACC<double> &gam1zl, const ACC<double> &dtdtzl, const ACC<double> &strtzl, const ACC<double> &sorpzl, const ACC<double> &strpzl, const ACC<double> &sydtzl) {
...
//  ============================
__global__ void ops_bounds_kernel_eqK_zl(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_bounds_kernel_eqK_zl[0][0] + idx_z * zstride_0 * dims_bounds_kernel_eqK_zl[0][0] * dims_bounds_kernel_eqK_zl[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_bounds_kernel_eqK_zl[1][0] + idx_z * zstride_1 * dims_bounds_kernel_eqK_zl[1][0] * dims_bounds_kernel_eqK_zl[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_bounds_kernel_eqK_zl[2][0] + idx_z * zstride_2 * dims_bounds_kernel_eqK_zl[2][0] * dims_bounds_kernel_eqK_zl[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_bounds_kernel_eqK_zl[3][0] + idx_z * zstride_3 * dims_bounds_kernel_eqK_zl[3][0] * dims_bounds_kernel_eqK_zl[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_bounds_kernel_eqK_zl[4][0] + idx_z * zstride_4 * dims_bounds_kernel_eqK_zl[4][0] * dims_bounds_kernel_eqK_zl[4][1];
    arg5 += idx_x * xstride_5 + idx_y * ystride_5 * dims_bounds_kernel_eqK_zl[5][0] + idx_z * zstride_5 * dims_bounds_kernel_eqK_zl[5][0] * dims_bounds_kernel_eqK_zl[5][1];
    arg6 += idx_x * xstride_6 + idx_y * ystride_6 * dims_bounds_kernel_eqK_zl[6][0] + idx_z * zstride_6 * dims_bounds_kernel_eqK_zl[6][0] * dims_bounds_kernel_eqK_zl[6][1];
    arg7 += idx_x * xstride_7 + idx_y * ystride_7 * dims_bounds_kernel_eqK_zl[7][0] + idx_z * zstride_7 * dims_bounds_kernel_eqK_zl[7][0] * dims_bounds_kernel_eqK_zl[7][1];
    arg8 += idx_x * xstride_8 + idx_y * ystride_8 * dims_bounds_kernel_eqK_zl[8][0] + idx_z * zstride_8 * dims_bounds_kernel_eqK_zl[8][0] * dims_bounds_kernel_eqK_zl[8][1];
    arg9 += idx_x * xstride_9 + idx_y * ystride_9 * dims_bounds_kernel_eqK_zl[9][0] + idx_z * zstride_9 * dims_bounds_kernel_eqK_zl[9][0] * dims_bounds_kernel_eqK_zl[9][1];
    arg10 += idx_x * xstride_10 + idx_y * ystride_10 * dims_bounds_kernel_eqK_zl[10][0] + idx_z * zstride_10 * dims_bounds_kernel_eqK_zl[10][0] * dims_bounds_kernel_eqK_zl[10][1];
    arg11 += idx_x * xstride_11 + idx_y * ystride_11 * dims_bounds_kernel_eqK_zl[11][0] + idx_z * zstride_11 * dims_bounds_kernel_eqK_zl[11][0] * dims_bounds_kernel_eqK_zl[11][1];
    arg12 += idx_x * xstride_12 + idx_y * ystride_12 * dims_bounds_kernel_eqK_zl[12][0] + idx_z * zstride_12 * dims_bounds_kernel_eqK_zl[12][0] * dims_bounds_kernel_eqK_zl[12][1];
    arg13 += idx_x * xstride_13 + idx_y * ystride_13 * dims_bounds_kernel_eqK_zl[13][0] + idx_z * zstride_13 * dims_bounds_kernel_eqK_zl[13][0] * dims_bounds_kernel_eqK_zl[13][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_bounds_kernel_eqK_zl[0][0], dims_bounds_kernel_eqK_zl[0][1], arg0);
        ACC<double> argp1(dims_bounds_kernel_eqK_zl[1][0], dims_bounds_kernel_eqK_zl[1][1], arg1);
        ACC<double> argp2(dims_bounds_kernel_eqK_zl[2][0], dims_bounds_kernel_eqK_zl[2][1], arg2);
        const ACC<double> argp3(dims_bounds_kernel_eqK_zl[3][0], dims_bounds_kernel_eqK_zl[3][1], arg3);
        const ACC<double> argp4(dims_bounds_kernel_eqK_zl[4][0], dims_bounds_kernel_eqK_zl[4][1], arg4);
        const ACC<double> argp5(dims_bounds_kernel_eqK_zl[5][0], dims_bounds_kernel_eqK_zl[5][1], arg5);
        const ACC<double> argp6(dims_bounds_kernel_eqK_zl[6][0], dims_bounds_kernel_eqK_zl[6][1], arg6);
        const ACC<double> argp7(dims_bounds_kernel_eqK_zl[7][0], dims_bounds_kernel_eqK_zl[7][1], arg7);
        const ACC<double> argp8(dims_bounds_kernel_eqK_zl[8][0], dims_bounds_kernel_eqK_zl[8][1], arg8);
        const ACC<double> argp9(dims_bounds_kernel_eqK_zl[9][0], dims_bounds_kernel_eqK_zl[9][1], arg9);
        const ACC<double> argp10(dims_bounds_kernel_eqK_zl[10][0], dims_bounds_kernel_eqK_zl[10][1], arg10);
        const ACC<double> argp11(dims_bounds_kernel_eqK_zl[11][0], dims_bounds_kernel_eqK_zl[11][1], arg11);
        const ACC<double> argp12(dims_bounds_kernel_eqK_zl[12][0], dims_bounds_kernel_eqK_zl[12][1], arg12);
        const ACC<double> argp13(dims_bounds_kernel_eqK_zl[13][0], dims_bounds_kernel_eqK_zl[13][1], arg13);

        bounds_kernel_eqK_zl_gpu(argp0, argp1, argp2, argp3, argp4, argp5, argp6, argp7, argp8, argp9, argp10, argp11, argp12, argp13);
...
//  ======================================================
    ...
    if (xdim0 != dims_bounds_kernel_eqK_zl_h[0][0] || ydim0 != dims_bounds_kernel_eqK_zl_h[0][1] || zdim0 != dims_bounds_kernel_eqK_zl_h[0][2] || xdim1 != dims_bounds_kernel_eqK_zl_h[1][0] || ydim1 != dims_bounds_kernel_eqK_zl_h[1][1] || zdim1 != dims_bounds_kernel_eqK_zl_h[1][2] || xdim2 != dims_bounds_kernel_eqK_zl_h[2][0] || ydim2 != dims_bounds_kernel_eqK_zl_h[2][1] || zdim2 != dims_bounds_kernel_eqK_zl_h[2][2] || xdim3 != dims_bounds_kernel_eqK_zl_h[3][0] || ydim3 != dims_bounds_kernel_eqK_zl_h[3][1] || zdim3 != dims_bounds_kernel_eqK_zl_h[3][2] || xdim4 != dims_bounds_kernel_eqK_zl_h[4][0] || ydim4 != dims_bounds_kernel_eqK_zl_h[4][1] || zdim4 != dims_bounds_kernel_eqK_zl_h[4][2] || xdim5 != dims_bounds_kernel_eqK_zl_h[5][0] || ydim5 != dims_bounds_kernel_eqK_zl_h[5][1] || zdim5 != dims_bounds_kernel_eqK_zl_h[5][2] || xdim6 != dims_bounds_kernel_eqK_zl_h[6][0] || ydim6 != dims_bounds_kernel_eqK_zl_h[6][1] || zdim6 != dims_bounds_kernel_eqK_zl_h[6][2] || xdim7 != dims_bounds_kernel_eqK_zl_h[7][0] || ydim7 != dims_bounds_kernel_eqK_zl_h[7][1] || zdim7 != dims_bounds_kernel_eqK_zl_h[7][2] || xdim8 != dims_bounds_kernel_eqK_zl_h[8][0] || ydim8 != dims_bounds_kernel_eqK_zl_h[8][1] || zdim8 != dims_bounds_kernel_eqK_zl_h[8][2] || xdim9 != dims_bounds_kernel_eqK_zl_h[9][0] || ydim9 != dims_bounds_kernel_eqK_zl_h[9][1] || zdim9 != dims_bounds_kernel_eqK_zl_h[9][2] || xdim10 != dims_bounds_kernel_eqK_zl_h[10][0] || ydim10 != dims_bounds_kernel_eqK_zl_h[10][1] || zdim10 != dims_bounds_kernel_eqK_zl_h[10][2] || xdim11 != dims_bounds_kernel_eqK_zl_h[11][0] || ydim11 != dims_bounds_kernel_eqK_zl_h[11][1] || zdim11 != dims_bounds_kernel_eqK_zl_h[11][2] || xdim12 != dims_bounds_kernel_eqK_zl_h[12][0] || ydim12 != dims_bounds_kernel_eqK_zl_h[12][1] || zdim12 != dims_bounds_kernel_eqK_zl_h[12][2] || xdim13 != dims_bounds_kernel_eqK_zl_h[13][0] || ydim13 != dims_bounds_kernel_eqK_zl_h[13][1] || zdim13 != dims_bounds_kernel_eqK_zl_h[13][2]) {
        dims_bounds_kernel_eqK_zl_h[0][0] = xdim0;
        dims_bounds_kernel_eqK_zl_h[0][1] = ydim0;
        dims_bounds_kernel_eqK_zl_h[0][2] = zdim0;
        dims_bounds_kernel_eqK_zl_h[1][0] = xdim1;
        dims_bounds_kernel_eqK_zl_h[1][1] = ydim1;
        dims_bounds_kernel_eqK_zl_h[1][2] = zdim1;
        dims_bounds_kernel_eqK_zl_h[2][0] = xdim2;
        dims_bounds_kernel_eqK_zl_h[2][1] = ydim2;
        dims_bounds_kernel_eqK_zl_h[2][2] = zdim2;
        dims_bounds_kernel_eqK_zl_h[3][0] = xdim3;
        dims_bounds_kernel_eqK_zl_h[3][1] = ydim3;
        dims_bounds_kernel_eqK_zl_h[3][2] = zdim3;
        dims_bounds_kernel_eqK_zl_h[4][0] = xdim4;
        dims_bounds_kernel_eqK_zl_h[4][1] = ydim4;
        dims_bounds_kernel_eqK_zl_h[4][2] = zdim4;
        dims_bounds_kernel_eqK_zl_h[5][0] = xdim5;
        dims_bounds_kernel_eqK_zl_h[5][1] = ydim5;
        dims_bounds_kernel_eqK_zl_h[5][2] = zdim5;
        dims_bounds_kernel_eqK_zl_h[6][0] = xdim6;
        dims_bounds_kernel_eqK_zl_h[6][1] = ydim6;
        dims_bounds_kernel_eqK_zl_h[6][2] = zdim6;
        dims_bounds_kernel_eqK_zl_h[7][0] = xdim7;
        dims_bounds_kernel_eqK_zl_h[7][1] = ydim7;
        dims_bounds_kernel_eqK_zl_h[7][2] = zdim7;
        dims_bounds_kernel_eqK_zl_h[8][0] = xdim8;
        dims_bounds_kernel_eqK_zl_h[8][1] = ydim8;
        dims_bounds_kernel_eqK_zl_h[8][2] = zdim8;
        dims_bounds_kernel_eqK_zl_h[9][0] = xdim9;
        dims_bounds_kernel_eqK_zl_h[9][1] = ydim9;
        dims_bounds_kernel_eqK_zl_h[9][2] = zdim9;
        dims_bounds_kernel_eqK_zl_h[10][0] = xdim10;
        dims_bounds_kernel_eqK_zl_h[10][1] = ydim10;
        dims_bounds_kernel_eqK_zl_h[10][2] = zdim10;
        dims_bounds_kernel_eqK_zl_h[11][0] = xdim11;
        dims_bounds_kernel_eqK_zl_h[11][1] = ydim11;
        dims_bounds_kernel_eqK_zl_h[11][2] = zdim11;
        dims_bounds_kernel_eqK_zl_h[12][0] = xdim12;
        dims_bounds_kernel_eqK_zl_h[12][1] = ydim12;
        dims_bounds_kernel_eqK_zl_h[12][2] = zdim12;
        dims_bounds_kernel_eqK_zl_h[13][0] = xdim13;
        dims_bounds_kernel_eqK_zl_h[13][1] = ydim13;
        dims_bounds_kernel_eqK_zl_h[13][2] = zdim13;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_bounds_kernel_eqK_zl, dims_bounds_kernel_eqK_zl_h, sizeof(dims_bounds_kernel_eqK_zl)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_bounds_kernel_eqK_zl<<<grid, tblock >>> (
