// Auto-generated at 2026-04-28 18:43:55.011549 by ops-translator

__constant__ int dims_hf_kernel_eqH[7][3];
static int dims_hf_kernel_eqH_h[7][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void hf_kernel_eqH_gpu(ACC<double> &erhs, const ACC<double> &trun, const ACC<double> &tdrmix, const ACC<double> &store7, const ACC<double> &td1x, const double *rgspec_ispec, const double *deltax) {
...
//  ============================
__global__ void ops_hf_kernel_eqH(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_hf_kernel_eqH[0][0] + idx_z * zstride_0 * dims_hf_kernel_eqH[0][0] * dims_hf_kernel_eqH[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_hf_kernel_eqH[1][0] + idx_z * zstride_1 * dims_hf_kernel_eqH[1][0] * dims_hf_kernel_eqH[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_hf_kernel_eqH[2][0] + idx_z * zstride_2 * dims_hf_kernel_eqH[2][0] * dims_hf_kernel_eqH[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_hf_kernel_eqH[3][0] + idx_z * zstride_3 * dims_hf_kernel_eqH[3][0] * dims_hf_kernel_eqH[3][1];
    arg4 += idx_x * xstride_4 + idx_y * ystride_4 * dims_hf_kernel_eqH[4][0] + idx_z * zstride_4 * dims_hf_kernel_eqH[4][0] * dims_hf_kernel_eqH[4][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_hf_kernel_eqH[0][0], dims_hf_kernel_eqH[0][1], arg0);
        const ACC<double> argp1(dims_hf_kernel_eqH[1][0], dims_hf_kernel_eqH[1][1], arg1);
        const ACC<double> argp2(dims_hf_kernel_eqH[2][0], dims_hf_kernel_eqH[2][1], arg2);
        const ACC<double> argp3(dims_hf_kernel_eqH[3][0], dims_hf_kernel_eqH[3][1], arg3);
        const ACC<double> argp4(dims_hf_kernel_eqH[4][0], dims_hf_kernel_eqH[4][1], arg4);

        hf_kernel_eqH_gpu(argp0, argp1, argp2, argp3, argp4, &arg5, &arg6);
...
//  ======================================================
    ...
    if (xdim0 != dims_hf_kernel_eqH_h[0][0] || ydim0 != dims_hf_kernel_eqH_h[0][1] || zdim0 != dims_hf_kernel_eqH_h[0][2] || xdim1 != dims_hf_kernel_eqH_h[1][0] || ydim1 != dims_hf_kernel_eqH_h[1][1] || zdim1 != dims_hf_kernel_eqH_h[1][2] || xdim2 != dims_hf_kernel_eqH_h[2][0] || ydim2 != dims_hf_kernel_eqH_h[2][1] || zdim2 != dims_hf_kernel_eqH_h[2][2] || xdim3 != dims_hf_kernel_eqH_h[3][0] || ydim3 != dims_hf_kernel_eqH_h[3][1] || zdim3 != dims_hf_kernel_eqH_h[3][2] || xdim4 != dims_hf_kernel_eqH_h[4][0] || ydim4 != dims_hf_kernel_eqH_h[4][1] || zdim4 != dims_hf_kernel_eqH_h[4][2]) {
        dims_hf_kernel_eqH_h[0][0] = xdim0;
        dims_hf_kernel_eqH_h[0][1] = ydim0;
        dims_hf_kernel_eqH_h[0][2] = zdim0;
        dims_hf_kernel_eqH_h[1][0] = xdim1;
        dims_hf_kernel_eqH_h[1][1] = ydim1;
        dims_hf_kernel_eqH_h[1][2] = zdim1;
        dims_hf_kernel_eqH_h[2][0] = xdim2;
        dims_hf_kernel_eqH_h[2][1] = ydim2;
        dims_hf_kernel_eqH_h[2][2] = zdim2;
        dims_hf_kernel_eqH_h[3][0] = xdim3;
        dims_hf_kernel_eqH_h[3][1] = ydim3;
        dims_hf_kernel_eqH_h[3][2] = zdim3;
        dims_hf_kernel_eqH_h[4][0] = xdim4;
        dims_hf_kernel_eqH_h[4][1] = ydim4;
        dims_hf_kernel_eqH_h[4][2] = zdim4;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_hf_kernel_eqH, dims_hf_kernel_eqH_h, sizeof(dims_hf_kernel_eqH)));
    }
...
//  =======================
    ...
    double * __restrict__ td1x_p = (double *)(args[4].data_d) + base4 - 1; // Subtracting 1 to convert to C-style
    p_a[4] = (char *)td1x_p;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("hf_kernel_eqH", args, 7, 264, dim, 1, range, block, hf_kernel_eqH_execute);
}
#endif
