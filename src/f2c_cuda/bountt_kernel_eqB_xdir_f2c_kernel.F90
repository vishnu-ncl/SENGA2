! Auto-generated at 2026-04-28 18:44:03.494496 by ops-translator
...
SUBROUTINE bountt_kernel_eqB_xdir_host_c(name, args, nargs, dim, range, block) BIND(C,name='bountt_kernel_eqB_xdir_host_c')
...
END SUBROUTINE bountt_kernel_eqB_xdir_host_c
...
SUBROUTINE bountt_kernel_eqB_xdir_host( userSubroutine, block, dim, range, &
    ...
    CALL bountt_kernel_eqB_xdir_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    5, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE bountt_kernel_eqB_xdir_host
