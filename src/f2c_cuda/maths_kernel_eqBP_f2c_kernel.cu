// Auto-generated at 2026-04-28 18:44:05.049595 by ops-translator

__constant__ int dims_maths_kernel_eqBP[12][3];
static int dims_maths_kernel_eqBP_h[12][3] = {{0}};

//  =============
//  User function
//  =============
__device__ void maths_kernel_eqBP_gpu(ACC<double> &erun, const ACC<double> &trun, const ACC<int> &itndex, const ACC<double> &yrun, const double *amasch, const int *ncpoly, const int *ncpom1, const int *ncenth, const int *ipower, const int *icoef1, const int *icoef2, const int *ispec) {
    ...
    fornow = amasch[(ncenth[(itint-1)+(ispec[0]-1)*ntinmx]-1)+(itint-1)*ncofmx+(ispec[0]-1)*ncofmx*ntinmx] + fornow * trun(0, 0, 0);
...
//  ============================
__global__ void ops_maths_kernel_eqBP(double* __restrict arg0, int xstride_0, int ystride_0, int zstride_0, 
...
int size0, int size1, int size2) {
    ...
    arg0 += idx_x * xstride_0 + idx_y * ystride_0 * dims_maths_kernel_eqBP[0][0] + idx_z * zstride_0 * dims_maths_kernel_eqBP[0][0] * dims_maths_kernel_eqBP[0][1];
    arg1 += idx_x * xstride_1 + idx_y * ystride_1 * dims_maths_kernel_eqBP[1][0] + idx_z * zstride_1 * dims_maths_kernel_eqBP[1][0] * dims_maths_kernel_eqBP[1][1];
    arg2 += idx_x * xstride_2 + idx_y * ystride_2 * dims_maths_kernel_eqBP[2][0] + idx_z * zstride_2 * dims_maths_kernel_eqBP[2][0] * dims_maths_kernel_eqBP[2][1];
    arg3 += idx_x * xstride_3 + idx_y * ystride_3 * dims_maths_kernel_eqBP[3][0] + idx_z * zstride_3 * dims_maths_kernel_eqBP[3][0] * dims_maths_kernel_eqBP[3][1];

    if(idx_x < size0 && idx_y < size1 && idx_z < size2) {

        ACC<double> argp0(dims_maths_kernel_eqBP[0][0], dims_maths_kernel_eqBP[0][1], arg0);
        const ACC<double> argp1(dims_maths_kernel_eqBP[1][0], dims_maths_kernel_eqBP[1][1], arg1);
        const ACC<int> argp2(dims_maths_kernel_eqBP[2][0], dims_maths_kernel_eqBP[2][1], arg2);
        const ACC<double> argp3(dims_maths_kernel_eqBP[3][0], dims_maths_kernel_eqBP[3][1], arg3);

        maths_kernel_eqBP_gpu(argp0, argp1, argp2, argp3, arg4, arg5, arg6, arg7, &arg8, &arg9, &arg10, &arg11);
...
//  ======================================================
    ...
    if (xdim0 != dims_maths_kernel_eqBP_h[0][0] || ydim0 != dims_maths_kernel_eqBP_h[0][1] || zdim0 != dims_maths_kernel_eqBP_h[0][2] || xdim1 != dims_maths_kernel_eqBP_h[1][0] || ydim1 != dims_maths_kernel_eqBP_h[1][1] || zdim1 != dims_maths_kernel_eqBP_h[1][2] || xdim2 != dims_maths_kernel_eqBP_h[2][0] || ydim2 != dims_maths_kernel_eqBP_h[2][1] || zdim2 != dims_maths_kernel_eqBP_h[2][2] || xdim3 != dims_maths_kernel_eqBP_h[3][0] || ydim3 != dims_maths_kernel_eqBP_h[3][1] || zdim3 != dims_maths_kernel_eqBP_h[3][2]) {
        dims_maths_kernel_eqBP_h[0][0] = xdim0;
        dims_maths_kernel_eqBP_h[0][1] = ydim0;
        dims_maths_kernel_eqBP_h[0][2] = zdim0;
        dims_maths_kernel_eqBP_h[1][0] = xdim1;
        dims_maths_kernel_eqBP_h[1][1] = ydim1;
        dims_maths_kernel_eqBP_h[1][2] = zdim1;
        dims_maths_kernel_eqBP_h[2][0] = xdim2;
        dims_maths_kernel_eqBP_h[2][1] = ydim2;
        dims_maths_kernel_eqBP_h[2][2] = zdim2;
        dims_maths_kernel_eqBP_h[3][0] = xdim3;
        dims_maths_kernel_eqBP_h[3][1] = ydim3;
        dims_maths_kernel_eqBP_h[3][2] = zdim3;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_maths_kernel_eqBP, dims_maths_kernel_eqBP_h, sizeof(dims_maths_kernel_eqBP)));
    }
...
//  call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_maths_kernel_eqBP<<<grid, tblock >>> (
