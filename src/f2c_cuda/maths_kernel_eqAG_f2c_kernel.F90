! Auto-generated at 2026-04-28 18:43:54.634195 by ops-translator
...
SUBROUTINE maths_kernel_eqAG_host_c(name, args, nargs, dim, range, block) BIND(C,name='maths_kernel_eqAG_host_c')
...
END SUBROUTINE maths_kernel_eqAG_host_c
...
SUBROUTINE maths_kernel_eqAG_host( userSubroutine, block, dim, range, &
    ...
    CALL maths_kernel_eqAG_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE maths_kernel_eqAG_host
