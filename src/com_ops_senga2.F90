...
!   OPS reduction handles
    TYPE(ops_reduction) :: h_erdtot, h_erutot, h_ervtot, h_erwtot, h_eretot, h_erytot,h_tkes
...
!   ops for tgv
!    TYPE(ops_dat) :: d_dutgvdx,d_dutgvdy,d_dutgvdz
!    TYPE(ops_dat) :: d_dvtgvdx,d_dvtgvdy,d_dvtgvdz
!    TYPE(ops_dat) :: d_dwtgvdx,d_dwtgvdy,d_dwtgvdz
