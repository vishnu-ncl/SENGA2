// Auto-generated at 2026-04-28 18:44:21.542536 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_bounds_kernel_eqN_xr_h[0][0] || ydim0 != dims_bounds_kernel_eqN_xr_h[0][1] || zdim0 != dims_bounds_kernel_eqN_xr_h[0][2] || xdim1 != dims_bounds_kernel_eqN_xr_h[1][0] || ydim1 != dims_bounds_kernel_eqN_xr_h[1][1] || zdim1 != dims_bounds_kernel_eqN_xr_h[1][2] || xdim2 != dims_bounds_kernel_eqN_xr_h[2][0] || ydim2 != dims_bounds_kernel_eqN_xr_h[2][1] || zdim2 != dims_bounds_kernel_eqN_xr_h[2][2] || xdim3 != dims_bounds_kernel_eqN_xr_h[3][0] || ydim3 != dims_bounds_kernel_eqN_xr_h[3][1] || zdim3 != dims_bounds_kernel_eqN_xr_h[3][2] || xdim4 != dims_bounds_kernel_eqN_xr_h[4][0] || ydim4 != dims_bounds_kernel_eqN_xr_h[4][1] || zdim4 != dims_bounds_kernel_eqN_xr_h[4][2] || xdim5 != dims_bounds_kernel_eqN_xr_h[5][0] || ydim5 != dims_bounds_kernel_eqN_xr_h[5][1] || zdim5 != dims_bounds_kernel_eqN_xr_h[5][2] || xdim6 != dims_bounds_kernel_eqN_xr_h[6][0] || ydim6 != dims_bounds_kernel_eqN_xr_h[6][1] || zdim6 != dims_bounds_kernel_eqN_xr_h[6][2] || xdim7 != dims_bounds_kernel_eqN_xr_h[7][0] || ydim7 != dims_bounds_kernel_eqN_xr_h[7][1] || zdim7 != dims_bounds_kernel_eqN_xr_h[7][2] || xdim8 != dims_bounds_kernel_eqN_xr_h[8][0] || ydim8 != dims_bounds_kernel_eqN_xr_h[8][1] || zdim8 != dims_bounds_kernel_eqN_xr_h[8][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_bounds_kernel_eqN_xr, dims_bounds_kernel_eqN_xr_h, sizeof(dims_bounds_kernel_eqN_xr)));
    }
