// Auto-generated at 2026-04-28 18:44:16.094072 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_maths_kernel_eqBE_h[0][0] || ydim0 != dims_maths_kernel_eqBE_h[0][1] || zdim0 != dims_maths_kernel_eqBE_h[0][2] || xdim1 != dims_maths_kernel_eqBE_h[1][0] || ydim1 != dims_maths_kernel_eqBE_h[1][1] || zdim1 != dims_maths_kernel_eqBE_h[1][2] || xdim2 != dims_maths_kernel_eqBE_h[2][0] || ydim2 != dims_maths_kernel_eqBE_h[2][1] || zdim2 != dims_maths_kernel_eqBE_h[2][2] || xdim3 != dims_maths_kernel_eqBE_h[3][0] || ydim3 != dims_maths_kernel_eqBE_h[3][1] || zdim3 != dims_maths_kernel_eqBE_h[3][2] || xdim4 != dims_maths_kernel_eqBE_h[4][0] || ydim4 != dims_maths_kernel_eqBE_h[4][1] || zdim4 != dims_maths_kernel_eqBE_h[4][2] || xdim5 != dims_maths_kernel_eqBE_h[5][0] || ydim5 != dims_maths_kernel_eqBE_h[5][1] || zdim5 != dims_maths_kernel_eqBE_h[5][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_maths_kernel_eqBE, dims_maths_kernel_eqBE_h, sizeof(dims_maths_kernel_eqBE)));
    }
