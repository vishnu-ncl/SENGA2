! Auto-generated at 2026-04-28 18:44:28.292795 by ops-translator
...
SUBROUTINE copy_kernel_mdim_to_sdim_host_c(name, args, nargs, dim, range, block) BIND(C,name='copy_kernel_mdim_to_sdim_host_c')
...
END SUBROUTINE copy_kernel_mdim_to_sdim_host_c
...
SUBROUTINE copy_kernel_mdim_to_sdim_host( userSubroutine, block, dim, range, &
    ...
    CALL copy_kernel_mdim_to_sdim_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    3, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE copy_kernel_mdim_to_sdim_host
