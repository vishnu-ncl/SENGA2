! Auto-generated at 2026-04-28 18:44:18.995306 by ops-translator
...
SUBROUTINE bcut_kernel_xdir_eqF_host_c(name, args, nargs, dim, range, block) BIND(C,name='bcut_kernel_xdir_eqF_host_c')
...
END SUBROUTINE bcut_kernel_xdir_eqF_host_c
...
SUBROUTINE bcut_kernel_xdir_eqF_host( userSubroutine, block, dim, range, &
    ...
    CALL bcut_kernel_xdir_eqF_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE bcut_kernel_xdir_eqF_host
