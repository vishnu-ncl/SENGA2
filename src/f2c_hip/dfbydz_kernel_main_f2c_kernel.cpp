// Auto-generated at 2026-04-28 18:44:06.515624 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_dfbydz_kernel_main_h[0][0] || ydim0 != dims_dfbydz_kernel_main_h[0][1] || zdim0 != dims_dfbydz_kernel_main_h[0][2] || xdim1 != dims_dfbydz_kernel_main_h[1][0] || ydim1 != dims_dfbydz_kernel_main_h[1][1] || zdim1 != dims_dfbydz_kernel_main_h[1][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_dfbydz_kernel_main, dims_dfbydz_kernel_main_h, sizeof(dims_dfbydz_kernel_main)));
    }
