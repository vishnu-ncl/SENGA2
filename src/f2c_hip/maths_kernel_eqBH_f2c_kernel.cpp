// Auto-generated at 2026-04-28 18:44:16.683168 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_maths_kernel_eqBH_h[0][0] || ydim0 != dims_maths_kernel_eqBH_h[0][1] || zdim0 != dims_maths_kernel_eqBH_h[0][2] || xdim1 != dims_maths_kernel_eqBH_h[1][0] || ydim1 != dims_maths_kernel_eqBH_h[1][1] || zdim1 != dims_maths_kernel_eqBH_h[1][2] || xdim2 != dims_maths_kernel_eqBH_h[2][0] || ydim2 != dims_maths_kernel_eqBH_h[2][1] || zdim2 != dims_maths_kernel_eqBH_h[2][2] || xdim3 != dims_maths_kernel_eqBH_h[3][0] || ydim3 != dims_maths_kernel_eqBH_h[3][1] || zdim3 != dims_maths_kernel_eqBH_h[3][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_maths_kernel_eqBH, dims_maths_kernel_eqBH_h, sizeof(dims_maths_kernel_eqBH)));
    }
