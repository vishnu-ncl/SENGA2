! Auto-generated at 2026-04-28 18:44:06.377792 by ops-translator
...
SUBROUTINE dfbydy_kernel_main_host_c(name, args, nargs, dim, range, block) BIND(C,name='dfbydy_kernel_main_host_c')
...
END SUBROUTINE dfbydy_kernel_main_host_c
...
SUBROUTINE dfbydy_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL dfbydy_kernel_main_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE dfbydy_kernel_main_host
