// Auto-generated at 2026-04-28 18:44:18.872197 by ops-translator
...
//  ==============================
    for(int d = 0; d < 1; d++)
        ops_reduction_hip<OPS_MAX>(&arg3[d+(blockIdx.x + blockIdx.y*gridDim.x + blockIdx.z*gridDim.x*gridDim.y)*1],arg3_l[d]);
...
//  ======================================================
    ...
    if (xdim0 != dims_adaptt_kernel_err_eval_h[0][0] || ydim0 != dims_adaptt_kernel_err_eval_h[0][1] || zdim0 != dims_adaptt_kernel_err_eval_h[0][2] || xdim1 != dims_adaptt_kernel_err_eval_h[1][0] || ydim1 != dims_adaptt_kernel_err_eval_h[1][1] || zdim1 != dims_adaptt_kernel_err_eval_h[1][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_adaptt_kernel_err_eval, dims_adaptt_kernel_err_eval_h, sizeof(dims_adaptt_kernel_err_eval)));
    }
