! Auto-generated at 2026-04-28 18:44:06.511633 by ops-translator
...
SUBROUTINE dfbydz_kernel_main_host_c(name, args, nargs, dim, range, block) BIND(C,name='dfbydz_kernel_main_host_c')
...
END SUBROUTINE dfbydz_kernel_main_host_c
...
SUBROUTINE dfbydz_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL dfbydz_kernel_main_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE dfbydz_kernel_main_host
