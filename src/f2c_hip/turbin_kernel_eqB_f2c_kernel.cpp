// Auto-generated at 2026-04-28 18:44:27.784344 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_turbin_kernel_eqB_h[0][0] || ydim0 != dims_turbin_kernel_eqB_h[0][1] || zdim0 != dims_turbin_kernel_eqB_h[0][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_turbin_kernel_eqB, dims_turbin_kernel_eqB_h, sizeof(dims_turbin_kernel_eqB)));
    }
