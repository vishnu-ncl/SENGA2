! Auto-generated at 2026-04-28 18:44:18.869182 by ops-translator
...
SUBROUTINE adaptt_kernel_err_eval_host_c(name, args, nargs, dim, range, block) BIND(C,name='adaptt_kernel_err_eval_host_c')
...
END SUBROUTINE adaptt_kernel_err_eval_host_c
...
SUBROUTINE adaptt_kernel_err_eval_host( userSubroutine, block, dim, range, &
    ...
    CALL adaptt_kernel_err_eval_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE adaptt_kernel_err_eval_host
