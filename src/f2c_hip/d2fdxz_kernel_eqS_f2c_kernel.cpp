// Auto-generated at 2026-04-28 18:44:10.670857 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_d2fdxz_kernel_eqS_h[0][0] || ydim0 != dims_d2fdxz_kernel_eqS_h[0][1] || zdim0 != dims_d2fdxz_kernel_eqS_h[0][2] || xdim1 != dims_d2fdxz_kernel_eqS_h[1][0] || ydim1 != dims_d2fdxz_kernel_eqS_h[1][1] || zdim1 != dims_d2fdxz_kernel_eqS_h[1][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_d2fdxz_kernel_eqS, dims_d2fdxz_kernel_eqS_h, sizeof(dims_d2fdxz_kernel_eqS)));
    }
