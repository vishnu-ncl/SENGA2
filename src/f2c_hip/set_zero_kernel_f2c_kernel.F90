! Auto-generated at 2026-04-28 18:44:05.647697 by ops-translator
...
SUBROUTINE set_zero_kernel_host_c(name, args, nargs, dim, range, block) BIND(C,name='set_zero_kernel_host_c')
...
END SUBROUTINE set_zero_kernel_host_c
...
END SUBROUTINE set_zero_kernel_host
