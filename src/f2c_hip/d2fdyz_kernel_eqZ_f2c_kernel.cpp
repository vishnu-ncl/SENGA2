// Auto-generated at 2026-04-28 18:44:13.953431 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_d2fdyz_kernel_eqZ_h[0][0] || ydim0 != dims_d2fdyz_kernel_eqZ_h[0][1] || zdim0 != dims_d2fdyz_kernel_eqZ_h[0][2] || xdim1 != dims_d2fdyz_kernel_eqZ_h[1][0] || ydim1 != dims_d2fdyz_kernel_eqZ_h[1][1] || zdim1 != dims_d2fdyz_kernel_eqZ_h[1][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_d2fdyz_kernel_eqZ, dims_d2fdyz_kernel_eqZ_h, sizeof(dims_d2fdyz_kernel_eqZ)));
    }
