// Auto-generated at 2026-04-28 18:44:27.846382 by ops-translator
...
//  ======================================================
    ...
    if (xdim0 != dims_set_zero_kernel_MD5_h[0][0] || ydim0 != dims_set_zero_kernel_MD5_h[0][1] || zdim0 != dims_set_zero_kernel_MD5_h[0][2]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_set_zero_kernel_MD5, dims_set_zero_kernel_MD5_h, sizeof(dims_set_zero_kernel_MD5)));
    }
