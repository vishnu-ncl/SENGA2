! Auto-generated at 2026-04-28 18:44:32.868683 by ops-translator

MODULE BOUNTT_KERNEL_EQF_ZDIR_MODULE
...
!$OMP DECLARE TARGET(xdim1_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim1_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim1_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim1_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim1_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim1_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_bountt_kernel_eqF_zdir*(y)) + (xdim1_bountt_kernel_eqF_zdir*ydim1_bountt_kernel_eqF_zdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim2_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim2_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim2_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim2_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim2_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_bountt_kernel_eqF_zdir*(y)) + (xdim2_bountt_kernel_eqF_zdir*ydim2_bountt_kernel_eqF_zdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim3_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim3_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim3_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim3_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim3_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_bountt_kernel_eqF_zdir*(y)) + (xdim3_bountt_kernel_eqF_zdir*ydim3_bountt_kernel_eqF_zdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim4_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim4_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim4_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim4_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim4_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_bountt_kernel_eqF_zdir*(y)) + (xdim4_bountt_kernel_eqF_zdir*ydim4_bountt_kernel_eqF_zdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim5_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim5_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim5_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim5_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim5_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_bountt_kernel_eqF_zdir*(y)) + (xdim5_bountt_kernel_eqF_zdir*ydim5_bountt_kernel_eqF_zdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim6_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim6_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim6_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim6_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim6_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_bountt_kernel_eqF_zdir*(y)) + (xdim6_bountt_kernel_eqF_zdir*ydim6_bountt_kernel_eqF_zdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim7_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim7_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim7_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim7_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim7_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim7_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC7(x,y,z) ((x) + (xdim7_bountt_kernel_eqF_zdir*(y)) + (xdim7_bountt_kernel_eqF_zdir*ydim7_bountt_kernel_eqF_zdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim8_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: xdim8_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: xdim8_bountt_kernel_eqF_zdir_h = -1
!$OMP DECLARE TARGET(ydim8_bountt_kernel_eqF_zdir)
    INTEGER(KIND=4) :: ydim8_bountt_kernel_eqF_zdir
    INTEGER(KIND=4) :: ydim8_bountt_kernel_eqF_zdir_h = -1
#define OPS_ACC8(x,y,z) ((x) + (xdim8_bountt_kernel_eqF_zdir*(y)) + (xdim8_bountt_kernel_eqF_zdir*ydim8_bountt_kernel_eqF_zdir*(z)) + 1)
...
SUBROUTINE bountt_kernel_eqF_zdir_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL bountt_kernel_eqF_zdir( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim1_bountt_kernel_eqF_zdir*xdim1_bountt_kernel_eqF_zdir*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim2_bountt_kernel_eqF_zdir*xdim2_bountt_kernel_eqF_zdir*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim3_bountt_kernel_eqF_zdir*xdim3_bountt_kernel_eqF_zdir*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim4_bountt_kernel_eqF_zdir*xdim4_bountt_kernel_eqF_zdir*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim5_bountt_kernel_eqF_zdir*xdim5_bountt_kernel_eqF_zdir*1)), &
                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim6_bountt_kernel_eqF_zdir*xdim6_bountt_kernel_eqF_zdir*1)), &
                opsDat7Local(dat7_base + ((n_x-1)*1) + ((n_y-1)*xdim7_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim7_bountt_kernel_eqF_zdir*xdim7_bountt_kernel_eqF_zdir*0)), &
                opsDat8Local(dat8_base + ((n_x-1)*1) + ((n_y-1)*xdim8_bountt_kernel_eqF_zdir*1) + ((n_z-1)*ydim8_bountt_kernel_eqF_zdir*xdim8_bountt_kernel_eqF_zdir*0)), &
                opsGblDat9Device(1), &
                opsGblDat10Device(1), &
                opsGblDat11Device(1), &
                opsGblDat12Device(1), &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bountt_kernel_eqF_zdir_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE bountt_kernel_eqF_zdir_host_execute( descPtr )
    ...
    kernelName = "bountt_kernel_eqF_zdir"
...
!   ==========================
    ...
    CALL setKernelTime(513, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim1 .NE. ydim1_bountt_kernel_eqF_zdir_h) .OR. &
         (xdim2 .NE. xdim2_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim2 .NE. ydim2_bountt_kernel_eqF_zdir_h) .OR. &
         (xdim3 .NE. xdim3_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim3 .NE. ydim3_bountt_kernel_eqF_zdir_h) .OR. &
         (xdim4 .NE. xdim4_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim4 .NE. ydim4_bountt_kernel_eqF_zdir_h) .OR. &
         (xdim5 .NE. xdim5_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim5 .NE. ydim5_bountt_kernel_eqF_zdir_h) .OR. &
         (xdim6 .NE. xdim6_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim6 .NE. ydim6_bountt_kernel_eqF_zdir_h) .OR. &
         (xdim7 .NE. xdim7_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim7 .NE. ydim7_bountt_kernel_eqF_zdir_h) .OR. &
         (xdim8 .NE. xdim8_bountt_kernel_eqF_zdir_h) .OR. &
         (ydim8 .NE. ydim8_bountt_kernel_eqF_zdir_h) &
       ) THEN
            xdim1_bountt_kernel_eqF_zdir = xdim1
            xdim1_bountt_kernel_eqF_zdir_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_bountt_kernel_eqF_zdir)
            ydim1_bountt_kernel_eqF_zdir = ydim1
            ydim1_bountt_kernel_eqF_zdir_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_bountt_kernel_eqF_zdir)
            xdim2_bountt_kernel_eqF_zdir = xdim2
            xdim2_bountt_kernel_eqF_zdir_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_bountt_kernel_eqF_zdir)
            ydim2_bountt_kernel_eqF_zdir = ydim2
            ydim2_bountt_kernel_eqF_zdir_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_bountt_kernel_eqF_zdir)
            xdim3_bountt_kernel_eqF_zdir = xdim3
            xdim3_bountt_kernel_eqF_zdir_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_bountt_kernel_eqF_zdir)
            ydim3_bountt_kernel_eqF_zdir = ydim3
            ydim3_bountt_kernel_eqF_zdir_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_bountt_kernel_eqF_zdir)
            xdim4_bountt_kernel_eqF_zdir = xdim4
            xdim4_bountt_kernel_eqF_zdir_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_bountt_kernel_eqF_zdir)
            ydim4_bountt_kernel_eqF_zdir = ydim4
            ydim4_bountt_kernel_eqF_zdir_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_bountt_kernel_eqF_zdir)
            xdim5_bountt_kernel_eqF_zdir = xdim5
            xdim5_bountt_kernel_eqF_zdir_h = xdim5
!$OMP TARGET UPDATE TO(xdim5_bountt_kernel_eqF_zdir)
            ydim5_bountt_kernel_eqF_zdir = ydim5
            ydim5_bountt_kernel_eqF_zdir_h = ydim5
!$OMP TARGET UPDATE TO(ydim5_bountt_kernel_eqF_zdir)
            xdim6_bountt_kernel_eqF_zdir = xdim6
            xdim6_bountt_kernel_eqF_zdir_h = xdim6
!$OMP TARGET UPDATE TO(xdim6_bountt_kernel_eqF_zdir)
            ydim6_bountt_kernel_eqF_zdir = ydim6
            ydim6_bountt_kernel_eqF_zdir_h = ydim6
!$OMP TARGET UPDATE TO(ydim6_bountt_kernel_eqF_zdir)
            xdim7_bountt_kernel_eqF_zdir = xdim7
            xdim7_bountt_kernel_eqF_zdir_h = xdim7
!$OMP TARGET UPDATE TO(xdim7_bountt_kernel_eqF_zdir)
            ydim7_bountt_kernel_eqF_zdir = ydim7
            ydim7_bountt_kernel_eqF_zdir_h = ydim7
!$OMP TARGET UPDATE TO(ydim7_bountt_kernel_eqF_zdir)
            xdim8_bountt_kernel_eqF_zdir = xdim8
            xdim8_bountt_kernel_eqF_zdir_h = xdim8
!$OMP TARGET UPDATE TO(xdim8_bountt_kernel_eqF_zdir)
            ydim8_bountt_kernel_eqF_zdir = ydim8
            ydim8_bountt_kernel_eqF_zdir_h = ydim8
!$OMP TARGET UPDATE TO(ydim8_bountt_kernel_eqF_zdir)
    END IF
...
!   ==============================
    CALL bountt_kernel_eqF_zdir_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
!   ========================
    ...
    CALL setKernelTime(513, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE bountt_kernel_eqF_zdir_host( userSubroutine, block, dim, range, &
    ...
    namelit = "bountt_kernel_eqF_zdir"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    16, 513, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bountt_kernel_eqF_zdir_host_execute))

END SUBROUTINE
#endif

END MODULE BOUNTT_KERNEL_EQF_ZDIR_MODULE
