! Auto-generated at 2026-04-28 18:44:30.564617 by ops-translator

MODULE MATHS_KERNEL_EQTAU_MODULE
...
!$OMP DECLARE TARGET(xdim1_maths_kernel_eqtau)
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqtau
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqtau_h = -1
!$OMP DECLARE TARGET(ydim1_maths_kernel_eqtau)
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqtau
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqtau_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_maths_kernel_eqtau*(y)) + (xdim1_maths_kernel_eqtau*ydim1_maths_kernel_eqtau*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_maths_kernel_eqtau)
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqtau
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqtau_h = -1
!$OMP DECLARE TARGET(ydim2_maths_kernel_eqtau)
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqtau
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqtau_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_maths_kernel_eqtau*(y)) + (xdim2_maths_kernel_eqtau*ydim2_maths_kernel_eqtau*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_maths_kernel_eqtau)
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqtau
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqtau_h = -1
!$OMP DECLARE TARGET(ydim3_maths_kernel_eqtau)
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqtau
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqtau_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_maths_kernel_eqtau*(y)) + (xdim3_maths_kernel_eqtau*ydim3_maths_kernel_eqtau*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_maths_kernel_eqtau)
    INTEGER(KIND=4) :: xdim4_maths_kernel_eqtau
    INTEGER(KIND=4) :: xdim4_maths_kernel_eqtau_h = -1
!$OMP DECLARE TARGET(ydim4_maths_kernel_eqtau)
    INTEGER(KIND=4) :: ydim4_maths_kernel_eqtau
    INTEGER(KIND=4) :: ydim4_maths_kernel_eqtau_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_maths_kernel_eqtau*(y)) + (xdim4_maths_kernel_eqtau*ydim4_maths_kernel_eqtau*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_maths_kernel_eqtau)
    INTEGER(KIND=4) :: xdim5_maths_kernel_eqtau
    INTEGER(KIND=4) :: xdim5_maths_kernel_eqtau_h = -1
!$OMP DECLARE TARGET(ydim5_maths_kernel_eqtau)
    INTEGER(KIND=4) :: ydim5_maths_kernel_eqtau
    INTEGER(KIND=4) :: ydim5_maths_kernel_eqtau_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_maths_kernel_eqtau*(y)) + (xdim5_maths_kernel_eqtau*ydim5_maths_kernel_eqtau*(z)) + 1)
...
SUBROUTINE maths_kernel_eqtau_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL maths_kernel_eqtau( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_maths_kernel_eqtau*1) + ((n_z-1)*ydim1_maths_kernel_eqtau*xdim1_maths_kernel_eqtau*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_maths_kernel_eqtau*1) + ((n_z-1)*ydim2_maths_kernel_eqtau*xdim2_maths_kernel_eqtau*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_maths_kernel_eqtau*1) + ((n_z-1)*ydim3_maths_kernel_eqtau*xdim3_maths_kernel_eqtau*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_maths_kernel_eqtau*1) + ((n_z-1)*ydim4_maths_kernel_eqtau*xdim4_maths_kernel_eqtau*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_maths_kernel_eqtau*1) + ((n_z-1)*ydim5_maths_kernel_eqtau*xdim5_maths_kernel_eqtau*1)), &
                opsGblDat6Device &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE maths_kernel_eqtau_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE maths_kernel_eqtau_host_execute( descPtr )
...
!   ==========================
    ...
    CALL setKernelTime(305, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_maths_kernel_eqtau_h) .OR. &
         (ydim1 .NE. ydim1_maths_kernel_eqtau_h) .OR. &
         (xdim2 .NE. xdim2_maths_kernel_eqtau_h) .OR. &
         (ydim2 .NE. ydim2_maths_kernel_eqtau_h) .OR. &
         (xdim3 .NE. xdim3_maths_kernel_eqtau_h) .OR. &
         (ydim3 .NE. ydim3_maths_kernel_eqtau_h) .OR. &
         (xdim4 .NE. xdim4_maths_kernel_eqtau_h) .OR. &
         (ydim4 .NE. ydim4_maths_kernel_eqtau_h) .OR. &
         (xdim5 .NE. xdim5_maths_kernel_eqtau_h) .OR. &
         (ydim5 .NE. ydim5_maths_kernel_eqtau_h) &
       ) THEN
            xdim1_maths_kernel_eqtau = xdim1
            xdim1_maths_kernel_eqtau_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_maths_kernel_eqtau)
            ydim1_maths_kernel_eqtau = ydim1
            ydim1_maths_kernel_eqtau_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_maths_kernel_eqtau)
            xdim2_maths_kernel_eqtau = xdim2
            xdim2_maths_kernel_eqtau_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_maths_kernel_eqtau)
            ydim2_maths_kernel_eqtau = ydim2
            ydim2_maths_kernel_eqtau_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_maths_kernel_eqtau)
            xdim3_maths_kernel_eqtau = xdim3
            xdim3_maths_kernel_eqtau_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_maths_kernel_eqtau)
            ydim3_maths_kernel_eqtau = ydim3
            ydim3_maths_kernel_eqtau_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_maths_kernel_eqtau)
            xdim4_maths_kernel_eqtau = xdim4
            xdim4_maths_kernel_eqtau_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_maths_kernel_eqtau)
            ydim4_maths_kernel_eqtau = ydim4
            ydim4_maths_kernel_eqtau_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_maths_kernel_eqtau)
            xdim5_maths_kernel_eqtau = xdim5
            xdim5_maths_kernel_eqtau_h = xdim5
!$OMP TARGET UPDATE TO(xdim5_maths_kernel_eqtau)
            ydim5_maths_kernel_eqtau = ydim5
            ydim5_maths_kernel_eqtau_h = ydim5
!$OMP TARGET UPDATE TO(ydim5_maths_kernel_eqtau)
    END IF
...
!   ========================
    ...
    CALL setKernelTime(305, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE maths_kernel_eqtau_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, 305, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(maths_kernel_eqtau_host_execute))

END SUBROUTINE
#endif

END MODULE MATHS_KERNEL_EQTAU_MODULE
