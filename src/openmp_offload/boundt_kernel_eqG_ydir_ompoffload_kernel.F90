! Auto-generated at 2026-04-28 18:44:32.850312 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: xdim1_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: xdim1_boundt_kernel_eqG_ydir_h = -1
!$OMP DECLARE TARGET(ydim1_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: ydim1_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: ydim1_boundt_kernel_eqG_ydir_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_boundt_kernel_eqG_ydir*(y)) + (xdim1_boundt_kernel_eqG_ydir*ydim1_boundt_kernel_eqG_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: xdim2_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: xdim2_boundt_kernel_eqG_ydir_h = -1
!$OMP DECLARE TARGET(ydim2_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: ydim2_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: ydim2_boundt_kernel_eqG_ydir_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_boundt_kernel_eqG_ydir*(y)) + (xdim2_boundt_kernel_eqG_ydir*ydim2_boundt_kernel_eqG_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: xdim3_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: xdim3_boundt_kernel_eqG_ydir_h = -1
!$OMP DECLARE TARGET(ydim3_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: ydim3_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: ydim3_boundt_kernel_eqG_ydir_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_boundt_kernel_eqG_ydir*(y)) + (xdim3_boundt_kernel_eqG_ydir*ydim3_boundt_kernel_eqG_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: xdim4_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: xdim4_boundt_kernel_eqG_ydir_h = -1
!$OMP DECLARE TARGET(ydim4_boundt_kernel_eqG_ydir)
    INTEGER(KIND=4) :: ydim4_boundt_kernel_eqG_ydir
    INTEGER(KIND=4) :: ydim4_boundt_kernel_eqG_ydir_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_boundt_kernel_eqG_ydir*(y)) + (xdim4_boundt_kernel_eqG_ydir*ydim4_boundt_kernel_eqG_ydir*(z)) + 1)
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_boundt_kernel_eqG_ydir*1) + ((n_z-1)*ydim1_boundt_kernel_eqG_ydir*xdim1_boundt_kernel_eqG_ydir*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_boundt_kernel_eqG_ydir*1) + ((n_z-1)*ydim2_boundt_kernel_eqG_ydir*xdim2_boundt_kernel_eqG_ydir*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_boundt_kernel_eqG_ydir*1) + ((n_z-1)*ydim3_boundt_kernel_eqG_ydir*xdim3_boundt_kernel_eqG_ydir*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_boundt_kernel_eqG_ydir*0) + ((n_z-1)*ydim4_boundt_kernel_eqG_ydir*xdim4_boundt_kernel_eqG_ydir*1)), &
                opsGblDat5Device(1), &
                opsGblDat6Device(1), &
                opsGblDat7Device(1), &
                opsGblDat8Device(1), &
...
SUBROUTINE boundt_kernel_eqG_ydir_host_execute( descPtr )
    ...
    kernelName = "boundt_kernel_eqG_ydir"
...
!   ==========================
    ...
    CALL setKernelTime(508, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_boundt_kernel_eqG_ydir_h) .OR. &
         (ydim1 .NE. ydim1_boundt_kernel_eqG_ydir_h) .OR. &
         (xdim2 .NE. xdim2_boundt_kernel_eqG_ydir_h) .OR. &
         (ydim2 .NE. ydim2_boundt_kernel_eqG_ydir_h) .OR. &
         (xdim3 .NE. xdim3_boundt_kernel_eqG_ydir_h) .OR. &
         (ydim3 .NE. ydim3_boundt_kernel_eqG_ydir_h) .OR. &
         (xdim4 .NE. xdim4_boundt_kernel_eqG_ydir_h) .OR. &
         (ydim4 .NE. ydim4_boundt_kernel_eqG_ydir_h) &
       ) THEN
            xdim1_boundt_kernel_eqG_ydir = xdim1
            xdim1_boundt_kernel_eqG_ydir_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_boundt_kernel_eqG_ydir)
            ydim1_boundt_kernel_eqG_ydir = ydim1
            ydim1_boundt_kernel_eqG_ydir_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_boundt_kernel_eqG_ydir)
            xdim2_boundt_kernel_eqG_ydir = xdim2
            xdim2_boundt_kernel_eqG_ydir_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_boundt_kernel_eqG_ydir)
            ydim2_boundt_kernel_eqG_ydir = ydim2
            ydim2_boundt_kernel_eqG_ydir_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_boundt_kernel_eqG_ydir)
            xdim3_boundt_kernel_eqG_ydir = xdim3
            xdim3_boundt_kernel_eqG_ydir_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_boundt_kernel_eqG_ydir)
            ydim3_boundt_kernel_eqG_ydir = ydim3
            ydim3_boundt_kernel_eqG_ydir_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_boundt_kernel_eqG_ydir)
            xdim4_boundt_kernel_eqG_ydir = xdim4
            xdim4_boundt_kernel_eqG_ydir_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_boundt_kernel_eqG_ydir)
            ydim4_boundt_kernel_eqG_ydir = ydim4
            ydim4_boundt_kernel_eqG_ydir_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_boundt_kernel_eqG_ydir)
    END IF
...
!   ========================
    ...
    CALL setKernelTime(508, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE boundt_kernel_eqG_ydir_host( userSubroutine, block, dim, range, &
    ...
    namelit = "boundt_kernel_eqG_ydir"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    12, 508, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(boundt_kernel_eqG_ydir_host_execute))

END SUBROUTINE
#endif

END MODULE BOUNDT_KERNEL_EQG_YDIR_MODULE
