! Auto-generated at 2026-04-28 18:44:33.094737 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim1_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim1_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim1_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim1_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim1_temper_kernel_eqD_h = -1
...
!$OMP DECLARE TARGET(xdim2_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim2_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim2_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim2_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim2_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim2_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(zdim2_temper_kernel_eqD)
    INTEGER(KIND=4) :: zdim2_temper_kernel_eqD
    INTEGER(KIND=4) :: zdim2_temper_kernel_eqD_h = -1
#define OPS_ACC_MD2(d,x,y,z) ((x) + (xdim2_temper_kernel_eqD*(y)) + (xdim2_temper_kernel_eqD*ydim2_temper_kernel_eqD*(z)) + (xdim2_temper_kernel_eqD*ydim2_temper_kernel_eqD*zdim2_temper_kernel_eqD*(d-1)) + 1)

!$OMP DECLARE TARGET(multi_d3)
    INTEGER(KIND=4) :: multi_d3
!$OMP DECLARE TARGET(xdim3_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim3_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim3_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim3_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim3_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim3_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(zdim3_temper_kernel_eqD)
    INTEGER(KIND=4) :: zdim3_temper_kernel_eqD
    INTEGER(KIND=4) :: zdim3_temper_kernel_eqD_h = -1
#define OPS_ACC_MD3(d,x,y,z) ((x) + (xdim3_temper_kernel_eqD*(y)) + (xdim3_temper_kernel_eqD*ydim3_temper_kernel_eqD*(z)) + (xdim3_temper_kernel_eqD*ydim3_temper_kernel_eqD*zdim3_temper_kernel_eqD*(d-1)) + 1)

!$OMP DECLARE TARGET(xdim4_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim4_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim4_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim4_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim4_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim4_temper_kernel_eqD_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_temper_kernel_eqD*(y)) + (xdim4_temper_kernel_eqD*ydim4_temper_kernel_eqD*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim5_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim5_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim5_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim5_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim5_temper_kernel_eqD_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_temper_kernel_eqD*(y)) + (xdim5_temper_kernel_eqD*ydim5_temper_kernel_eqD*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim6_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim6_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim6_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim6_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim6_temper_kernel_eqD_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_temper_kernel_eqD*(y)) + (xdim6_temper_kernel_eqD*ydim6_temper_kernel_eqD*(z)) + 1)

!$OMP DECLARE TARGET(xdim7_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim7_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim7_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim7_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim7_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim7_temper_kernel_eqD_h = -1
#define OPS_ACC7(x,y,z) ((x) + (xdim7_temper_kernel_eqD*(y)) + (xdim7_temper_kernel_eqD*ydim7_temper_kernel_eqD*(z)) + 1)

!$OMP DECLARE TARGET(xdim8_temper_kernel_eqD)
    INTEGER(KIND=4) :: xdim8_temper_kernel_eqD
    INTEGER(KIND=4) :: xdim8_temper_kernel_eqD_h = -1
!$OMP DECLARE TARGET(ydim8_temper_kernel_eqD)
    INTEGER(KIND=4) :: ydim8_temper_kernel_eqD
    INTEGER(KIND=4) :: ydim8_temper_kernel_eqD_h = -1
...
!$OMP TARGET TEAMS LOOP COLLAPSE(3) PRIVATE(n_x,n_y,n_z,idx_local)
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        ...
        idx_local = [idx_1+n_x-1, idx_2+n_y-1, idx_3+n_z-1]
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_temper_kernel_eqD*1) + ((n_z-1)*ydim1_temper_kernel_eqD*xdim1_temper_kernel_eqD*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_temper_kernel_eqD*1) + ((n_z-1)*ydim2_temper_kernel_eqD*xdim2_temper_kernel_eqD*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_temper_kernel_eqD*1) + ((n_z-1)*ydim3_temper_kernel_eqD*xdim3_temper_kernel_eqD*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_temper_kernel_eqD*1) + ((n_z-1)*ydim4_temper_kernel_eqD*xdim4_temper_kernel_eqD*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_temper_kernel_eqD*1) + ((n_z-1)*ydim5_temper_kernel_eqD*xdim5_temper_kernel_eqD*1)), &
                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6_temper_kernel_eqD*1) + ((n_z-1)*ydim6_temper_kernel_eqD*xdim6_temper_kernel_eqD*1)), &
                opsDat7Local(dat7_base + ((n_x-1)*1) + ((n_y-1)*xdim7_temper_kernel_eqD*1) + ((n_z-1)*ydim7_temper_kernel_eqD*xdim7_temper_kernel_eqD*1)), &
                opsDat8Local(dat8_base + ((n_x-1)*1) + ((n_y-1)*xdim8_temper_kernel_eqD*1) + ((n_z-1)*ydim8_temper_kernel_eqD*xdim8_temper_kernel_eqD*1)), &
                idx_local &
               )
...
!   ==========================
    ...
    CALL setKernelTime(562, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
...
!   ========================
    ...
    CALL setKernelTime(562, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE temper_kernel_eqD_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    9, 562, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(temper_kernel_eqD_host_execute))

END SUBROUTINE
#endif

END MODULE TEMPER_KERNEL_EQD_MODULE
