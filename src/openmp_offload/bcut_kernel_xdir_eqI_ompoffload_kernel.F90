! Auto-generated at 2026-04-28 18:44:30.636453 by ops-translator

MODULE BCUT_KERNEL_XDIR_EQI_MODULE
...
!$OMP DECLARE TARGET(xdim1_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim1_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim1_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim1_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim1_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim1_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_bcut_kernel_xdir_eqI*(y)) + (xdim1_bcut_kernel_xdir_eqI*ydim1_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim2_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim2_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim2_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim2_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim2_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_bcut_kernel_xdir_eqI*(y)) + (xdim2_bcut_kernel_xdir_eqI*ydim2_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim3_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim3_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim3_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim3_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim3_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_bcut_kernel_xdir_eqI*(y)) + (xdim3_bcut_kernel_xdir_eqI*ydim3_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim4_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim4_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim4_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim4_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim4_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_bcut_kernel_xdir_eqI*(y)) + (xdim4_bcut_kernel_xdir_eqI*ydim4_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim5_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim5_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim5_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim5_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim5_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_bcut_kernel_xdir_eqI*(y)) + (xdim5_bcut_kernel_xdir_eqI*ydim5_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim6_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim6_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim6_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim6_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim6_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_bcut_kernel_xdir_eqI*(y)) + (xdim6_bcut_kernel_xdir_eqI*ydim6_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim7_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim7_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim7_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim7_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim7_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim7_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC7(x,y,z) ((x) + (xdim7_bcut_kernel_xdir_eqI*(y)) + (xdim7_bcut_kernel_xdir_eqI*ydim7_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim8_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim8_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim8_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim8_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim8_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim8_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC8(x,y,z) ((x) + (xdim8_bcut_kernel_xdir_eqI*(y)) + (xdim8_bcut_kernel_xdir_eqI*ydim8_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim9_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim9_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim9_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim9_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim9_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim9_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC9(x,y,z) ((x) + (xdim9_bcut_kernel_xdir_eqI*(y)) + (xdim9_bcut_kernel_xdir_eqI*ydim9_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim10_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim10_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim10_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim10_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim10_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim10_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC10(x,y,z) ((x) + (xdim10_bcut_kernel_xdir_eqI*(y)) + (xdim10_bcut_kernel_xdir_eqI*ydim10_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim11_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim11_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim11_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim11_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim11_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim11_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC11(x,y,z) ((x) + (xdim11_bcut_kernel_xdir_eqI*(y)) + (xdim11_bcut_kernel_xdir_eqI*ydim11_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim12_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim12_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim12_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim12_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim12_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim12_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC12(x,y,z) ((x) + (xdim12_bcut_kernel_xdir_eqI*(y)) + (xdim12_bcut_kernel_xdir_eqI*ydim12_bcut_kernel_xdir_eqI*(z)) + 1)

!$OMP DECLARE TARGET(xdim13_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: xdim13_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: xdim13_bcut_kernel_xdir_eqI_h = -1
!$OMP DECLARE TARGET(ydim13_bcut_kernel_xdir_eqI)
    INTEGER(KIND=4) :: ydim13_bcut_kernel_xdir_eqI
    INTEGER(KIND=4) :: ydim13_bcut_kernel_xdir_eqI_h = -1
#define OPS_ACC13(x,y,z) ((x) + (xdim13_bcut_kernel_xdir_eqI*(y)) + (xdim13_bcut_kernel_xdir_eqI*ydim13_bcut_kernel_xdir_eqI*(z)) + 1)
...
SUBROUTINE bcut_kernel_xdir_eqI_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL bcut_kernel_xdir_eqI( &
                opsDat1Local(dat1_base + ((n_x-1)*0) + ((n_y-1)*xdim1_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim1_bcut_kernel_xdir_eqI*xdim1_bcut_kernel_xdir_eqI*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*0) + ((n_y-1)*xdim2_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim2_bcut_kernel_xdir_eqI*xdim2_bcut_kernel_xdir_eqI*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*0) + ((n_y-1)*xdim3_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim3_bcut_kernel_xdir_eqI*xdim3_bcut_kernel_xdir_eqI*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*0) + ((n_y-1)*xdim4_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim4_bcut_kernel_xdir_eqI*xdim4_bcut_kernel_xdir_eqI*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*0) + ((n_y-1)*xdim5_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim5_bcut_kernel_xdir_eqI*xdim5_bcut_kernel_xdir_eqI*1)), &
                opsDat6Local(dat6_base + ((n_x-1)*0) + ((n_y-1)*xdim6_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim6_bcut_kernel_xdir_eqI*xdim6_bcut_kernel_xdir_eqI*1)), &
                opsDat7Local(dat7_base + ((n_x-1)*0) + ((n_y-1)*xdim7_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim7_bcut_kernel_xdir_eqI*xdim7_bcut_kernel_xdir_eqI*1)), &
                opsDat8Local(dat8_base + ((n_x-1)*0) + ((n_y-1)*xdim8_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim8_bcut_kernel_xdir_eqI*xdim8_bcut_kernel_xdir_eqI*1)), &
                opsDat9Local(dat9_base + ((n_x-1)*0) + ((n_y-1)*xdim9_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim9_bcut_kernel_xdir_eqI*xdim9_bcut_kernel_xdir_eqI*1)), &
                opsDat10Local(dat10_base + ((n_x-1)*0) + ((n_y-1)*xdim10_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim10_bcut_kernel_xdir_eqI*xdim10_bcut_kernel_xdir_eqI*1)), &
                opsDat11Local(dat11_base + ((n_x-1)*0) + ((n_y-1)*xdim11_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim11_bcut_kernel_xdir_eqI*xdim11_bcut_kernel_xdir_eqI*1)), &
                opsDat12Local(dat12_base + ((n_x-1)*0) + ((n_y-1)*xdim12_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim12_bcut_kernel_xdir_eqI*xdim12_bcut_kernel_xdir_eqI*1)), &
                opsDat13Local(dat13_base + ((n_x-1)*0) + ((n_y-1)*xdim13_bcut_kernel_xdir_eqI*1) + ((n_z-1)*ydim13_bcut_kernel_xdir_eqI*xdim13_bcut_kernel_xdir_eqI*1)), &
                opsGblDat14Device, &
                opsGblDat15Device, &
                opsGblDat16Device, &
                opsGblDat17Device, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bcut_kernel_xdir_eqI_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE bcut_kernel_xdir_eqI_host_execute( descPtr )
    ...
    kernelName = "bcut_kernel_xdir_eqI"
...
!   ==========================
    ...
    CALL setKernelTime(326, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim1 .NE. ydim1_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim2 .NE. xdim2_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim2 .NE. ydim2_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim3 .NE. xdim3_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim3 .NE. ydim3_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim4 .NE. xdim4_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim4 .NE. ydim4_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim5 .NE. xdim5_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim5 .NE. ydim5_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim6 .NE. xdim6_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim6 .NE. ydim6_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim7 .NE. xdim7_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim7 .NE. ydim7_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim8 .NE. xdim8_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim8 .NE. ydim8_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim9 .NE. xdim9_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim9 .NE. ydim9_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim10 .NE. xdim10_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim10 .NE. ydim10_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim11 .NE. xdim11_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim11 .NE. ydim11_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim12 .NE. xdim12_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim12 .NE. ydim12_bcut_kernel_xdir_eqI_h) .OR. &
         (xdim13 .NE. xdim13_bcut_kernel_xdir_eqI_h) .OR. &
         (ydim13 .NE. ydim13_bcut_kernel_xdir_eqI_h) &
       ) THEN
            xdim1_bcut_kernel_xdir_eqI = xdim1
            xdim1_bcut_kernel_xdir_eqI_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_bcut_kernel_xdir_eqI)
            ydim1_bcut_kernel_xdir_eqI = ydim1
            ydim1_bcut_kernel_xdir_eqI_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_bcut_kernel_xdir_eqI)
            xdim2_bcut_kernel_xdir_eqI = xdim2
            xdim2_bcut_kernel_xdir_eqI_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_bcut_kernel_xdir_eqI)
            ydim2_bcut_kernel_xdir_eqI = ydim2
            ydim2_bcut_kernel_xdir_eqI_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_bcut_kernel_xdir_eqI)
            xdim3_bcut_kernel_xdir_eqI = xdim3
            xdim3_bcut_kernel_xdir_eqI_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_bcut_kernel_xdir_eqI)
            ydim3_bcut_kernel_xdir_eqI = ydim3
            ydim3_bcut_kernel_xdir_eqI_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_bcut_kernel_xdir_eqI)
            xdim4_bcut_kernel_xdir_eqI = xdim4
            xdim4_bcut_kernel_xdir_eqI_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_bcut_kernel_xdir_eqI)
            ydim4_bcut_kernel_xdir_eqI = ydim4
            ydim4_bcut_kernel_xdir_eqI_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_bcut_kernel_xdir_eqI)
            xdim5_bcut_kernel_xdir_eqI = xdim5
            xdim5_bcut_kernel_xdir_eqI_h = xdim5
!$OMP TARGET UPDATE TO(xdim5_bcut_kernel_xdir_eqI)
            ydim5_bcut_kernel_xdir_eqI = ydim5
            ydim5_bcut_kernel_xdir_eqI_h = ydim5
!$OMP TARGET UPDATE TO(ydim5_bcut_kernel_xdir_eqI)
            xdim6_bcut_kernel_xdir_eqI = xdim6
            xdim6_bcut_kernel_xdir_eqI_h = xdim6
!$OMP TARGET UPDATE TO(xdim6_bcut_kernel_xdir_eqI)
            ydim6_bcut_kernel_xdir_eqI = ydim6
            ydim6_bcut_kernel_xdir_eqI_h = ydim6
!$OMP TARGET UPDATE TO(ydim6_bcut_kernel_xdir_eqI)
            xdim7_bcut_kernel_xdir_eqI = xdim7
            xdim7_bcut_kernel_xdir_eqI_h = xdim7
!$OMP TARGET UPDATE TO(xdim7_bcut_kernel_xdir_eqI)
            ydim7_bcut_kernel_xdir_eqI = ydim7
            ydim7_bcut_kernel_xdir_eqI_h = ydim7
!$OMP TARGET UPDATE TO(ydim7_bcut_kernel_xdir_eqI)
            xdim8_bcut_kernel_xdir_eqI = xdim8
            xdim8_bcut_kernel_xdir_eqI_h = xdim8
!$OMP TARGET UPDATE TO(xdim8_bcut_kernel_xdir_eqI)
            ydim8_bcut_kernel_xdir_eqI = ydim8
            ydim8_bcut_kernel_xdir_eqI_h = ydim8
!$OMP TARGET UPDATE TO(ydim8_bcut_kernel_xdir_eqI)
            xdim9_bcut_kernel_xdir_eqI = xdim9
            xdim9_bcut_kernel_xdir_eqI_h = xdim9
!$OMP TARGET UPDATE TO(xdim9_bcut_kernel_xdir_eqI)
            ydim9_bcut_kernel_xdir_eqI = ydim9
            ydim9_bcut_kernel_xdir_eqI_h = ydim9
!$OMP TARGET UPDATE TO(ydim9_bcut_kernel_xdir_eqI)
            xdim10_bcut_kernel_xdir_eqI = xdim10
            xdim10_bcut_kernel_xdir_eqI_h = xdim10
!$OMP TARGET UPDATE TO(xdim10_bcut_kernel_xdir_eqI)
            ydim10_bcut_kernel_xdir_eqI = ydim10
            ydim10_bcut_kernel_xdir_eqI_h = ydim10
!$OMP TARGET UPDATE TO(ydim10_bcut_kernel_xdir_eqI)
            xdim11_bcut_kernel_xdir_eqI = xdim11
            xdim11_bcut_kernel_xdir_eqI_h = xdim11
!$OMP TARGET UPDATE TO(xdim11_bcut_kernel_xdir_eqI)
            ydim11_bcut_kernel_xdir_eqI = ydim11
            ydim11_bcut_kernel_xdir_eqI_h = ydim11
!$OMP TARGET UPDATE TO(ydim11_bcut_kernel_xdir_eqI)
            xdim12_bcut_kernel_xdir_eqI = xdim12
            xdim12_bcut_kernel_xdir_eqI_h = xdim12
!$OMP TARGET UPDATE TO(xdim12_bcut_kernel_xdir_eqI)
            ydim12_bcut_kernel_xdir_eqI = ydim12
            ydim12_bcut_kernel_xdir_eqI_h = ydim12
!$OMP TARGET UPDATE TO(ydim12_bcut_kernel_xdir_eqI)
            xdim13_bcut_kernel_xdir_eqI = xdim13
            xdim13_bcut_kernel_xdir_eqI_h = xdim13
!$OMP TARGET UPDATE TO(xdim13_bcut_kernel_xdir_eqI)
            ydim13_bcut_kernel_xdir_eqI = ydim13
            ydim13_bcut_kernel_xdir_eqI_h = ydim13
!$OMP TARGET UPDATE TO(ydim13_bcut_kernel_xdir_eqI)
    END IF
...
!   ==============================
    CALL bcut_kernel_xdir_eqI_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
!   ========================
    ...
    CALL setKernelTime(326, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE bcut_kernel_xdir_eqI_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    18, 326, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bcut_kernel_xdir_eqI_host_execute))

END SUBROUTINE
#endif

END MODULE BCUT_KERNEL_XDIR_EQI_MODULE
