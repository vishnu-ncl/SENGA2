! Auto-generated at 2026-04-28 18:44:30.267646 by ops-translator

MODULE MATHS_KERNEL_EQBA_MODULE
...
!$OMP DECLARE TARGET(xdim1_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim1_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqBA_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_maths_kernel_eqBA*(y)) + (xdim1_maths_kernel_eqBA*ydim1_maths_kernel_eqBA*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim2_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqBA_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_maths_kernel_eqBA*(y)) + (xdim2_maths_kernel_eqBA*ydim2_maths_kernel_eqBA*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim3_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqBA_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_maths_kernel_eqBA*(y)) + (xdim3_maths_kernel_eqBA*ydim3_maths_kernel_eqBA*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim4_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim4_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim4_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim4_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim4_maths_kernel_eqBA_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_maths_kernel_eqBA*(y)) + (xdim4_maths_kernel_eqBA*ydim4_maths_kernel_eqBA*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim5_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim5_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim5_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim5_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim5_maths_kernel_eqBA_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_maths_kernel_eqBA*(y)) + (xdim5_maths_kernel_eqBA*ydim5_maths_kernel_eqBA*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim6_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim6_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim6_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim6_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim6_maths_kernel_eqBA_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_maths_kernel_eqBA*(y)) + (xdim6_maths_kernel_eqBA*ydim6_maths_kernel_eqBA*(z)) + 1)

!$OMP DECLARE TARGET(xdim7_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim7_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim7_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim7_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim7_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim7_maths_kernel_eqBA_h = -1
#define OPS_ACC7(x,y,z) ((x) + (xdim7_maths_kernel_eqBA*(y)) + (xdim7_maths_kernel_eqBA*ydim7_maths_kernel_eqBA*(z)) + 1)

!$OMP DECLARE TARGET(xdim8_maths_kernel_eqBA)
    INTEGER(KIND=4) :: xdim8_maths_kernel_eqBA
    INTEGER(KIND=4) :: xdim8_maths_kernel_eqBA_h = -1
!$OMP DECLARE TARGET(ydim8_maths_kernel_eqBA)
    INTEGER(KIND=4) :: ydim8_maths_kernel_eqBA
    INTEGER(KIND=4) :: ydim8_maths_kernel_eqBA_h = -1
#define OPS_ACC8(x,y,z) ((x) + (xdim8_maths_kernel_eqBA*(y)) + (xdim8_maths_kernel_eqBA*ydim8_maths_kernel_eqBA*(z)) + 1)
...
SUBROUTINE maths_kernel_eqBA_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL maths_kernel_eqBA( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_maths_kernel_eqBA*1) + ((n_z-1)*ydim1_maths_kernel_eqBA*xdim1_maths_kernel_eqBA*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_maths_kernel_eqBA*1) + ((n_z-1)*ydim2_maths_kernel_eqBA*xdim2_maths_kernel_eqBA*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_maths_kernel_eqBA*1) + ((n_z-1)*ydim3_maths_kernel_eqBA*xdim3_maths_kernel_eqBA*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_maths_kernel_eqBA*1) + ((n_z-1)*ydim4_maths_kernel_eqBA*xdim4_maths_kernel_eqBA*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_maths_kernel_eqBA*1) + ((n_z-1)*ydim5_maths_kernel_eqBA*xdim5_maths_kernel_eqBA*1)), &
                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6_maths_kernel_eqBA*1) + ((n_z-1)*ydim6_maths_kernel_eqBA*xdim6_maths_kernel_eqBA*1)), &
                opsDat7Local(dat7_base + ((n_x-1)*1) + ((n_y-1)*xdim7_maths_kernel_eqBA*1) + ((n_z-1)*ydim7_maths_kernel_eqBA*xdim7_maths_kernel_eqBA*1)), &
                opsDat8Local(dat8_base + ((n_x-1)*1) + ((n_y-1)*xdim8_maths_kernel_eqBA*1) + ((n_z-1)*ydim8_maths_kernel_eqBA*xdim8_maths_kernel_eqBA*1)) &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE maths_kernel_eqBA_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE maths_kernel_eqBA_host_execute( descPtr )
...
!   ==========================
    ...
    CALL setKernelTime(244, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_maths_kernel_eqBA_h) .OR. &
         (ydim1 .NE. ydim1_maths_kernel_eqBA_h) .OR. &
         (xdim2 .NE. xdim2_maths_kernel_eqBA_h) .OR. &
         (ydim2 .NE. ydim2_maths_kernel_eqBA_h) .OR. &
         (xdim3 .NE. xdim3_maths_kernel_eqBA_h) .OR. &
         (ydim3 .NE. ydim3_maths_kernel_eqBA_h) .OR. &
         (xdim4 .NE. xdim4_maths_kernel_eqBA_h) .OR. &
         (ydim4 .NE. ydim4_maths_kernel_eqBA_h) .OR. &
         (xdim5 .NE. xdim5_maths_kernel_eqBA_h) .OR. &
         (ydim5 .NE. ydim5_maths_kernel_eqBA_h) .OR. &
         (xdim6 .NE. xdim6_maths_kernel_eqBA_h) .OR. &
         (ydim6 .NE. ydim6_maths_kernel_eqBA_h) .OR. &
         (xdim7 .NE. xdim7_maths_kernel_eqBA_h) .OR. &
         (ydim7 .NE. ydim7_maths_kernel_eqBA_h) .OR. &
         (xdim8 .NE. xdim8_maths_kernel_eqBA_h) .OR. &
         (ydim8 .NE. ydim8_maths_kernel_eqBA_h) &
       ) THEN
            xdim1_maths_kernel_eqBA = xdim1
            xdim1_maths_kernel_eqBA_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_maths_kernel_eqBA)
            ydim1_maths_kernel_eqBA = ydim1
            ydim1_maths_kernel_eqBA_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_maths_kernel_eqBA)
            xdim2_maths_kernel_eqBA = xdim2
            xdim2_maths_kernel_eqBA_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_maths_kernel_eqBA)
            ydim2_maths_kernel_eqBA = ydim2
            ydim2_maths_kernel_eqBA_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_maths_kernel_eqBA)
            xdim3_maths_kernel_eqBA = xdim3
            xdim3_maths_kernel_eqBA_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_maths_kernel_eqBA)
            ydim3_maths_kernel_eqBA = ydim3
            ydim3_maths_kernel_eqBA_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_maths_kernel_eqBA)
            xdim4_maths_kernel_eqBA = xdim4
            xdim4_maths_kernel_eqBA_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_maths_kernel_eqBA)
            ydim4_maths_kernel_eqBA = ydim4
            ydim4_maths_kernel_eqBA_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_maths_kernel_eqBA)
            xdim5_maths_kernel_eqBA = xdim5
            xdim5_maths_kernel_eqBA_h = xdim5
!$OMP TARGET UPDATE TO(xdim5_maths_kernel_eqBA)
            ydim5_maths_kernel_eqBA = ydim5
            ydim5_maths_kernel_eqBA_h = ydim5
!$OMP TARGET UPDATE TO(ydim5_maths_kernel_eqBA)
            xdim6_maths_kernel_eqBA = xdim6
            xdim6_maths_kernel_eqBA_h = xdim6
!$OMP TARGET UPDATE TO(xdim6_maths_kernel_eqBA)
            ydim6_maths_kernel_eqBA = ydim6
            ydim6_maths_kernel_eqBA_h = ydim6
!$OMP TARGET UPDATE TO(ydim6_maths_kernel_eqBA)
            xdim7_maths_kernel_eqBA = xdim7
            xdim7_maths_kernel_eqBA_h = xdim7
!$OMP TARGET UPDATE TO(xdim7_maths_kernel_eqBA)
            ydim7_maths_kernel_eqBA = ydim7
            ydim7_maths_kernel_eqBA_h = ydim7
!$OMP TARGET UPDATE TO(ydim7_maths_kernel_eqBA)
            xdim8_maths_kernel_eqBA = xdim8
            xdim8_maths_kernel_eqBA_h = xdim8
!$OMP TARGET UPDATE TO(xdim8_maths_kernel_eqBA)
            ydim8_maths_kernel_eqBA = ydim8
            ydim8_maths_kernel_eqBA_h = ydim8
!$OMP TARGET UPDATE TO(ydim8_maths_kernel_eqBA)
    END IF
...
!   ========================
    ...
    CALL setKernelTime(244, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE maths_kernel_eqBA_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    8, 244, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(maths_kernel_eqBA_host_execute))

END SUBROUTINE
#endif

END MODULE MATHS_KERNEL_EQBA_MODULE
