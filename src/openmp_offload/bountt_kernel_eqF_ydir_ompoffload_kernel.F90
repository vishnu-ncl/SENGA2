! Auto-generated at 2026-04-28 18:44:32.838739 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim1_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim1_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim1_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim1_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim1_bountt_kernel_eqF_ydir_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_bountt_kernel_eqF_ydir*(y)) + (xdim1_bountt_kernel_eqF_ydir*ydim1_bountt_kernel_eqF_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim2_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim2_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim2_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim2_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim2_bountt_kernel_eqF_ydir_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_bountt_kernel_eqF_ydir*(y)) + (xdim2_bountt_kernel_eqF_ydir*ydim2_bountt_kernel_eqF_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim3_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim3_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim3_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim3_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim3_bountt_kernel_eqF_ydir_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_bountt_kernel_eqF_ydir*(y)) + (xdim3_bountt_kernel_eqF_ydir*ydim3_bountt_kernel_eqF_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim4_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim4_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim4_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim4_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim4_bountt_kernel_eqF_ydir_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_bountt_kernel_eqF_ydir*(y)) + (xdim4_bountt_kernel_eqF_ydir*ydim4_bountt_kernel_eqF_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim5_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim5_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim5_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim5_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim5_bountt_kernel_eqF_ydir_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_bountt_kernel_eqF_ydir*(y)) + (xdim5_bountt_kernel_eqF_ydir*ydim5_bountt_kernel_eqF_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim6_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim6_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim6_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim6_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim6_bountt_kernel_eqF_ydir_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_bountt_kernel_eqF_ydir*(y)) + (xdim6_bountt_kernel_eqF_ydir*ydim6_bountt_kernel_eqF_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim7_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim7_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim7_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim7_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim7_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim7_bountt_kernel_eqF_ydir_h = -1
#define OPS_ACC7(x,y,z) ((x) + (xdim7_bountt_kernel_eqF_ydir*(y)) + (xdim7_bountt_kernel_eqF_ydir*ydim7_bountt_kernel_eqF_ydir*(z)) + 1)

!$OMP DECLARE TARGET(xdim8_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: xdim8_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: xdim8_bountt_kernel_eqF_ydir_h = -1
!$OMP DECLARE TARGET(ydim8_bountt_kernel_eqF_ydir)
    INTEGER(KIND=4) :: ydim8_bountt_kernel_eqF_ydir
    INTEGER(KIND=4) :: ydim8_bountt_kernel_eqF_ydir_h = -1
...
SUBROUTINE bountt_kernel_eqF_ydir_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL bountt_kernel_eqF_ydir( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_bountt_kernel_eqF_ydir*1) + ((n_z-1)*ydim1_bountt_kernel_eqF_ydir*xdim1_bountt_kernel_eqF_ydir*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_bountt_kernel_eqF_ydir*1) + ((n_z-1)*ydim2_bountt_kernel_eqF_ydir*xdim2_bountt_kernel_eqF_ydir*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_bountt_kernel_eqF_ydir*1) + ((n_z-1)*ydim3_bountt_kernel_eqF_ydir*xdim3_bountt_kernel_eqF_ydir*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_bountt_kernel_eqF_ydir*1) + ((n_z-1)*ydim4_bountt_kernel_eqF_ydir*xdim4_bountt_kernel_eqF_ydir*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_bountt_kernel_eqF_ydir*1) + ((n_z-1)*ydim5_bountt_kernel_eqF_ydir*xdim5_bountt_kernel_eqF_ydir*1)), &
                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6_bountt_kernel_eqF_ydir*1) + ((n_z-1)*ydim6_bountt_kernel_eqF_ydir*xdim6_bountt_kernel_eqF_ydir*1)), &
                opsDat7Local(dat7_base + ((n_x-1)*1) + ((n_y-1)*xdim7_bountt_kernel_eqF_ydir*0) + ((n_z-1)*ydim7_bountt_kernel_eqF_ydir*xdim7_bountt_kernel_eqF_ydir*1)), &
                opsDat8Local(dat8_base + ((n_x-1)*1) + ((n_y-1)*xdim8_bountt_kernel_eqF_ydir*0) + ((n_z-1)*ydim8_bountt_kernel_eqF_ydir*xdim8_bountt_kernel_eqF_ydir*1)), &
                opsGblDat9Device(1), &
                opsGblDat10Device(1), &
                opsGblDat11Device(1), &
                opsGblDat12Device(1), &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bountt_kernel_eqF_ydir_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE bountt_kernel_eqF_ydir_host_execute( descPtr )
    ...
    kernelName = "bountt_kernel_eqF_ydir"
...
!   ==========================
    ...
    CALL setKernelTime(505, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_bountt_kernel_eqF_ydir_h) .OR. &
...
!   ==============================
    CALL bountt_kernel_eqF_ydir_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
!   ========================
    ...
    CALL setKernelTime(505, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE bountt_kernel_eqF_ydir_host( userSubroutine, block, dim, range, &
    ...
    namelit = "bountt_kernel_eqF_ydir"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    16, 505, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bountt_kernel_eqF_ydir_host_execute))

END SUBROUTINE
#endif

END MODULE BOUNTT_KERNEL_EQF_YDIR_MODULE
