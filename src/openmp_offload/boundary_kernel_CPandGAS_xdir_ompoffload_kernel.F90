! Auto-generated at 2026-04-28 18:44:30.022048 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: xdim1_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: xdim1_boundary_kernel_CPandGAS_xdir_h = -1
!$OMP DECLARE TARGET(ydim1_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: ydim1_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: ydim1_boundary_kernel_CPandGAS_xdir_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_boundary_kernel_CPandGAS_xdir*(y)) + (xdim1_boundary_kernel_CPandGAS_xdir*ydim1_boundary_kernel_CPandGAS_xdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: xdim2_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: xdim2_boundary_kernel_CPandGAS_xdir_h = -1
!$OMP DECLARE TARGET(ydim2_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: ydim2_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: ydim2_boundary_kernel_CPandGAS_xdir_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_boundary_kernel_CPandGAS_xdir*(y)) + (xdim2_boundary_kernel_CPandGAS_xdir*ydim2_boundary_kernel_CPandGAS_xdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: xdim3_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: xdim3_boundary_kernel_CPandGAS_xdir_h = -1
!$OMP DECLARE TARGET(ydim3_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: ydim3_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: ydim3_boundary_kernel_CPandGAS_xdir_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_boundary_kernel_CPandGAS_xdir*(y)) + (xdim3_boundary_kernel_CPandGAS_xdir*ydim3_boundary_kernel_CPandGAS_xdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: xdim4_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: xdim4_boundary_kernel_CPandGAS_xdir_h = -1
!$OMP DECLARE TARGET(ydim4_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: ydim4_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: ydim4_boundary_kernel_CPandGAS_xdir_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_boundary_kernel_CPandGAS_xdir*(y)) + (xdim4_boundary_kernel_CPandGAS_xdir*ydim4_boundary_kernel_CPandGAS_xdir*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: xdim5_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: xdim5_boundary_kernel_CPandGAS_xdir_h = -1
!$OMP DECLARE TARGET(ydim5_boundary_kernel_CPandGAS_xdir)
    INTEGER(KIND=4) :: ydim5_boundary_kernel_CPandGAS_xdir
    INTEGER(KIND=4) :: ydim5_boundary_kernel_CPandGAS_xdir_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_boundary_kernel_CPandGAS_xdir*(y)) + (xdim5_boundary_kernel_CPandGAS_xdir*ydim5_boundary_kernel_CPandGAS_xdir*(z)) + 1)
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_boundary_kernel_CPandGAS_xdir*1) + ((n_z-1)*ydim1_boundary_kernel_CPandGAS_xdir*xdim1_boundary_kernel_CPandGAS_xdir*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_boundary_kernel_CPandGAS_xdir*1) + ((n_z-1)*ydim2_boundary_kernel_CPandGAS_xdir*xdim2_boundary_kernel_CPandGAS_xdir*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_boundary_kernel_CPandGAS_xdir*1) + ((n_z-1)*ydim3_boundary_kernel_CPandGAS_xdir*xdim3_boundary_kernel_CPandGAS_xdir*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*0) + ((n_y-1)*xdim4_boundary_kernel_CPandGAS_xdir*1) + ((n_z-1)*ydim4_boundary_kernel_CPandGAS_xdir*xdim4_boundary_kernel_CPandGAS_xdir*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*0) + ((n_y-1)*xdim5_boundary_kernel_CPandGAS_xdir*1) + ((n_z-1)*ydim5_boundary_kernel_CPandGAS_xdir*xdim5_boundary_kernel_CPandGAS_xdir*1)) &
               )
...
!   ==========================
    ...
    IF (&
         (xdim1 .NE. xdim1_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (ydim1 .NE. ydim1_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (xdim2 .NE. xdim2_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (ydim2 .NE. ydim2_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (xdim3 .NE. xdim3_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (ydim3 .NE. ydim3_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (xdim4 .NE. xdim4_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (ydim4 .NE. ydim4_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (xdim5 .NE. xdim5_boundary_kernel_CPandGAS_xdir_h) .OR. &
         (ydim5 .NE. ydim5_boundary_kernel_CPandGAS_xdir_h) &
       ) THEN
            xdim1_boundary_kernel_CPandGAS_xdir = xdim1
            xdim1_boundary_kernel_CPandGAS_xdir_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_boundary_kernel_CPandGAS_xdir)
            ydim1_boundary_kernel_CPandGAS_xdir = ydim1
            ydim1_boundary_kernel_CPandGAS_xdir_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_boundary_kernel_CPandGAS_xdir)
            xdim2_boundary_kernel_CPandGAS_xdir = xdim2
            xdim2_boundary_kernel_CPandGAS_xdir_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_boundary_kernel_CPandGAS_xdir)
            ydim2_boundary_kernel_CPandGAS_xdir = ydim2
            ydim2_boundary_kernel_CPandGAS_xdir_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_boundary_kernel_CPandGAS_xdir)
            xdim3_boundary_kernel_CPandGAS_xdir = xdim3
            xdim3_boundary_kernel_CPandGAS_xdir_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_boundary_kernel_CPandGAS_xdir)
            ydim3_boundary_kernel_CPandGAS_xdir = ydim3
            ydim3_boundary_kernel_CPandGAS_xdir_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_boundary_kernel_CPandGAS_xdir)
            xdim4_boundary_kernel_CPandGAS_xdir = xdim4
            xdim4_boundary_kernel_CPandGAS_xdir_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_boundary_kernel_CPandGAS_xdir)
            ydim4_boundary_kernel_CPandGAS_xdir = ydim4
            ydim4_boundary_kernel_CPandGAS_xdir_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_boundary_kernel_CPandGAS_xdir)
            xdim5_boundary_kernel_CPandGAS_xdir = xdim5
            xdim5_boundary_kernel_CPandGAS_xdir_h = xdim5
!$OMP TARGET UPDATE TO(xdim5_boundary_kernel_CPandGAS_xdir)
            ydim5_boundary_kernel_CPandGAS_xdir = ydim5
            ydim5_boundary_kernel_CPandGAS_xdir_h = ydim5
!$OMP TARGET UPDATE TO(ydim5_boundary_kernel_CPandGAS_xdir)
    END IF
