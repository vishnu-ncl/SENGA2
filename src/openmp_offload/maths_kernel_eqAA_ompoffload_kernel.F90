! Auto-generated at 2026-04-28 18:44:30.536271 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_maths_kernel_eqAA)
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqAA
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqAA_h = -1
!$OMP DECLARE TARGET(ydim1_maths_kernel_eqAA)
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqAA
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqAA_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_maths_kernel_eqAA*(y)) + (xdim1_maths_kernel_eqAA*ydim1_maths_kernel_eqAA*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_maths_kernel_eqAA)
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqAA
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqAA_h = -1
!$OMP DECLARE TARGET(ydim2_maths_kernel_eqAA)
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqAA
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqAA_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_maths_kernel_eqAA*(y)) + (xdim2_maths_kernel_eqAA*ydim2_maths_kernel_eqAA*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_maths_kernel_eqAA)
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqAA
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqAA_h = -1
!$OMP DECLARE TARGET(ydim3_maths_kernel_eqAA)
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqAA
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqAA_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_maths_kernel_eqAA*(y)) + (xdim3_maths_kernel_eqAA*ydim3_maths_kernel_eqAA*(z)) + 1)
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_maths_kernel_eqAA*1) + ((n_z-1)*ydim1_maths_kernel_eqAA*xdim1_maths_kernel_eqAA*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_maths_kernel_eqAA*1) + ((n_z-1)*ydim2_maths_kernel_eqAA*xdim2_maths_kernel_eqAA*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_maths_kernel_eqAA*1) + ((n_z-1)*ydim3_maths_kernel_eqAA*xdim3_maths_kernel_eqAA*1)) &
               )
...
!   ==========================
    ...
    IF (&
         (xdim1 .NE. xdim1_maths_kernel_eqAA_h) .OR. &
         (ydim1 .NE. ydim1_maths_kernel_eqAA_h) .OR. &
         (xdim2 .NE. xdim2_maths_kernel_eqAA_h) .OR. &
         (ydim2 .NE. ydim2_maths_kernel_eqAA_h) .OR. &
         (xdim3 .NE. xdim3_maths_kernel_eqAA_h) .OR. &
         (ydim3 .NE. ydim3_maths_kernel_eqAA_h) &
       ) THEN
            xdim1_maths_kernel_eqAA = xdim1
            xdim1_maths_kernel_eqAA_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_maths_kernel_eqAA)
            ydim1_maths_kernel_eqAA = ydim1
            ydim1_maths_kernel_eqAA_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_maths_kernel_eqAA)
            xdim2_maths_kernel_eqAA = xdim2
            xdim2_maths_kernel_eqAA_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_maths_kernel_eqAA)
            ydim2_maths_kernel_eqAA = ydim2
            ydim2_maths_kernel_eqAA_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_maths_kernel_eqAA)
            xdim3_maths_kernel_eqAA = xdim3
            xdim3_maths_kernel_eqAA_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_maths_kernel_eqAA)
            ydim3_maths_kernel_eqAA = ydim3
            ydim3_maths_kernel_eqAA_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_maths_kernel_eqAA)
    END IF
...
SUBROUTINE maths_kernel_eqAA_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    3, 299, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(maths_kernel_eqAA_host_execute))

END SUBROUTINE
#endif

END MODULE MATHS_KERNEL_EQAA_MODULE
