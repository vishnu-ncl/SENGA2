! Auto-generated at 2026-04-28 18:44:30.211028 by ops-translator

MODULE COPY_KERNEL_SDIM_TO_MDIM_MODULE
...
!$OMP DECLARE TARGET(xdim1_copy_kernel_sdim_to_mdim)
    INTEGER(KIND=4) :: xdim1_copy_kernel_sdim_to_mdim
    INTEGER(KIND=4) :: xdim1_copy_kernel_sdim_to_mdim_h = -1
!$OMP DECLARE TARGET(ydim1_copy_kernel_sdim_to_mdim)
    INTEGER(KIND=4) :: ydim1_copy_kernel_sdim_to_mdim
    INTEGER(KIND=4) :: ydim1_copy_kernel_sdim_to_mdim_h = -1
!$OMP DECLARE TARGET(zdim1_copy_kernel_sdim_to_mdim)
    INTEGER(KIND=4) :: zdim1_copy_kernel_sdim_to_mdim
    INTEGER(KIND=4) :: zdim1_copy_kernel_sdim_to_mdim_h = -1
#define OPS_ACC_MD1(d,x,y,z) ((x) + (xdim1_copy_kernel_sdim_to_mdim*(y)) + (xdim1_copy_kernel_sdim_to_mdim*ydim1_copy_kernel_sdim_to_mdim*(z)) + (xdim1_copy_kernel_sdim_to_mdim*ydim1_copy_kernel_sdim_to_mdim*zdim1_copy_kernel_sdim_to_mdim*(d-1)) + 1)

!$OMP DECLARE TARGET(xdim2_copy_kernel_sdim_to_mdim)
    INTEGER(KIND=4) :: xdim2_copy_kernel_sdim_to_mdim
    INTEGER(KIND=4) :: xdim2_copy_kernel_sdim_to_mdim_h = -1
!$OMP DECLARE TARGET(ydim2_copy_kernel_sdim_to_mdim)
    INTEGER(KIND=4) :: ydim2_copy_kernel_sdim_to_mdim
    INTEGER(KIND=4) :: ydim2_copy_kernel_sdim_to_mdim_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_copy_kernel_sdim_to_mdim*(y)) + (xdim2_copy_kernel_sdim_to_mdim*ydim2_copy_kernel_sdim_to_mdim*(z)) + 1)
...
SUBROUTINE copy_kernel_sdim_to_mdim_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsGblDat3Device, &
    dat1_base, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL copy_kernel_sdim_to_mdim( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_copy_kernel_sdim_to_mdim*1) + ((n_z-1)*ydim1_copy_kernel_sdim_to_mdim*xdim1_copy_kernel_sdim_to_mdim*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_copy_kernel_sdim_to_mdim*1) + ((n_z-1)*ydim2_copy_kernel_sdim_to_mdim*xdim2_copy_kernel_sdim_to_mdim*1)), &
                opsGblDat3Device &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE copy_kernel_sdim_to_mdim_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3 &
    )
...
#else
SUBROUTINE copy_kernel_sdim_to_mdim_host_execute( descPtr )
    ...
    kernelName = "copy_kernel_sdim_to_mdim"
...
!   ==========================
    ...
    CALL setKernelTime(234, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
...
!$OMP TARGET UPDATE TO(multi_d1)
    ...
    IF (&
         (xdim1 .NE. xdim1_copy_kernel_sdim_to_mdim_h) .OR. &
         (ydim1 .NE. ydim1_copy_kernel_sdim_to_mdim_h) .OR. &
         (zdim1 .NE. zdim1_copy_kernel_sdim_to_mdim_h) .OR. &
         (xdim2 .NE. xdim2_copy_kernel_sdim_to_mdim_h) .OR. &
         (ydim2 .NE. ydim2_copy_kernel_sdim_to_mdim_h) &
       ) THEN
            xdim1_copy_kernel_sdim_to_mdim = xdim1
            xdim1_copy_kernel_sdim_to_mdim_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_copy_kernel_sdim_to_mdim)
            ydim1_copy_kernel_sdim_to_mdim = ydim1
            ydim1_copy_kernel_sdim_to_mdim_h = ydim1
            zdim1_copy_kernel_sdim_to_mdim = zdim1
            zdim1_copy_kernel_sdim_to_mdim_h = zdim1
!$OMP TARGET UPDATE TO(ydim1_copy_kernel_sdim_to_mdim,zdim1_copy_kernel_sdim_to_mdim)
            xdim2_copy_kernel_sdim_to_mdim = xdim2
            xdim2_copy_kernel_sdim_to_mdim_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_copy_kernel_sdim_to_mdim)
            ydim2_copy_kernel_sdim_to_mdim = ydim2
            ydim2_copy_kernel_sdim_to_mdim_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_copy_kernel_sdim_to_mdim)
    END IF
...
!   ==============================
    CALL copy_kernel_sdim_to_mdim_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local(1), &
                        dat1_base, &
...
!   ========================
    ...
    CALL setKernelTime(234, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE copy_kernel_sdim_to_mdim_host( userSubroutine, block, dim, range, &
    ...
    namelit = "copy_kernel_sdim_to_mdim"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    3, 234, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(copy_kernel_sdim_to_mdim_host_execute))

END SUBROUTINE
#endif

END MODULE COPY_KERNEL_SDIM_TO_MDIM_MODULE
