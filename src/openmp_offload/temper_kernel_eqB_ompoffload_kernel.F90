! Auto-generated at 2026-04-28 18:44:33.087610 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_temper_kernel_eqB)
    INTEGER(KIND=4) :: xdim1_temper_kernel_eqB
    INTEGER(KIND=4) :: xdim1_temper_kernel_eqB_h = -1
!$OMP DECLARE TARGET(ydim1_temper_kernel_eqB)
    INTEGER(KIND=4) :: ydim1_temper_kernel_eqB
    INTEGER(KIND=4) :: ydim1_temper_kernel_eqB_h = -1
!$OMP DECLARE TARGET(zdim1_temper_kernel_eqB)
    INTEGER(KIND=4) :: zdim1_temper_kernel_eqB
    INTEGER(KIND=4) :: zdim1_temper_kernel_eqB_h = -1
#define OPS_ACC_MD1(d,x,y,z) ((x) + (xdim1_temper_kernel_eqB*(y)) + (xdim1_temper_kernel_eqB*ydim1_temper_kernel_eqB*(z)) + (xdim1_temper_kernel_eqB*ydim1_temper_kernel_eqB*zdim1_temper_kernel_eqB*(d-1)) + 1)

!$OMP DECLARE TARGET(multi_d2)
    INTEGER(KIND=4) :: multi_d2
!$OMP DECLARE TARGET(xdim2_temper_kernel_eqB)
    INTEGER(KIND=4) :: xdim2_temper_kernel_eqB
    INTEGER(KIND=4) :: xdim2_temper_kernel_eqB_h = -1
!$OMP DECLARE TARGET(ydim2_temper_kernel_eqB)
    INTEGER(KIND=4) :: ydim2_temper_kernel_eqB
    INTEGER(KIND=4) :: ydim2_temper_kernel_eqB_h = -1
!$OMP DECLARE TARGET(zdim2_temper_kernel_eqB)
    INTEGER(KIND=4) :: zdim2_temper_kernel_eqB
    INTEGER(KIND=4) :: zdim2_temper_kernel_eqB_h = -1
#define OPS_ACC_MD2(d,x,y,z) ((x) + (xdim2_temper_kernel_eqB*(y)) + (xdim2_temper_kernel_eqB*ydim2_temper_kernel_eqB*(z)) + (xdim2_temper_kernel_eqB*ydim2_temper_kernel_eqB*zdim2_temper_kernel_eqB*(d-1)) + 1)

!$OMP DECLARE TARGET(xdim3_temper_kernel_eqB)
    INTEGER(KIND=4) :: xdim3_temper_kernel_eqB
    INTEGER(KIND=4) :: xdim3_temper_kernel_eqB_h = -1
!$OMP DECLARE TARGET(ydim3_temper_kernel_eqB)
    INTEGER(KIND=4) :: ydim3_temper_kernel_eqB
    INTEGER(KIND=4) :: ydim3_temper_kernel_eqB_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_temper_kernel_eqB*(y)) + (xdim3_temper_kernel_eqB*ydim3_temper_kernel_eqB*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_temper_kernel_eqB)
    INTEGER(KIND=4) :: xdim4_temper_kernel_eqB
    INTEGER(KIND=4) :: xdim4_temper_kernel_eqB_h = -1
!$OMP DECLARE TARGET(ydim4_temper_kernel_eqB)
    INTEGER(KIND=4) :: ydim4_temper_kernel_eqB
    INTEGER(KIND=4) :: ydim4_temper_kernel_eqB_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_temper_kernel_eqB*(y)) + (xdim4_temper_kernel_eqB*ydim4_temper_kernel_eqB*(z)) + 1)
...
SUBROUTINE temper_kernel_eqB_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL temper_kernel_eqB( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_temper_kernel_eqB*1) + ((n_z-1)*ydim1_temper_kernel_eqB*xdim1_temper_kernel_eqB*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_temper_kernel_eqB*1) + ((n_z-1)*ydim2_temper_kernel_eqB*xdim2_temper_kernel_eqB*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_temper_kernel_eqB*1) + ((n_z-1)*ydim3_temper_kernel_eqB*xdim3_temper_kernel_eqB*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_temper_kernel_eqB*1) + ((n_z-1)*ydim4_temper_kernel_eqB*xdim4_temper_kernel_eqB*1)), &
                opsGblDat5Device(1), &
                opsGblDat6Device(1), &
                opsGblDat7Device(1), &
                opsGblDat8Device(1), &
...
#else
SUBROUTINE temper_kernel_eqB_host_execute( descPtr )
...
!   ==========================
    ...
    CALL setKernelTime(560, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
...
!$OMP TARGET UPDATE TO(multi_d2)
    ...
    IF (&
         (xdim1 .NE. xdim1_temper_kernel_eqB_h) .OR. &
         (ydim1 .NE. ydim1_temper_kernel_eqB_h) .OR. &
         (zdim1 .NE. zdim1_temper_kernel_eqB_h) .OR. &
         (xdim2 .NE. xdim2_temper_kernel_eqB_h) .OR. &
         (ydim2 .NE. ydim2_temper_kernel_eqB_h) .OR. &
         (zdim2 .NE. zdim2_temper_kernel_eqB_h) .OR. &
         (xdim3 .NE. xdim3_temper_kernel_eqB_h) .OR. &
         (ydim3 .NE. ydim3_temper_kernel_eqB_h) .OR. &
         (xdim4 .NE. xdim4_temper_kernel_eqB_h) .OR. &
         (ydim4 .NE. ydim4_temper_kernel_eqB_h) &
       ) THEN
            xdim1_temper_kernel_eqB = xdim1
            xdim1_temper_kernel_eqB_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_temper_kernel_eqB)
            ydim1_temper_kernel_eqB = ydim1
            ydim1_temper_kernel_eqB_h = ydim1
            zdim1_temper_kernel_eqB = zdim1
            zdim1_temper_kernel_eqB_h = zdim1
!$OMP TARGET UPDATE TO(ydim1_temper_kernel_eqB,zdim1_temper_kernel_eqB)
            xdim2_temper_kernel_eqB = xdim2
            xdim2_temper_kernel_eqB_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_temper_kernel_eqB)
            ydim2_temper_kernel_eqB = ydim2
            ydim2_temper_kernel_eqB_h = ydim2
            zdim2_temper_kernel_eqB = zdim2
            zdim2_temper_kernel_eqB_h = zdim2
!$OMP TARGET UPDATE TO(ydim2_temper_kernel_eqB,zdim2_temper_kernel_eqB)
            xdim3_temper_kernel_eqB = xdim3
            xdim3_temper_kernel_eqB_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_temper_kernel_eqB)
            ydim3_temper_kernel_eqB = ydim3
            ydim3_temper_kernel_eqB_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_temper_kernel_eqB)
            xdim4_temper_kernel_eqB = xdim4
            xdim4_temper_kernel_eqB_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_temper_kernel_eqB)
            ydim4_temper_kernel_eqB = ydim4
            ydim4_temper_kernel_eqB_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_temper_kernel_eqB)
    END IF
...
!   ========================
    ...
    CALL setKernelTime(560, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE temper_kernel_eqB_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    12, 560, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(temper_kernel_eqB_host_execute))
