! Auto-generated at 2026-04-28 18:44:30.365514 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_hf_kernel_eqG)
    INTEGER(KIND=4) :: xdim1_hf_kernel_eqG
    INTEGER(KIND=4) :: xdim1_hf_kernel_eqG_h = -1
!$OMP DECLARE TARGET(ydim1_hf_kernel_eqG)
    INTEGER(KIND=4) :: ydim1_hf_kernel_eqG
...
!$OMP DECLARE TARGET(xdim2_hf_kernel_eqG)
    INTEGER(KIND=4) :: xdim2_hf_kernel_eqG
    INTEGER(KIND=4) :: xdim2_hf_kernel_eqG_h = -1
!$OMP DECLARE TARGET(ydim2_hf_kernel_eqG)
    INTEGER(KIND=4) :: ydim2_hf_kernel_eqG
...
!$OMP DECLARE TARGET(xdim3_hf_kernel_eqG)
    INTEGER(KIND=4) :: xdim3_hf_kernel_eqG
    INTEGER(KIND=4) :: xdim3_hf_kernel_eqG_h = -1
!$OMP DECLARE TARGET(ydim3_hf_kernel_eqG)
    INTEGER(KIND=4) :: ydim3_hf_kernel_eqG
...
!$OMP DECLARE TARGET(xdim4_hf_kernel_eqG)
    INTEGER(KIND=4) :: xdim4_hf_kernel_eqG
    INTEGER(KIND=4) :: xdim4_hf_kernel_eqG_h = -1
!$OMP DECLARE TARGET(ydim4_hf_kernel_eqG)
    INTEGER(KIND=4) :: ydim4_hf_kernel_eqG
...
!$OMP DECLARE TARGET(xdim5_hf_kernel_eqG)
    INTEGER(KIND=4) :: xdim5_hf_kernel_eqG
    INTEGER(KIND=4) :: xdim5_hf_kernel_eqG_h = -1
!$OMP DECLARE TARGET(ydim5_hf_kernel_eqG)
    INTEGER(KIND=4) :: ydim5_hf_kernel_eqG
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL hf_kernel_eqG( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_hf_kernel_eqG*1) + ((n_z-1)*ydim1_hf_kernel_eqG*xdim1_hf_kernel_eqG*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_hf_kernel_eqG*1) + ((n_z-1)*ydim2_hf_kernel_eqG*xdim2_hf_kernel_eqG*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_hf_kernel_eqG*1) + ((n_z-1)*ydim3_hf_kernel_eqG*xdim3_hf_kernel_eqG*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_hf_kernel_eqG*1) + ((n_z-1)*ydim4_hf_kernel_eqG*xdim4_hf_kernel_eqG*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_hf_kernel_eqG*1) + ((n_z-1)*ydim5_hf_kernel_eqG*xdim5_hf_kernel_eqG*1)), &
                opsGblDat6Device, &
                opsGblDat7Device &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE hf_kernel_eqG_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE hf_kernel_eqG_host_execute( descPtr )
