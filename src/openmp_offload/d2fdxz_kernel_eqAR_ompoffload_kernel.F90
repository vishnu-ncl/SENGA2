! Auto-generated at 2026-04-28 18:44:29.394919 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_d2fdxz_kernel_eqAR)
    INTEGER(KIND=4) :: xdim1_d2fdxz_kernel_eqAR
    INTEGER(KIND=4) :: xdim1_d2fdxz_kernel_eqAR_h = -1
!$OMP DECLARE TARGET(ydim1_d2fdxz_kernel_eqAR)
    INTEGER(KIND=4) :: ydim1_d2fdxz_kernel_eqAR
...
!$OMP DECLARE TARGET(xdim2_d2fdxz_kernel_eqAR)
    INTEGER(KIND=4) :: xdim2_d2fdxz_kernel_eqAR
    INTEGER(KIND=4) :: xdim2_d2fdxz_kernel_eqAR_h = -1
!$OMP DECLARE TARGET(ydim2_d2fdxz_kernel_eqAR)
    INTEGER(KIND=4) :: ydim2_d2fdxz_kernel_eqAR
...
SUBROUTINE d2fdxz_kernel_eqAR_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    dat1_base, &
    dat2_base, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL d2fdxz_kernel_eqAR( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_d2fdxz_kernel_eqAR*1) + ((n_z-1)*ydim1_d2fdxz_kernel_eqAR*xdim1_d2fdxz_kernel_eqAR*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_d2fdxz_kernel_eqAR*1) + ((n_z-1)*ydim2_d2fdxz_kernel_eqAR*xdim2_d2fdxz_kernel_eqAR*1)) &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE d2fdxz_kernel_eqAR_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2 &
    )
...
#else
SUBROUTINE d2fdxz_kernel_eqAR_host_execute( descPtr )
