! Auto-generated at 2026-04-28 18:44:33.079845 by ops-translator

MODULE TEMPER_KERNEL_EQA_MODULE
...
!$OMP DECLARE TARGET(multi_d1)
    INTEGER(KIND=4) :: multi_d1
!$OMP DECLARE TARGET(xdim1_temper_kernel_eqA)
    INTEGER(KIND=4) :: xdim1_temper_kernel_eqA
    INTEGER(KIND=4) :: xdim1_temper_kernel_eqA_h = -1
!$OMP DECLARE TARGET(ydim1_temper_kernel_eqA)
    INTEGER(KIND=4) :: ydim1_temper_kernel_eqA
    INTEGER(KIND=4) :: ydim1_temper_kernel_eqA_h = -1
!$OMP DECLARE TARGET(zdim1_temper_kernel_eqA)
    INTEGER(KIND=4) :: zdim1_temper_kernel_eqA
    INTEGER(KIND=4) :: zdim1_temper_kernel_eqA_h = -1
#define OPS_ACC_MD1(d,x,y,z) ((x) + (xdim1_temper_kernel_eqA*(y)) + (xdim1_temper_kernel_eqA*ydim1_temper_kernel_eqA*(z)) + (xdim1_temper_kernel_eqA*ydim1_temper_kernel_eqA*zdim1_temper_kernel_eqA*(d-1)) + 1)

!$OMP DECLARE TARGET(xdim2_temper_kernel_eqA)
    INTEGER(KIND=4) :: xdim2_temper_kernel_eqA
    INTEGER(KIND=4) :: xdim2_temper_kernel_eqA_h = -1
!$OMP DECLARE TARGET(ydim2_temper_kernel_eqA)
    INTEGER(KIND=4) :: ydim2_temper_kernel_eqA
    INTEGER(KIND=4) :: ydim2_temper_kernel_eqA_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_temper_kernel_eqA*(y)) + (xdim2_temper_kernel_eqA*ydim2_temper_kernel_eqA*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_temper_kernel_eqA)
    INTEGER(KIND=4) :: xdim3_temper_kernel_eqA
    INTEGER(KIND=4) :: xdim3_temper_kernel_eqA_h = -1
!$OMP DECLARE TARGET(ydim3_temper_kernel_eqA)
    INTEGER(KIND=4) :: ydim3_temper_kernel_eqA
    INTEGER(KIND=4) :: ydim3_temper_kernel_eqA_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_temper_kernel_eqA*(y)) + (xdim3_temper_kernel_eqA*ydim3_temper_kernel_eqA*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_temper_kernel_eqA)
    INTEGER(KIND=4) :: xdim4_temper_kernel_eqA
    INTEGER(KIND=4) :: xdim4_temper_kernel_eqA_h = -1
!$OMP DECLARE TARGET(ydim4_temper_kernel_eqA)
    INTEGER(KIND=4) :: ydim4_temper_kernel_eqA
    INTEGER(KIND=4) :: ydim4_temper_kernel_eqA_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_temper_kernel_eqA*(y)) + (xdim4_temper_kernel_eqA*ydim4_temper_kernel_eqA*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_temper_kernel_eqA)
    INTEGER(KIND=4) :: xdim5_temper_kernel_eqA
    INTEGER(KIND=4) :: xdim5_temper_kernel_eqA_h = -1
!$OMP DECLARE TARGET(ydim5_temper_kernel_eqA)
    INTEGER(KIND=4) :: ydim5_temper_kernel_eqA
    INTEGER(KIND=4) :: ydim5_temper_kernel_eqA_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_temper_kernel_eqA*(y)) + (xdim5_temper_kernel_eqA*ydim5_temper_kernel_eqA*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_temper_kernel_eqA)
    INTEGER(KIND=4) :: xdim6_temper_kernel_eqA
    INTEGER(KIND=4) :: xdim6_temper_kernel_eqA_h = -1
!$OMP DECLARE TARGET(ydim6_temper_kernel_eqA)
    INTEGER(KIND=4) :: ydim6_temper_kernel_eqA
    INTEGER(KIND=4) :: ydim6_temper_kernel_eqA_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_temper_kernel_eqA*(y)) + (xdim6_temper_kernel_eqA*ydim6_temper_kernel_eqA*(z)) + 1)
...
SUBROUTINE temper_kernel_eqA_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL temper_kernel_eqA( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_temper_kernel_eqA*1) + ((n_z-1)*ydim1_temper_kernel_eqA*xdim1_temper_kernel_eqA*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_temper_kernel_eqA*1) + ((n_z-1)*ydim2_temper_kernel_eqA*xdim2_temper_kernel_eqA*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_temper_kernel_eqA*1) + ((n_z-1)*ydim3_temper_kernel_eqA*xdim3_temper_kernel_eqA*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_temper_kernel_eqA*1) + ((n_z-1)*ydim4_temper_kernel_eqA*xdim4_temper_kernel_eqA*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_temper_kernel_eqA*1) + ((n_z-1)*ydim5_temper_kernel_eqA*xdim5_temper_kernel_eqA*1)), &
                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6_temper_kernel_eqA*1) + ((n_z-1)*ydim6_temper_kernel_eqA*xdim6_temper_kernel_eqA*1)) &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE temper_kernel_eqA_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE temper_kernel_eqA_host_execute( descPtr )
...
!   ==========================
    ...
    CALL setKernelTime(558, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    multi_d1 = getDatDimFromOpsArg(opsArg1) ! dimension of dat
!$OMP TARGET UPDATE TO(multi_d1)
    dat1_base = getDatBaseFromOpsArg3D(opsArg1, start_indx, multi_d1)
    ...
    IF (&
         (xdim1 .NE. xdim1_temper_kernel_eqA_h) .OR. &
         (ydim1 .NE. ydim1_temper_kernel_eqA_h) .OR. &
         (zdim1 .NE. zdim1_temper_kernel_eqA_h) .OR. &
         (xdim2 .NE. xdim2_temper_kernel_eqA_h) .OR. &
         (ydim2 .NE. ydim2_temper_kernel_eqA_h) .OR. &
         (xdim3 .NE. xdim3_temper_kernel_eqA_h) .OR. &
         (ydim3 .NE. ydim3_temper_kernel_eqA_h) .OR. &
         (xdim4 .NE. xdim4_temper_kernel_eqA_h) .OR. &
         (ydim4 .NE. ydim4_temper_kernel_eqA_h) .OR. &
         (xdim5 .NE. xdim5_temper_kernel_eqA_h) .OR. &
         (ydim5 .NE. ydim5_temper_kernel_eqA_h) .OR. &
         (xdim6 .NE. xdim6_temper_kernel_eqA_h) .OR. &
         (ydim6 .NE. ydim6_temper_kernel_eqA_h) &
       ) THEN
            xdim1_temper_kernel_eqA = xdim1
            xdim1_temper_kernel_eqA_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_temper_kernel_eqA)
            ydim1_temper_kernel_eqA = ydim1
            ydim1_temper_kernel_eqA_h = ydim1
            zdim1_temper_kernel_eqA = zdim1
            zdim1_temper_kernel_eqA_h = zdim1
!$OMP TARGET UPDATE TO(ydim1_temper_kernel_eqA,zdim1_temper_kernel_eqA)
            xdim2_temper_kernel_eqA = xdim2
            xdim2_temper_kernel_eqA_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_temper_kernel_eqA)
            ydim2_temper_kernel_eqA = ydim2
            ydim2_temper_kernel_eqA_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_temper_kernel_eqA)
            xdim3_temper_kernel_eqA = xdim3
            xdim3_temper_kernel_eqA_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_temper_kernel_eqA)
            ydim3_temper_kernel_eqA = ydim3
            ydim3_temper_kernel_eqA_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_temper_kernel_eqA)
            xdim4_temper_kernel_eqA = xdim4
            xdim4_temper_kernel_eqA_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_temper_kernel_eqA)
            ydim4_temper_kernel_eqA = ydim4
            ydim4_temper_kernel_eqA_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_temper_kernel_eqA)
            xdim5_temper_kernel_eqA = xdim5
            xdim5_temper_kernel_eqA_h = xdim5
!$OMP TARGET UPDATE TO(xdim5_temper_kernel_eqA)
            ydim5_temper_kernel_eqA = ydim5
            ydim5_temper_kernel_eqA_h = ydim5
!$OMP TARGET UPDATE TO(ydim5_temper_kernel_eqA)
            xdim6_temper_kernel_eqA = xdim6
            xdim6_temper_kernel_eqA_h = xdim6
!$OMP TARGET UPDATE TO(xdim6_temper_kernel_eqA)
            ydim6_temper_kernel_eqA = ydim6
            ydim6_temper_kernel_eqA_h = ydim6
!$OMP TARGET UPDATE TO(ydim6_temper_kernel_eqA)
    END IF
...
!   ========================
    ...
    CALL setKernelTime(558, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE temper_kernel_eqA_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, 558, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(temper_kernel_eqA_host_execute))

END SUBROUTINE
#endif

END MODULE TEMPER_KERNEL_EQA_MODULE
