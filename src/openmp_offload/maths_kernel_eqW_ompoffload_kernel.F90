! Auto-generated at 2026-04-28 18:44:30.073835 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_maths_kernel_eqW)
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqW
    INTEGER(KIND=4) :: xdim1_maths_kernel_eqW_h = -1
!$OMP DECLARE TARGET(ydim1_maths_kernel_eqW)
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqW
    INTEGER(KIND=4) :: ydim1_maths_kernel_eqW_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_maths_kernel_eqW*(y)) + (xdim1_maths_kernel_eqW*ydim1_maths_kernel_eqW*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_maths_kernel_eqW)
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqW
    INTEGER(KIND=4) :: xdim2_maths_kernel_eqW_h = -1
!$OMP DECLARE TARGET(ydim2_maths_kernel_eqW)
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqW
    INTEGER(KIND=4) :: ydim2_maths_kernel_eqW_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_maths_kernel_eqW*(y)) + (xdim2_maths_kernel_eqW*ydim2_maths_kernel_eqW*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_maths_kernel_eqW)
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqW
    INTEGER(KIND=4) :: xdim3_maths_kernel_eqW_h = -1
!$OMP DECLARE TARGET(ydim3_maths_kernel_eqW)
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqW
    INTEGER(KIND=4) :: ydim3_maths_kernel_eqW_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_maths_kernel_eqW*(y)) + (xdim3_maths_kernel_eqW*ydim3_maths_kernel_eqW*(z)) + 1)
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_maths_kernel_eqW*1) + ((n_z-1)*ydim1_maths_kernel_eqW*xdim1_maths_kernel_eqW*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_maths_kernel_eqW*1) + ((n_z-1)*ydim2_maths_kernel_eqW*xdim2_maths_kernel_eqW*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_maths_kernel_eqW*1) + ((n_z-1)*ydim3_maths_kernel_eqW*xdim3_maths_kernel_eqW*1)) &
               )
...
!   ==========================
    ...
    IF (&
         (xdim1 .NE. xdim1_maths_kernel_eqW_h) .OR. &
         (ydim1 .NE. ydim1_maths_kernel_eqW_h) .OR. &
         (xdim2 .NE. xdim2_maths_kernel_eqW_h) .OR. &
         (ydim2 .NE. ydim2_maths_kernel_eqW_h) .OR. &
         (xdim3 .NE. xdim3_maths_kernel_eqW_h) .OR. &
         (ydim3 .NE. ydim3_maths_kernel_eqW_h) &
       ) THEN
            xdim1_maths_kernel_eqW = xdim1
            xdim1_maths_kernel_eqW_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_maths_kernel_eqW)
            ydim1_maths_kernel_eqW = ydim1
            ydim1_maths_kernel_eqW_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_maths_kernel_eqW)
            xdim2_maths_kernel_eqW = xdim2
            xdim2_maths_kernel_eqW_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_maths_kernel_eqW)
            ydim2_maths_kernel_eqW = ydim2
            ydim2_maths_kernel_eqW_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_maths_kernel_eqW)
            xdim3_maths_kernel_eqW = xdim3
            xdim3_maths_kernel_eqW_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_maths_kernel_eqW)
            ydim3_maths_kernel_eqW = ydim3
            ydim3_maths_kernel_eqW_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_maths_kernel_eqW)
    END IF
