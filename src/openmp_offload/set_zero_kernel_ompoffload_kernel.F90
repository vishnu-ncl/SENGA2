! Auto-generated at 2026-04-28 18:44:28.503874 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_set_zero_kernel)
    INTEGER(KIND=4) :: xdim1_set_zero_kernel
    INTEGER(KIND=4) :: xdim1_set_zero_kernel_h = -1
!$OMP DECLARE TARGET(ydim1_set_zero_kernel)
    INTEGER(KIND=4) :: ydim1_set_zero_kernel
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_set_zero_kernel*1) + ((n_z-1)*ydim1_set_zero_kernel*xdim1_set_zero_kernel*1)) &
               )
...
!$OMP TARGET UPDATE TO(xdim1_set_zero_kernel)
            ydim1_set_zero_kernel = ydim1
            ydim1_set_zero_kernel_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_set_zero_kernel)
    END IF
