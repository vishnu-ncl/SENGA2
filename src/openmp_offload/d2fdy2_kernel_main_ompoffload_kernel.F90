! Auto-generated at 2026-04-28 18:44:28.547254 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_d2fdy2_kernel_main)
    INTEGER(KIND=4) :: xdim1_d2fdy2_kernel_main
    INTEGER(KIND=4) :: xdim1_d2fdy2_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim1_d2fdy2_kernel_main)
    INTEGER(KIND=4) :: ydim1_d2fdy2_kernel_main
...
!$OMP DECLARE TARGET(xdim2_d2fdy2_kernel_main)
    INTEGER(KIND=4) :: xdim2_d2fdy2_kernel_main
    INTEGER(KIND=4) :: xdim2_d2fdy2_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim2_d2fdy2_kernel_main)
    INTEGER(KIND=4) :: ydim2_d2fdy2_kernel_main
...
SUBROUTINE d2fdy2_kernel_main_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsGblDat3Device, &
    opsGblDat4Device, &
...
!$OMP TARGET TEAMS LOOP COLLAPSE(3) PRIVATE(n_x,n_y,n_z,idx_local)
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        ...
        idx_local = [idx_1+n_x-1, idx_2+n_y-1, idx_3+n_z-1]
                ...
                CALL d2fdy2_kernel_main( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_d2fdy2_kernel_main*1) + ((n_z-1)*ydim1_d2fdy2_kernel_main*xdim1_d2fdy2_kernel_main*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_d2fdy2_kernel_main*1) + ((n_z-1)*ydim2_d2fdy2_kernel_main*xdim2_d2fdy2_kernel_main*1)), &
                opsGblDat3Device, &
                opsGblDat4Device, &
                opsGblDat5Device, &
                opsGblDat6Device, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE d2fdy2_kernel_main_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE d2fdy2_kernel_main_host_execute( descPtr )
