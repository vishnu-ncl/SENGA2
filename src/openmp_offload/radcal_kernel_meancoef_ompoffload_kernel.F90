! Auto-generated at 2026-04-28 18:44:32.969484 by ops-translator

MODULE RADCAL_KERNEL_MEANCOEF_MODULE
...
!$OMP DECLARE TARGET(xdim1_radcal_kernel_meancoef)
    INTEGER(KIND=4) :: xdim1_radcal_kernel_meancoef
    INTEGER(KIND=4) :: xdim1_radcal_kernel_meancoef_h = -1
!$OMP DECLARE TARGET(ydim1_radcal_kernel_meancoef)
    INTEGER(KIND=4) :: ydim1_radcal_kernel_meancoef
    INTEGER(KIND=4) :: ydim1_radcal_kernel_meancoef_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_radcal_kernel_meancoef*(y)) + (xdim1_radcal_kernel_meancoef*ydim1_radcal_kernel_meancoef*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_radcal_kernel_meancoef)
    INTEGER(KIND=4) :: xdim2_radcal_kernel_meancoef
    INTEGER(KIND=4) :: xdim2_radcal_kernel_meancoef_h = -1
!$OMP DECLARE TARGET(ydim2_radcal_kernel_meancoef)
    INTEGER(KIND=4) :: ydim2_radcal_kernel_meancoef
    INTEGER(KIND=4) :: ydim2_radcal_kernel_meancoef_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_radcal_kernel_meancoef*(y)) + (xdim2_radcal_kernel_meancoef*ydim2_radcal_kernel_meancoef*(z)) + 1)
...
SUBROUTINE radcal_kernel_meancoef_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsGblDat3Device, &
    opsGblDat4Device, &
    ...
    INTEGER(KIND=4), DIMENSION(dat5_dim), INTENT(IN) :: opsGblDat5Device
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL radcal_kernel_meancoef( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_radcal_kernel_meancoef*1) + ((n_z-1)*ydim1_radcal_kernel_meancoef*xdim1_radcal_kernel_meancoef*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_radcal_kernel_meancoef*1) + ((n_z-1)*ydim2_radcal_kernel_meancoef*xdim2_radcal_kernel_meancoef*1)), &
                opsGblDat3Device(1), &
                opsGblDat4Device(1), &
                opsGblDat5Device(1), &
                opsGblDat6Device &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE radcal_kernel_meancoef_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE radcal_kernel_meancoef_host_execute( descPtr )
    ...
    kernelName = "radcal_kernel_meancoef"
...
!   ==========================
    ...
    CALL setKernelTime(534, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_radcal_kernel_meancoef_h) .OR. &
         (ydim1 .NE. ydim1_radcal_kernel_meancoef_h) .OR. &
         (xdim2 .NE. xdim2_radcal_kernel_meancoef_h) .OR. &
         (ydim2 .NE. ydim2_radcal_kernel_meancoef_h) &
       ) THEN
            xdim1_radcal_kernel_meancoef = xdim1
            xdim1_radcal_kernel_meancoef_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_radcal_kernel_meancoef)
            ydim1_radcal_kernel_meancoef = ydim1
            ydim1_radcal_kernel_meancoef_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_radcal_kernel_meancoef)
            xdim2_radcal_kernel_meancoef = xdim2
            xdim2_radcal_kernel_meancoef_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_radcal_kernel_meancoef)
            ydim2_radcal_kernel_meancoef = ydim2
            ydim2_radcal_kernel_meancoef_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_radcal_kernel_meancoef)
    END IF
...
!   ==============================
    CALL radcal_kernel_meancoef_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
!   ========================
    ...
    CALL setKernelTime(534, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE radcal_kernel_meancoef_host( userSubroutine, block, dim, range, &
    ...
    namelit = "radcal_kernel_meancoef"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, 534, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(radcal_kernel_meancoef_host_execute))

END SUBROUTINE
#endif

END MODULE RADCAL_KERNEL_MEANCOEF_MODULE
