! Auto-generated at 2026-04-28 18:44:32.228844 by ops-translator

MODULE BOUNDS_KERNEL_EQT_ZL_MODULE
...
!$OMP DECLARE TARGET(xdim1_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: xdim1_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: xdim1_bounds_kernel_eqT_zl_h = -1
!$OMP DECLARE TARGET(ydim1_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: ydim1_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: ydim1_bounds_kernel_eqT_zl_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_bounds_kernel_eqT_zl*(y)) + (xdim1_bounds_kernel_eqT_zl*ydim1_bounds_kernel_eqT_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: xdim2_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: xdim2_bounds_kernel_eqT_zl_h = -1
!$OMP DECLARE TARGET(ydim2_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: ydim2_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: ydim2_bounds_kernel_eqT_zl_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_bounds_kernel_eqT_zl*(y)) + (xdim2_bounds_kernel_eqT_zl*ydim2_bounds_kernel_eqT_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: xdim3_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: xdim3_bounds_kernel_eqT_zl_h = -1
!$OMP DECLARE TARGET(ydim3_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: ydim3_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: ydim3_bounds_kernel_eqT_zl_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_bounds_kernel_eqT_zl*(y)) + (xdim3_bounds_kernel_eqT_zl*ydim3_bounds_kernel_eqT_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: xdim4_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: xdim4_bounds_kernel_eqT_zl_h = -1
!$OMP DECLARE TARGET(ydim4_bounds_kernel_eqT_zl)
    INTEGER(KIND=4) :: ydim4_bounds_kernel_eqT_zl
    INTEGER(KIND=4) :: ydim4_bounds_kernel_eqT_zl_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_bounds_kernel_eqT_zl*(y)) + (xdim4_bounds_kernel_eqT_zl*ydim4_bounds_kernel_eqT_zl*(z)) + 1)
...
SUBROUTINE bounds_kernel_eqT_zl_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL bounds_kernel_eqT_zl( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_bounds_kernel_eqT_zl*1) + ((n_z-1)*ydim1_bounds_kernel_eqT_zl*xdim1_bounds_kernel_eqT_zl*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_bounds_kernel_eqT_zl*1) + ((n_z-1)*ydim2_bounds_kernel_eqT_zl*xdim2_bounds_kernel_eqT_zl*0)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_bounds_kernel_eqT_zl*1) + ((n_z-1)*ydim3_bounds_kernel_eqT_zl*xdim3_bounds_kernel_eqT_zl*0)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_bounds_kernel_eqT_zl*1) + ((n_z-1)*ydim4_bounds_kernel_eqT_zl*xdim4_bounds_kernel_eqT_zl*0)) &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bounds_kernel_eqT_zl_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4 &
...
#else
SUBROUTINE bounds_kernel_eqT_zl_host_execute( descPtr )
    ...
    kernelName = "bounds_kernel_eqT_zl"
...
!   ==========================
    ...
    CALL setKernelTime(458, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_bounds_kernel_eqT_zl_h) .OR. &
         (ydim1 .NE. ydim1_bounds_kernel_eqT_zl_h) .OR. &
         (xdim2 .NE. xdim2_bounds_kernel_eqT_zl_h) .OR. &
         (ydim2 .NE. ydim2_bounds_kernel_eqT_zl_h) .OR. &
         (xdim3 .NE. xdim3_bounds_kernel_eqT_zl_h) .OR. &
         (ydim3 .NE. ydim3_bounds_kernel_eqT_zl_h) .OR. &
         (xdim4 .NE. xdim4_bounds_kernel_eqT_zl_h) .OR. &
         (ydim4 .NE. ydim4_bounds_kernel_eqT_zl_h) &
       ) THEN
            xdim1_bounds_kernel_eqT_zl = xdim1
            xdim1_bounds_kernel_eqT_zl_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_bounds_kernel_eqT_zl)
            ydim1_bounds_kernel_eqT_zl = ydim1
            ydim1_bounds_kernel_eqT_zl_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_bounds_kernel_eqT_zl)
            xdim2_bounds_kernel_eqT_zl = xdim2
            xdim2_bounds_kernel_eqT_zl_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_bounds_kernel_eqT_zl)
            ydim2_bounds_kernel_eqT_zl = ydim2
            ydim2_bounds_kernel_eqT_zl_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_bounds_kernel_eqT_zl)
            xdim3_bounds_kernel_eqT_zl = xdim3
            xdim3_bounds_kernel_eqT_zl_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_bounds_kernel_eqT_zl)
            ydim3_bounds_kernel_eqT_zl = ydim3
            ydim3_bounds_kernel_eqT_zl_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_bounds_kernel_eqT_zl)
            xdim4_bounds_kernel_eqT_zl = xdim4
            xdim4_bounds_kernel_eqT_zl_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_bounds_kernel_eqT_zl)
            ydim4_bounds_kernel_eqT_zl = ydim4
            ydim4_bounds_kernel_eqT_zl_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_bounds_kernel_eqT_zl)
    END IF
...
!   ==============================
    CALL bounds_kernel_eqT_zl_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
!   ========================
    ...
    CALL setKernelTime(458, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE bounds_kernel_eqT_zl_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, 458, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bounds_kernel_eqT_zl_host_execute))

END SUBROUTINE
#endif

END MODULE BOUNDS_KERNEL_EQT_ZL_MODULE
