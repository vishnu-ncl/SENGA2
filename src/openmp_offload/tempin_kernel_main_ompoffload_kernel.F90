! Auto-generated at 2026-04-28 18:44:33.108800 by ops-translator
...
!$OMP DECLARE TARGET(xdim1_tempin_kernel_main)
    INTEGER(KIND=4) :: xdim1_tempin_kernel_main
    INTEGER(KIND=4) :: xdim1_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim1_tempin_kernel_main)
    INTEGER(KIND=4) :: ydim1_tempin_kernel_main
    INTEGER(KIND=4) :: ydim1_tempin_kernel_main_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_tempin_kernel_main*(y)) + (xdim1_tempin_kernel_main*ydim1_tempin_kernel_main*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_tempin_kernel_main)
    INTEGER(KIND=4) :: xdim2_tempin_kernel_main
    INTEGER(KIND=4) :: xdim2_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim2_tempin_kernel_main)
    INTEGER(KIND=4) :: ydim2_tempin_kernel_main
    INTEGER(KIND=4) :: ydim2_tempin_kernel_main_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_tempin_kernel_main*(y)) + (xdim2_tempin_kernel_main*ydim2_tempin_kernel_main*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_tempin_kernel_main)
    INTEGER(KIND=4) :: xdim3_tempin_kernel_main
    INTEGER(KIND=4) :: xdim3_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim3_tempin_kernel_main)
    INTEGER(KIND=4) :: ydim3_tempin_kernel_main
    INTEGER(KIND=4) :: ydim3_tempin_kernel_main_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_tempin_kernel_main*(y)) + (xdim3_tempin_kernel_main*ydim3_tempin_kernel_main*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_tempin_kernel_main)
    INTEGER(KIND=4) :: xdim4_tempin_kernel_main
    INTEGER(KIND=4) :: xdim4_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim4_tempin_kernel_main)
    INTEGER(KIND=4) :: ydim4_tempin_kernel_main
    INTEGER(KIND=4) :: ydim4_tempin_kernel_main_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_tempin_kernel_main*(y)) + (xdim4_tempin_kernel_main*ydim4_tempin_kernel_main*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_tempin_kernel_main)
    INTEGER(KIND=4) :: xdim5_tempin_kernel_main
    INTEGER(KIND=4) :: xdim5_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim5_tempin_kernel_main)
    INTEGER(KIND=4) :: ydim5_tempin_kernel_main
    INTEGER(KIND=4) :: ydim5_tempin_kernel_main_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_tempin_kernel_main*(y)) + (xdim5_tempin_kernel_main*ydim5_tempin_kernel_main*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_tempin_kernel_main)
    INTEGER(KIND=4) :: xdim6_tempin_kernel_main
    INTEGER(KIND=4) :: xdim6_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim6_tempin_kernel_main)
    INTEGER(KIND=4) :: ydim6_tempin_kernel_main
    INTEGER(KIND=4) :: ydim6_tempin_kernel_main_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_tempin_kernel_main*(y)) + (xdim6_tempin_kernel_main*ydim6_tempin_kernel_main*(z)) + 1)

!$OMP DECLARE TARGET(multi_d7)
    INTEGER(KIND=4) :: multi_d7
!$OMP DECLARE TARGET(xdim7_tempin_kernel_main)
    INTEGER(KIND=4) :: xdim7_tempin_kernel_main
    INTEGER(KIND=4) :: xdim7_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(ydim7_tempin_kernel_main)
    INTEGER(KIND=4) :: ydim7_tempin_kernel_main
    INTEGER(KIND=4) :: ydim7_tempin_kernel_main_h = -1
!$OMP DECLARE TARGET(zdim7_tempin_kernel_main)
    INTEGER(KIND=4) :: zdim7_tempin_kernel_main
    INTEGER(KIND=4) :: zdim7_tempin_kernel_main_h = -1
#define OPS_ACC_MD7(d,x,y,z) ((x) + (xdim7_tempin_kernel_main*(y)) + (xdim7_tempin_kernel_main*ydim7_tempin_kernel_main*(z)) + (xdim7_tempin_kernel_main*ydim7_tempin_kernel_main*zdim7_tempin_kernel_main*(d-1)) + 1)
...
SUBROUTINE tempin_kernel_main_wrap( &
    ...
    REAL(KIND=8), DIMENSION(dat12_dim), INTENT(IN) :: opsGblDat12Device
...
!$OMP TARGET TEAMS LOOP COLLAPSE(3) PRIVATE(n_x,n_y,n_z,idx_local)
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        ...
        idx_local = [idx_1+n_x-1, idx_2+n_y-1, idx_3+n_z-1]
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_tempin_kernel_main*1) + ((n_z-1)*ydim1_tempin_kernel_main*xdim1_tempin_kernel_main*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_tempin_kernel_main*1) + ((n_z-1)*ydim2_tempin_kernel_main*xdim2_tempin_kernel_main*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_tempin_kernel_main*1) + ((n_z-1)*ydim3_tempin_kernel_main*xdim3_tempin_kernel_main*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_tempin_kernel_main*1) + ((n_z-1)*ydim4_tempin_kernel_main*xdim4_tempin_kernel_main*1)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_tempin_kernel_main*1) + ((n_z-1)*ydim5_tempin_kernel_main*xdim5_tempin_kernel_main*1)), &
                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6_tempin_kernel_main*1) + ((n_z-1)*ydim6_tempin_kernel_main*xdim6_tempin_kernel_main*1)), &
                opsDat7Local(dat7_base + ((n_x-1)*1) + ((n_y-1)*xdim7_tempin_kernel_main*1) + ((n_z-1)*ydim7_tempin_kernel_main*xdim7_tempin_kernel_main*1)), &
                opsGblDat8Device(1), &
                opsGblDat9Device(1), &
                opsGblDat10Device(1), &
                opsGblDat11Device(1), &
...
!   ==========================
    ...
    CALL setKernelTime(565, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    multi_d7 = getDatDimFromOpsArg(opsArg7) ! dimension of dat
!$OMP TARGET UPDATE TO(multi_d7)
    ...
    IF (&
         (xdim1 .NE. xdim1_tempin_kernel_main_h) .OR. &
...
!   ========================
    ...
    CALL setKernelTime(565, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE tempin_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    17, 565, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(tempin_kernel_main_host_execute))

END SUBROUTINE
#endif

END MODULE TEMPIN_KERNEL_MAIN_MODULE
