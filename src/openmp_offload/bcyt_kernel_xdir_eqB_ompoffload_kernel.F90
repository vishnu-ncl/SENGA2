! Auto-generated at 2026-04-28 18:44:30.648367 by ops-translator

MODULE BCYT_KERNEL_XDIR_EQB_MODULE
...
!$OMP DECLARE TARGET(xdim1_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: xdim1_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: xdim1_bcyt_kernel_xdir_eqB_h = -1
!$OMP DECLARE TARGET(ydim1_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: ydim1_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: ydim1_bcyt_kernel_xdir_eqB_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_bcyt_kernel_xdir_eqB*(y)) + (xdim1_bcyt_kernel_xdir_eqB*ydim1_bcyt_kernel_xdir_eqB*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: xdim2_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: xdim2_bcyt_kernel_xdir_eqB_h = -1
!$OMP DECLARE TARGET(ydim2_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: ydim2_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: ydim2_bcyt_kernel_xdir_eqB_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_bcyt_kernel_xdir_eqB*(y)) + (xdim2_bcyt_kernel_xdir_eqB*ydim2_bcyt_kernel_xdir_eqB*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: xdim3_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: xdim3_bcyt_kernel_xdir_eqB_h = -1
!$OMP DECLARE TARGET(ydim3_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: ydim3_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: ydim3_bcyt_kernel_xdir_eqB_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_bcyt_kernel_xdir_eqB*(y)) + (xdim3_bcyt_kernel_xdir_eqB*ydim3_bcyt_kernel_xdir_eqB*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: xdim4_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: xdim4_bcyt_kernel_xdir_eqB_h = -1
!$OMP DECLARE TARGET(ydim4_bcyt_kernel_xdir_eqB)
    INTEGER(KIND=4) :: ydim4_bcyt_kernel_xdir_eqB
    INTEGER(KIND=4) :: ydim4_bcyt_kernel_xdir_eqB_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_bcyt_kernel_xdir_eqB*(y)) + (xdim4_bcyt_kernel_xdir_eqB*ydim4_bcyt_kernel_xdir_eqB*(z)) + 1)
...
SUBROUTINE bcyt_kernel_xdir_eqB_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    INTEGER(KIND=4), VALUE ::  opsGblDat7Device
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL bcyt_kernel_xdir_eqB( &
                opsDat1Local(dat1_base + ((n_x-1)*0) + ((n_y-1)*xdim1_bcyt_kernel_xdir_eqB*1) + ((n_z-1)*ydim1_bcyt_kernel_xdir_eqB*xdim1_bcyt_kernel_xdir_eqB*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*0) + ((n_y-1)*xdim2_bcyt_kernel_xdir_eqB*1) + ((n_z-1)*ydim2_bcyt_kernel_xdir_eqB*xdim2_bcyt_kernel_xdir_eqB*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*0) + ((n_y-1)*xdim3_bcyt_kernel_xdir_eqB*1) + ((n_z-1)*ydim3_bcyt_kernel_xdir_eqB*xdim3_bcyt_kernel_xdir_eqB*1)), &
                opsDat4Local(dat4_base + ((n_x-1)*0) + ((n_y-1)*xdim4_bcyt_kernel_xdir_eqB*1) + ((n_z-1)*ydim4_bcyt_kernel_xdir_eqB*xdim4_bcyt_kernel_xdir_eqB*1)), &
                opsGblDat5Device(1), &
                opsGblDat6Device, &
                opsGblDat7Device &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bcyt_kernel_xdir_eqB_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE bcyt_kernel_xdir_eqB_host_execute( descPtr )
    ...
    kernelName = "bcyt_kernel_xdir_eqB"
...
!   ==========================
    ...
    CALL setKernelTime(330, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_bcyt_kernel_xdir_eqB_h) .OR. &
         (ydim1 .NE. ydim1_bcyt_kernel_xdir_eqB_h) .OR. &
         (xdim2 .NE. xdim2_bcyt_kernel_xdir_eqB_h) .OR. &
         (ydim2 .NE. ydim2_bcyt_kernel_xdir_eqB_h) .OR. &
         (xdim3 .NE. xdim3_bcyt_kernel_xdir_eqB_h) .OR. &
         (ydim3 .NE. ydim3_bcyt_kernel_xdir_eqB_h) .OR. &
         (xdim4 .NE. xdim4_bcyt_kernel_xdir_eqB_h) .OR. &
         (ydim4 .NE. ydim4_bcyt_kernel_xdir_eqB_h) &
       ) THEN
            xdim1_bcyt_kernel_xdir_eqB = xdim1
            xdim1_bcyt_kernel_xdir_eqB_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_bcyt_kernel_xdir_eqB)
            ydim1_bcyt_kernel_xdir_eqB = ydim1
            ydim1_bcyt_kernel_xdir_eqB_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_bcyt_kernel_xdir_eqB)
            xdim2_bcyt_kernel_xdir_eqB = xdim2
            xdim2_bcyt_kernel_xdir_eqB_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_bcyt_kernel_xdir_eqB)
            ydim2_bcyt_kernel_xdir_eqB = ydim2
            ydim2_bcyt_kernel_xdir_eqB_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_bcyt_kernel_xdir_eqB)
            xdim3_bcyt_kernel_xdir_eqB = xdim3
            xdim3_bcyt_kernel_xdir_eqB_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_bcyt_kernel_xdir_eqB)
            ydim3_bcyt_kernel_xdir_eqB = ydim3
            ydim3_bcyt_kernel_xdir_eqB_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_bcyt_kernel_xdir_eqB)
            xdim4_bcyt_kernel_xdir_eqB = xdim4
            xdim4_bcyt_kernel_xdir_eqB_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_bcyt_kernel_xdir_eqB)
            ydim4_bcyt_kernel_xdir_eqB = ydim4
            ydim4_bcyt_kernel_xdir_eqB_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_bcyt_kernel_xdir_eqB)
    END IF
...
!   ==============================
    CALL bcyt_kernel_xdir_eqB_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
!   ========================
    ...
    CALL setKernelTime(330, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE bcyt_kernel_xdir_eqB_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, 330, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bcyt_kernel_xdir_eqB_host_execute))

END SUBROUTINE
#endif

END MODULE BCYT_KERNEL_XDIR_EQB_MODULE
