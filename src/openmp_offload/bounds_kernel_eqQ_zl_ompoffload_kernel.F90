! Auto-generated at 2026-04-28 18:44:32.154776 by ops-translator

MODULE BOUNDS_KERNEL_EQQ_ZL_MODULE
...
!$OMP DECLARE TARGET(xdim1_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim1_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim1_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim1_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim1_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim1_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_bounds_kernel_eqQ_zl*(y)) + (xdim1_bounds_kernel_eqQ_zl*ydim1_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim2_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim2_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim2_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim2_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim2_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_bounds_kernel_eqQ_zl*(y)) + (xdim2_bounds_kernel_eqQ_zl*ydim2_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim3_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim3_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim3_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim3_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim3_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_bounds_kernel_eqQ_zl*(y)) + (xdim3_bounds_kernel_eqQ_zl*ydim3_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim4_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim4_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim4_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim4_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim4_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim4_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC4(x,y,z) ((x) + (xdim4_bounds_kernel_eqQ_zl*(y)) + (xdim4_bounds_kernel_eqQ_zl*ydim4_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim5_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim5_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim5_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim5_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim5_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim5_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC5(x,y,z) ((x) + (xdim5_bounds_kernel_eqQ_zl*(y)) + (xdim5_bounds_kernel_eqQ_zl*ydim5_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim6_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim6_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim6_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim6_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim6_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim6_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC6(x,y,z) ((x) + (xdim6_bounds_kernel_eqQ_zl*(y)) + (xdim6_bounds_kernel_eqQ_zl*ydim6_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim7_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim7_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim7_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim7_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim7_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim7_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC7(x,y,z) ((x) + (xdim7_bounds_kernel_eqQ_zl*(y)) + (xdim7_bounds_kernel_eqQ_zl*ydim7_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim8_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim8_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim8_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim8_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim8_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim8_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC8(x,y,z) ((x) + (xdim8_bounds_kernel_eqQ_zl*(y)) + (xdim8_bounds_kernel_eqQ_zl*ydim8_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim9_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim9_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim9_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim9_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim9_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim9_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC9(x,y,z) ((x) + (xdim9_bounds_kernel_eqQ_zl*(y)) + (xdim9_bounds_kernel_eqQ_zl*ydim9_bounds_kernel_eqQ_zl*(z)) + 1)

!$OMP DECLARE TARGET(xdim10_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: xdim10_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: xdim10_bounds_kernel_eqQ_zl_h = -1
!$OMP DECLARE TARGET(ydim10_bounds_kernel_eqQ_zl)
    INTEGER(KIND=4) :: ydim10_bounds_kernel_eqQ_zl
    INTEGER(KIND=4) :: ydim10_bounds_kernel_eqQ_zl_h = -1
#define OPS_ACC10(x,y,z) ((x) + (xdim10_bounds_kernel_eqQ_zl*(y)) + (xdim10_bounds_kernel_eqQ_zl*ydim10_bounds_kernel_eqQ_zl*(z)) + 1)
...
SUBROUTINE bounds_kernel_eqQ_zl_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL bounds_kernel_eqQ_zl( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim1_bounds_kernel_eqQ_zl*xdim1_bounds_kernel_eqQ_zl*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim2_bounds_kernel_eqQ_zl*xdim2_bounds_kernel_eqQ_zl*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim3_bounds_kernel_eqQ_zl*xdim3_bounds_kernel_eqQ_zl*0)), &
                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim4_bounds_kernel_eqQ_zl*xdim4_bounds_kernel_eqQ_zl*0)), &
                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim5_bounds_kernel_eqQ_zl*xdim5_bounds_kernel_eqQ_zl*0)), &
                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim6_bounds_kernel_eqQ_zl*xdim6_bounds_kernel_eqQ_zl*0)), &
                opsDat7Local(dat7_base + ((n_x-1)*1) + ((n_y-1)*xdim7_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim7_bounds_kernel_eqQ_zl*xdim7_bounds_kernel_eqQ_zl*0)), &
                opsDat8Local(dat8_base + ((n_x-1)*1) + ((n_y-1)*xdim8_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim8_bounds_kernel_eqQ_zl*xdim8_bounds_kernel_eqQ_zl*0)), &
                opsDat9Local(dat9_base + ((n_x-1)*1) + ((n_y-1)*xdim9_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim9_bounds_kernel_eqQ_zl*xdim9_bounds_kernel_eqQ_zl*0)), &
                opsDat10Local(dat10_base + ((n_x-1)*1) + ((n_y-1)*xdim10_bounds_kernel_eqQ_zl*1) + ((n_z-1)*ydim10_bounds_kernel_eqQ_zl*xdim10_bounds_kernel_eqQ_zl*0)), &
                opsGblDat11Device &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bounds_kernel_eqQ_zl_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE bounds_kernel_eqQ_zl_host_execute( descPtr )
    ...
    kernelName = "bounds_kernel_eqQ_zl"
...
!   ==========================
    ...
    CALL setKernelTime(450, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim1 .NE. ydim1_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim2 .NE. xdim2_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim2 .NE. ydim2_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim3 .NE. xdim3_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim3 .NE. ydim3_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim4 .NE. xdim4_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim4 .NE. ydim4_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim5 .NE. xdim5_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim5 .NE. ydim5_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim6 .NE. xdim6_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim6 .NE. ydim6_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim7 .NE. xdim7_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim7 .NE. ydim7_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim8 .NE. xdim8_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim8 .NE. ydim8_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim9 .NE. xdim9_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim9 .NE. ydim9_bounds_kernel_eqQ_zl_h) .OR. &
         (xdim10 .NE. xdim10_bounds_kernel_eqQ_zl_h) .OR. &
         (ydim10 .NE. ydim10_bounds_kernel_eqQ_zl_h) &
       ) THEN
            xdim1_bounds_kernel_eqQ_zl = xdim1
            xdim1_bounds_kernel_eqQ_zl_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_bounds_kernel_eqQ_zl)
            ydim1_bounds_kernel_eqQ_zl = ydim1
            ydim1_bounds_kernel_eqQ_zl_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_bounds_kernel_eqQ_zl)
            xdim2_bounds_kernel_eqQ_zl = xdim2
            xdim2_bounds_kernel_eqQ_zl_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_bounds_kernel_eqQ_zl)
            ydim2_bounds_kernel_eqQ_zl = ydim2
            ydim2_bounds_kernel_eqQ_zl_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_bounds_kernel_eqQ_zl)
            xdim3_bounds_kernel_eqQ_zl = xdim3
            xdim3_bounds_kernel_eqQ_zl_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_bounds_kernel_eqQ_zl)
            ydim3_bounds_kernel_eqQ_zl = ydim3
            ydim3_bounds_kernel_eqQ_zl_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_bounds_kernel_eqQ_zl)
            xdim4_bounds_kernel_eqQ_zl = xdim4
            xdim4_bounds_kernel_eqQ_zl_h = xdim4
!$OMP TARGET UPDATE TO(xdim4_bounds_kernel_eqQ_zl)
            ydim4_bounds_kernel_eqQ_zl = ydim4
            ydim4_bounds_kernel_eqQ_zl_h = ydim4
!$OMP TARGET UPDATE TO(ydim4_bounds_kernel_eqQ_zl)
            xdim5_bounds_kernel_eqQ_zl = xdim5
            xdim5_bounds_kernel_eqQ_zl_h = xdim5
!$OMP TARGET UPDATE TO(xdim5_bounds_kernel_eqQ_zl)
            ydim5_bounds_kernel_eqQ_zl = ydim5
            ydim5_bounds_kernel_eqQ_zl_h = ydim5
!$OMP TARGET UPDATE TO(ydim5_bounds_kernel_eqQ_zl)
            xdim6_bounds_kernel_eqQ_zl = xdim6
            xdim6_bounds_kernel_eqQ_zl_h = xdim6
!$OMP TARGET UPDATE TO(xdim6_bounds_kernel_eqQ_zl)
            ydim6_bounds_kernel_eqQ_zl = ydim6
            ydim6_bounds_kernel_eqQ_zl_h = ydim6
!$OMP TARGET UPDATE TO(ydim6_bounds_kernel_eqQ_zl)
            xdim7_bounds_kernel_eqQ_zl = xdim7
            xdim7_bounds_kernel_eqQ_zl_h = xdim7
!$OMP TARGET UPDATE TO(xdim7_bounds_kernel_eqQ_zl)
            ydim7_bounds_kernel_eqQ_zl = ydim7
            ydim7_bounds_kernel_eqQ_zl_h = ydim7
!$OMP TARGET UPDATE TO(ydim7_bounds_kernel_eqQ_zl)
            xdim8_bounds_kernel_eqQ_zl = xdim8
            xdim8_bounds_kernel_eqQ_zl_h = xdim8
!$OMP TARGET UPDATE TO(xdim8_bounds_kernel_eqQ_zl)
            ydim8_bounds_kernel_eqQ_zl = ydim8
            ydim8_bounds_kernel_eqQ_zl_h = ydim8
!$OMP TARGET UPDATE TO(ydim8_bounds_kernel_eqQ_zl)
            xdim9_bounds_kernel_eqQ_zl = xdim9
            xdim9_bounds_kernel_eqQ_zl_h = xdim9
!$OMP TARGET UPDATE TO(xdim9_bounds_kernel_eqQ_zl)
            ydim9_bounds_kernel_eqQ_zl = ydim9
            ydim9_bounds_kernel_eqQ_zl_h = ydim9
!$OMP TARGET UPDATE TO(ydim9_bounds_kernel_eqQ_zl)
            xdim10_bounds_kernel_eqQ_zl = xdim10
            xdim10_bounds_kernel_eqQ_zl_h = xdim10
!$OMP TARGET UPDATE TO(xdim10_bounds_kernel_eqQ_zl)
            ydim10_bounds_kernel_eqQ_zl = ydim10
            ydim10_bounds_kernel_eqQ_zl_h = ydim10
!$OMP TARGET UPDATE TO(ydim10_bounds_kernel_eqQ_zl)
    END IF
...
!   ==============================
    CALL bounds_kernel_eqQ_zl_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
!   ========================
    ...
    CALL setKernelTime(450, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE bounds_kernel_eqQ_zl_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    11, 450, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bounds_kernel_eqQ_zl_host_execute))

END SUBROUTINE
#endif

END MODULE BOUNDS_KERNEL_EQQ_ZL_MODULE
