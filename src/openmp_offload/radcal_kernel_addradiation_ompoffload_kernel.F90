! Auto-generated at 2026-04-28 18:44:32.977087 by ops-translator

MODULE RADCAL_KERNEL_ADDRADIATION_MODULE
...
!$OMP DECLARE TARGET(xdim1_radcal_kernel_addradiation)
    INTEGER(KIND=4) :: xdim1_radcal_kernel_addradiation
    INTEGER(KIND=4) :: xdim1_radcal_kernel_addradiation_h = -1
!$OMP DECLARE TARGET(ydim1_radcal_kernel_addradiation)
    INTEGER(KIND=4) :: ydim1_radcal_kernel_addradiation
    INTEGER(KIND=4) :: ydim1_radcal_kernel_addradiation_h = -1
#define OPS_ACC1(x,y,z) ((x) + (xdim1_radcal_kernel_addradiation*(y)) + (xdim1_radcal_kernel_addradiation*ydim1_radcal_kernel_addradiation*(z)) + 1)

!$OMP DECLARE TARGET(xdim2_radcal_kernel_addradiation)
    INTEGER(KIND=4) :: xdim2_radcal_kernel_addradiation
    INTEGER(KIND=4) :: xdim2_radcal_kernel_addradiation_h = -1
!$OMP DECLARE TARGET(ydim2_radcal_kernel_addradiation)
    INTEGER(KIND=4) :: ydim2_radcal_kernel_addradiation
    INTEGER(KIND=4) :: ydim2_radcal_kernel_addradiation_h = -1
#define OPS_ACC2(x,y,z) ((x) + (xdim2_radcal_kernel_addradiation*(y)) + (xdim2_radcal_kernel_addradiation*ydim2_radcal_kernel_addradiation*(z)) + 1)

!$OMP DECLARE TARGET(xdim3_radcal_kernel_addradiation)
    INTEGER(KIND=4) :: xdim3_radcal_kernel_addradiation
    INTEGER(KIND=4) :: xdim3_radcal_kernel_addradiation_h = -1
!$OMP DECLARE TARGET(ydim3_radcal_kernel_addradiation)
    INTEGER(KIND=4) :: ydim3_radcal_kernel_addradiation
    INTEGER(KIND=4) :: ydim3_radcal_kernel_addradiation_h = -1
#define OPS_ACC3(x,y,z) ((x) + (xdim3_radcal_kernel_addradiation*(y)) + (xdim3_radcal_kernel_addradiation*ydim3_radcal_kernel_addradiation*(z)) + 1)
...
SUBROUTINE radcal_kernel_addradiation_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    dat1_base, &
    ...
    DO n_z = 1, end_indx_3-start_indx_3+1
        DO n_y = 1, end_indx_2-start_indx_2+1
            DO n_x = 1, end_indx_1-start_indx_1+1
                ...
                CALL radcal_kernel_addradiation( &
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1_radcal_kernel_addradiation*1) + ((n_z-1)*ydim1_radcal_kernel_addradiation*xdim1_radcal_kernel_addradiation*1)), &
                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2_radcal_kernel_addradiation*1) + ((n_z-1)*ydim2_radcal_kernel_addradiation*xdim2_radcal_kernel_addradiation*1)), &
                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3_radcal_kernel_addradiation*1) + ((n_z-1)*ydim3_radcal_kernel_addradiation*xdim3_radcal_kernel_addradiation*1)) &
               )
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE radcal_kernel_addradiation_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3 &
    )
...
#else
SUBROUTINE radcal_kernel_addradiation_host_execute( descPtr )
    ...
    kernelName = "radcal_kernel_addradiation"
...
!   ==========================
    ...
    CALL setKernelTime(536, kernelName//c_null_char, 0.0_8, 0.0_8, 0.0_4, 1)
    ...
    IF (&
         (xdim1 .NE. xdim1_radcal_kernel_addradiation_h) .OR. &
         (ydim1 .NE. ydim1_radcal_kernel_addradiation_h) .OR. &
         (xdim2 .NE. xdim2_radcal_kernel_addradiation_h) .OR. &
         (ydim2 .NE. ydim2_radcal_kernel_addradiation_h) .OR. &
         (xdim3 .NE. xdim3_radcal_kernel_addradiation_h) .OR. &
         (ydim3 .NE. ydim3_radcal_kernel_addradiation_h) &
       ) THEN
            xdim1_radcal_kernel_addradiation = xdim1
            xdim1_radcal_kernel_addradiation_h = xdim1
!$OMP TARGET UPDATE TO(xdim1_radcal_kernel_addradiation)
            ydim1_radcal_kernel_addradiation = ydim1
            ydim1_radcal_kernel_addradiation_h = ydim1
!$OMP TARGET UPDATE TO(ydim1_radcal_kernel_addradiation)
            xdim2_radcal_kernel_addradiation = xdim2
            xdim2_radcal_kernel_addradiation_h = xdim2
!$OMP TARGET UPDATE TO(xdim2_radcal_kernel_addradiation)
            ydim2_radcal_kernel_addradiation = ydim2
            ydim2_radcal_kernel_addradiation_h = ydim2
!$OMP TARGET UPDATE TO(ydim2_radcal_kernel_addradiation)
            xdim3_radcal_kernel_addradiation = xdim3
            xdim3_radcal_kernel_addradiation_h = xdim3
!$OMP TARGET UPDATE TO(xdim3_radcal_kernel_addradiation)
            ydim3_radcal_kernel_addradiation = ydim3
            ydim3_radcal_kernel_addradiation_h = ydim3
!$OMP TARGET UPDATE TO(ydim3_radcal_kernel_addradiation)
    END IF
...
!   ==============================
    CALL radcal_kernel_addradiation_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        dat1_base, &
...
!   ========================
    ...
    CALL setKernelTime(536, kernelName//c_null_char, t3__-t2__, t2__-t1__, transfer_total, 0)
...
SUBROUTINE radcal_kernel_addradiation_host( userSubroutine, block, dim, range, &
    ...
    namelit = "radcal_kernel_addradiation"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    3, 536, dim, 1, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(radcal_kernel_addradiation_host_execute))

END SUBROUTINE
#endif

END MODULE RADCAL_KERNEL_ADDRADIATION_MODULE
