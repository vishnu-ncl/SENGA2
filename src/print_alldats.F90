SUBROUTINE print_alldats()
    ...
    fname = 'test_dir/derr_timestep'//citime//pnxhdf
    call ops_fetch_block_hdf5_file(senga_grid, trim(fname))
    call ops_fetch_dat_hdf5_file(d_derr, trim(fname))

    fname = 'test_dir/uerr_timestep'//citime//pnxhdf
    call ops_fetch_block_hdf5_file(senga_grid, trim(fname))
    call ops_fetch_dat_hdf5_file(d_uerr, trim(fname))

    fname = 'test_dir/verr_timestep'//citime//pnxhdf
    call ops_fetch_block_hdf5_file(senga_grid, trim(fname))
    call ops_fetch_dat_hdf5_file(d_verr, trim(fname))

    fname = 'test_dir/werr_timestep'//citime//pnxhdf
    call ops_fetch_block_hdf5_file(senga_grid, trim(fname))
    call ops_fetch_dat_hdf5_file(d_werr, trim(fname))

    fname = 'test_dir/eerr_timestep'//citime//pnxhdf
    call ops_fetch_block_hdf5_file(senga_grid, trim(fname))
    ...
    fname = 'test_dir/yerr_timestep'//citime//pnxhdf
    call ops_fetch_block_hdf5_file(senga_grid, trim(fname))
    DO ispec = 1,nspcmx
