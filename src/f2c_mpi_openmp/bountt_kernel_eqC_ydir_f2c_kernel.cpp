// Auto-generated at 2026-04-28 18:43:36.208096 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ strdy_p = (double *)(args[12].data) + base12 - 1; // Subtracting 1 to convert to C-style

    int base13 = getDatBaseFromOpsArg3D(&args[13], start_indx, 1);
    double * __restrict__ struy_p = (double *)(args[13].data) + base13 - 1; // Subtracting 1 to convert to C-style

    int base14 = getDatBaseFromOpsArg3D(&args[14], start_indx, 1);
    double * __restrict__ strvy_p = (double *)(args[14].data) + base14 - 1; // Subtracting 1 to convert to C-style

    int base15 = getDatBaseFromOpsArg3D(&args[15], start_indx, 1);
    double * __restrict__ strwy_p = (double *)(args[15].data) + base15 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("bountt_kernel_eqC_ydir", args, 16, 506, dim, 0, range, block, bountt_kernel_eqC_ydir_execute);
}
#endif
