! Auto-generated at 2026-04-28 18:43:28.240686 by ops-translator
...
SUBROUTINE bcdt_kernel_zdir_host_c(name, args, nargs, dim, range, block) BIND(C,name='bcdt_kernel_zdir_host_c')
...
END SUBROUTINE bcdt_kernel_zdir_host_c
...
SUBROUTINE bcdt_kernel_zdir_host( userSubroutine, block, dim, range, &
    ...
    CALL bcdt_kernel_zdir_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    3, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE bcdt_kernel_zdir_host
