// Auto-generated at 2026-04-28 18:43:36.950288 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ stryz_p = (double *)(args[5].data) + base5 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("boundt_kernel_eqF_zdir", args, 14, 531, dim, 0, range, block, boundt_kernel_eqF_zdir_execute);
}
#endif
