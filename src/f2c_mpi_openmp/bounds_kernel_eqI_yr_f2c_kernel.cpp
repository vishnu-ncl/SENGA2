// Auto-generated at 2026-04-28 18:43:32.697293 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ strdyr_p = (double *)(args[4].data) + base4 - 1; // Subtracting 1 to convert to C-style

    int base5 = getDatBaseFromOpsArg3D(&args[5], start_indx, 1);
    double * __restrict__ acouyr_p = (double *)(args[5].data) + base5 - 1; // Subtracting 1 to convert to C-style
    ...
    double * __restrict__ bcl5yr_p = (double *)(args[7].data) + base7 - 1; // Subtracting 1 to convert to C-style
    ...
    double * __restrict__ sorpyr_p = (double *)(args[9].data) + base9 - 1; // Subtracting 1 to convert to C-style

    int base10 = getDatBaseFromOpsArg3D(&args[10], start_indx, 1);
    double * __restrict__ strpyr_p = (double *)(args[10].data) + base10 - 1; // Subtracting 1 to convert to C-style

    double * __restrict__  cobcyr = (double *)args[11].data;
    double * __restrict__  pinfyr = (double *)args[12].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("bounds_kernel_eqI_yr", args, 13, 424, dim, 0, range, block, bounds_kernel_eqI_yr_execute);
}
#endif
