! Auto-generated at 2026-04-28 18:43:18.526956 by ops-translator
...
SUBROUTINE d2fdxy_kernel_eqBD_host_c(name, args, nargs, dim, range, block) BIND(C,name='d2fdxy_kernel_eqBD_host_c')
...
END SUBROUTINE d2fdxy_kernel_eqBD_host_c
...
SUBROUTINE d2fdxy_kernel_eqBD_host( userSubroutine, block, dim, range, &
    ...
    CALL d2fdxy_kernel_eqBD_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    5, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE d2fdxy_kernel_eqBD_host
