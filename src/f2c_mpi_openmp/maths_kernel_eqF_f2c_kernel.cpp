// Auto-generated at 2026-04-28 18:43:37.369325 by ops-translator
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "maths_kernel_eqF");
#endif
...
//  ======================================================
    int xdim0_maths_kernel_eqF = args[0].dat->size[0];
    int ydim0_maths_kernel_eqF = args[0].dat->size[1];
    ...
    for (int n_z = 0; n_z < end_indx[2]-start_indx[2] +1; n_z++)
    {
        for (int n_y = 0; n_y < end_indx[1]-start_indx[1] +1; n_y++)
        {
            for(int n_x = 0; n_x < end_indx[0]-start_indx[0] +1; n_x++)
            {
                 ...
                 ACC<double> out_arr(xdim0_maths_kernel_eqF, ydim0_maths_kernel_eqF, out_arr_p + (n_x * 1) + (n_y * xdim0_maths_kernel_eqF * 1) + (n_z * xdim0_maths_kernel_eqF * ydim0_maths_kernel_eqF * 1));
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqF", args, 2, 546, dim, 0, range, block, maths_kernel_eqF_execute);
}
#endif
