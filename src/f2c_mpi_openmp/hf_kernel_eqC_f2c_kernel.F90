! Auto-generated at 2026-04-28 18:43:25.308856 by ops-translator
...
SUBROUTINE hf_kernel_eqC_host_c(name, args, nargs, dim, range, block) BIND(C,name='hf_kernel_eqC_host_c')
...
END SUBROUTINE hf_kernel_eqC_host_c
...
SUBROUTINE hf_kernel_eqC_host( userSubroutine, block, dim, range, &
    ...
    CALL hf_kernel_eqC_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE hf_kernel_eqC_host
