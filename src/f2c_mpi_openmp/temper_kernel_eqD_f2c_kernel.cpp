// Auto-generated at 2026-04-28 18:43:37.802369 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ tcoeff_p = (double *)(args[1].data) + base1 - 1; // Subtracting 1 to convert to C-style

    int multi_d2 = getDatDimFromOpsArg(&args[2]);
    int base2 = getDatBaseFromOpsArg3D(&args[2], start_indx, multi_d2);
    double * __restrict__ tderiv_p = (double *)(args[2].data) + base2 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("temper_kernel_eqD", args, 9, 562, dim, 0, range, block, temper_kernel_eqD_execute);
}
#endif
