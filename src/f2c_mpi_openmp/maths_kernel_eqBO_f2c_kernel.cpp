// Auto-generated at 2026-04-28 18:43:37.455966 by ops-translator
...
//  =======================================================
    ...
    int * __restrict__ itndex_p = (int *)(args[0].data) + base0 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqBO", args, 6, 551, dim, 0, range, block, maths_kernel_eqBO_execute);
}
#endif
