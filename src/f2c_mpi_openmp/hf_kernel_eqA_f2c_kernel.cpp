// Auto-generated at 2026-04-28 18:43:25.253179 by ops-translator
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "hf_kernel_eqA");
#endif
...
//  ======================================================
    int xdim0_hf_kernel_eqA = args[0].dat->size[0];
    int ydim0_hf_kernel_eqA = args[0].dat->size[1];
    int xdim1_hf_kernel_eqA = args[1].dat->size[0];
    int ydim1_hf_kernel_eqA = args[1].dat->size[1];
    int xdim2_hf_kernel_eqA = args[2].dat->size[0];
    int ydim2_hf_kernel_eqA = args[2].dat->size[1];
    ...
    for (int n_z = 0; n_z < end_indx[2]-start_indx[2] +1; n_z++)
    {
        for (int n_y = 0; n_y < end_indx[1]-start_indx[1] +1; n_y++)
        {
            for(int n_x = 0; n_x < end_indx[0]-start_indx[0] +1; n_x++)
            {
                 ...
                 ACC<double> erhs(xdim0_hf_kernel_eqA, ydim0_hf_kernel_eqA, erhs_p + (n_x * 1) + (n_y * xdim0_hf_kernel_eqA * 1) + (n_z * xdim0_hf_kernel_eqA * ydim0_hf_kernel_eqA * 1));

                const  ACC<double> store1(xdim1_hf_kernel_eqA, ydim1_hf_kernel_eqA, store1_p + (n_x * 1) + (n_y * xdim1_hf_kernel_eqA * 1) + (n_z * xdim1_hf_kernel_eqA * ydim1_hf_kernel_eqA * 1));

                const  ACC<double> store7(xdim2_hf_kernel_eqA, ydim2_hf_kernel_eqA, store7_p + (n_x * 1) + (n_y * xdim2_hf_kernel_eqA * 1) + (n_z * xdim2_hf_kernel_eqA * ydim2_hf_kernel_eqA * 1));
    ...
    )
{
    ...
    create_kerneldesc_and_enque("hf_kernel_eqA", args, 4, 215, dim, 0, range, block, hf_kernel_eqA_execute);
}
#endif
