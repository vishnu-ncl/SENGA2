// Auto-generated at 2026-04-28 18:43:37.503236 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ yrun_p = (double *)(args[3].data) + base3 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqBP", args, 12, 552, dim, 0, range, block, maths_kernel_eqBP_execute);
}
#endif
