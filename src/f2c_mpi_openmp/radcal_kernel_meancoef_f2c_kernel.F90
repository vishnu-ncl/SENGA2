! Auto-generated at 2026-04-28 18:43:37.028698 by ops-translator
...
SUBROUTINE radcal_kernel_meancoef_host_c(name, args, nargs, dim, range, block) BIND(C,name='radcal_kernel_meancoef_host_c')
...
END SUBROUTINE radcal_kernel_meancoef_host_c
...
SUBROUTINE radcal_kernel_meancoef_host( userSubroutine, block, dim, range, &
    ...
    CALL radcal_kernel_meancoef_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE radcal_kernel_meancoef_host
