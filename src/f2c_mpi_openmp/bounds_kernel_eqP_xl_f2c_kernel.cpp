// Auto-generated at 2026-04-28 18:43:28.981754 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ strdxl_p = (double *)(args[9].data) + base9 - 1; // Subtracting 1 to convert to C-style

    int base10 = getDatBaseFromOpsArg3D(&args[10], start_indx, 1);
    double * __restrict__ struxl_p = (double *)(args[10].data) + base10 - 1; // Subtracting 1 to convert to C-style

    int base11 = getDatBaseFromOpsArg3D(&args[11], start_indx, 1);
    double * __restrict__ strvxl_p = (double *)(args[11].data) + base11 - 1; // Subtracting 1 to convert to C-style

    int base12 = getDatBaseFromOpsArg3D(&args[12], start_indx, 1);
    double * __restrict__ strwxl_p = (double *)(args[12].data) + base12 - 1; // Subtracting 1 to convert to C-style
    ...
    double * __restrict__ ova2xl_p = (double *)(args[14].data) + base14 - 1; // Subtracting 1 to convert to C-style

    int base15 = getDatBaseFromOpsArg3D(&args[15], start_indx, 1);
    double * __restrict__ ovgmxl_p = (double *)(args[15].data) + base15 - 1; // Subtracting 1 to convert to C-style

    int base16 = getDatBaseFromOpsArg3D(&args[16], start_indx, 1);
    double * __restrict__ acouxl_p = (double *)(args[16].data) + base16 - 1; // Subtracting 1 to convert to C-style

    int * __restrict__  flag_pio_xl = (int *)args[17].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("bounds_kernel_eqP_xl", args, 18, 343, dim, 0, range, block, bounds_kernel_eqP_xl_execute);
}
#endif
