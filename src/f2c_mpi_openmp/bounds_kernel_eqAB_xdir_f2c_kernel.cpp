// Auto-generated at 2026-04-28 18:43:29.557565 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ bcl2x_p = (double *)(args[0].data) + base0 - 1; // Subtracting 1 to convert to C-style

    int base1 = getDatBaseFromOpsArg3D(&args[1], start_indx, 1);
    double * __restrict__ bcl3x_p = (double *)(args[1].data) + base1 - 1; // Subtracting 1 to convert to C-style

    int base2 = getDatBaseFromOpsArg3D(&args[2], start_indx, 1);
    double * __restrict__ bcl4x_p = (double *)(args[2].data) + base2 - 1; // Subtracting 1 to convert to C-style

    int base3 = getDatBaseFromOpsArg3D(&args[3], start_indx, 1);
    double * __restrict__ bcl5x_p = (double *)(args[3].data) + base3 - 1; // Subtracting 1 to convert to C-style

    int base4 = getDatBaseFromOpsArg3D(&args[4], start_indx, 1);
    double * __restrict__ bcl1x_p = (double *)(args[4].data) + base4 - 1; // Subtracting 1 to convert to C-style
    ...
    double * __restrict__ acoux_p = (double *)(args[6].data) + base6 - 1; // Subtracting 1 to convert to C-style

    int base7 = getDatBaseFromOpsArg3D(&args[7], start_indx, 1);
    double * __restrict__ ova2x_p = (double *)(args[7].data) + base7 - 1; // Subtracting 1 to convert to C-style

    int base8 = getDatBaseFromOpsArg3D(&args[8], start_indx, 1);
    double * __restrict__ tt2x_p = (double *)(args[8].data) + base8 - 1; // Subtracting 1 to convert to C-style

    int base9 = getDatBaseFromOpsArg3D(&args[9], start_indx, 1);
    double * __restrict__ tt3x_p = (double *)(args[9].data) + base9 - 1; // Subtracting 1 to convert to C-style

    int base10 = getDatBaseFromOpsArg3D(&args[10], start_indx, 1);
    double * __restrict__ tt4x_p = (double *)(args[10].data) + base10 - 1; // Subtracting 1 to convert to C-style

    int base11 = getDatBaseFromOpsArg3D(&args[11], start_indx, 1);
    double * __restrict__ tt5x_p = (double *)(args[11].data) + base11 - 1; // Subtracting 1 to convert to C-style

    int base12 = getDatBaseFromOpsArg3D(&args[12], start_indx, 1);
    double * __restrict__ strrx_p = (double *)(args[12].data) + base12 - 1; // Subtracting 1 to convert to C-style

    int base13 = getDatBaseFromOpsArg3D(&args[13], start_indx, 1);
    double * __restrict__ stlux_p = (double *)(args[13].data) + base13 - 1; // Subtracting 1 to convert to C-style

    int base14 = getDatBaseFromOpsArg3D(&args[14], start_indx, 1);
    double * __restrict__ strux_p = (double *)(args[14].data) + base14 - 1; // Subtracting 1 to convert to C-style

    int base15 = getDatBaseFromOpsArg3D(&args[15], start_indx, 1);
    double * __restrict__ stlvx_p = (double *)(args[15].data) + base15 - 1; // Subtracting 1 to convert to C-style

    int base16 = getDatBaseFromOpsArg3D(&args[16], start_indx, 1);
    double * __restrict__ strvx_p = (double *)(args[16].data) + base16 - 1; // Subtracting 1 to convert to C-style

    int base17 = getDatBaseFromOpsArg3D(&args[17], start_indx, 1);
    double * __restrict__ stlwx_p = (double *)(args[17].data) + base17 - 1; // Subtracting 1 to convert to C-style

    int base18 = getDatBaseFromOpsArg3D(&args[18], start_indx, 1);
    double * __restrict__ strwx_p = (double *)(args[18].data) + base18 - 1; // Subtracting 1 to convert to C-style

    int base19 = getDatBaseFromOpsArg3D(&args[19], start_indx, 1);
    double * __restrict__ stltx_p = (double *)(args[19].data) + base19 - 1; // Subtracting 1 to convert to C-style

    int base20 = getDatBaseFromOpsArg3D(&args[20], start_indx, 1);
    double * __restrict__ strtx_p = (double *)(args[20].data) + base20 - 1; // Subtracting 1 to convert to C-style

    double * __restrict__  xgdlen = (double *)args[21].data;
    double * __restrict__  nrieta2 = (double *)args[22].data;
    double * __restrict__  nrieta3 = (double *)args[23].data;
    double * __restrict__  nrieta4 = (double *)args[24].data;
    double * __restrict__  nrieta5 = (double *)args[25].data;
    double * __restrict__  m2max = (double *)args[26].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("bounds_kernel_eqAB_xdir", args, 27, 356, dim, 0, range, block, bounds_kernel_eqAB_xdir_execute);
}
#endif
