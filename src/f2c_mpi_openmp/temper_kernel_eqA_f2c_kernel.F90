! Auto-generated at 2026-04-28 18:43:37.656997 by ops-translator
...
SUBROUTINE temper_kernel_eqA_host_c(name, args, nargs, dim, range, block) BIND(C,name='temper_kernel_eqA_host_c')
...
END SUBROUTINE temper_kernel_eqA_host_c
...
SUBROUTINE temper_kernel_eqA_host( userSubroutine, block, dim, range, &
    ...
    CALL temper_kernel_eqA_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE temper_kernel_eqA_host
