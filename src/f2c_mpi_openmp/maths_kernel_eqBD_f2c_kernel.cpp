// Auto-generated at 2026-04-28 18:43:25.160323 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ combo1_p = (double *)(args[0].data) + base0 - 1; // Subtracting 1 to convert to C-style

    int base1 = getDatBaseFromOpsArg3D(&args[1], start_indx, 1);
    double * __restrict__ combo2_p = (double *)(args[1].data) + base1 - 1; // Subtracting 1 to convert to C-style

    int base2 = getDatBaseFromOpsArg3D(&args[2], start_indx, 1);
    double * __restrict__ combo3_p = (double *)(args[2].data) + base2 - 1; // Subtracting 1 to convert to C-style

    int base3 = getDatBaseFromOpsArg3D(&args[3], start_indx, 1);
    double * __restrict__ transp_p = (double *)(args[3].data) + base3 - 1; // Subtracting 1 to convert to C-style

    int base4 = getDatBaseFromOpsArg3D(&args[4], start_indx, 1);
    double * __restrict__ yrhs_p = (double *)(args[4].data) + base4 - 1; // Subtracting 1 to convert to C-style

    double * __restrict__  condco = (double *)args[5].data;
    double * __restrict__  ovwmol = (double *)args[6].data;
    int * __restrict__  ncocon = (int *)args[7].data;
    int * __restrict__  ncocm1 = (int *)args[8].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqBD", args, 10, 212, dim, 0, range, block, maths_kernel_eqBD_execute);
}
#endif
