// Auto-generated at 2026-04-28 18:43:27.029378 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ transp_p = (double *)(args[1].data) + base1 - 1; // Subtracting 1 to convert to C-style

    int multi_d2 = getDatDimFromOpsArg(&args[2]);
    int base2 = getDatBaseFromOpsArg3D(&args[2], start_indx, multi_d2);
    double * __restrict__ yrhs_md_p = (double *)(args[2].data) + base2 - 1; // Subtracting 1 to convert to C-style

    double * __restrict__  viscco = (double *)args[3].data;
    double * __restrict__  wilko1 = (double *)args[4].data;
    double * __restrict__  wilko2 = (double *)args[5].data;
    double * __restrict__  ovwmol = (double *)args[6].data;
    int * __restrict__  ncovis = (int *)args[7].data;
    int * __restrict__  ncovm1 = (int *)args[8].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqBIJK", args, 9, 270, dim, 0, range, block, maths_kernel_eqBIJK_execute);
}
#endif
