// Auto-generated at 2026-04-28 18:43:25.191650 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ wmomix_p = (double *)(args[4].data) + base4 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqBE", args, 6, 213, dim, 0, range, block, maths_kernel_eqBE_execute);
}
#endif
