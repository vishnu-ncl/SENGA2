! Auto-generated at 2026-04-28 18:43:38.318361 by ops-translator
...
SUBROUTINE tempin_kernel_main_host_c(name, args, nargs, dim, range, block) BIND(C,name='tempin_kernel_main_host_c')
...
END SUBROUTINE tempin_kernel_main_host_c
...
SUBROUTINE tempin_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL tempin_kernel_main_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    17, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE tempin_kernel_main_host
