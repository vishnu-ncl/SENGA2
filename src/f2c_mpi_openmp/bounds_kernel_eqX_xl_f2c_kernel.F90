! Auto-generated at 2026-04-28 18:43:29.940171 by ops-translator
...
SUBROUTINE bounds_kernel_eqX_xl_host_c(name, args, nargs, dim, range, block) BIND(C,name='bounds_kernel_eqX_xl_host_c')
...
END SUBROUTINE bounds_kernel_eqX_xl_host_c
...
SUBROUTINE bounds_kernel_eqX_xl_host( userSubroutine, block, dim, range, &
    ...
    CALL bounds_kernel_eqX_xl_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    5, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE bounds_kernel_eqX_xl_host
