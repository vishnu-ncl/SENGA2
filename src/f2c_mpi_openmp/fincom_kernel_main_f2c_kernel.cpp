// Auto-generated at 2026-04-28 18:43:28.153662 by ops-translator
...
//  =======================================================
    ...
    int * __restrict__  nrkstp = (int *)args[5].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("fincom_kernel_main", args, 6, 314, dim, 0, range, block, fincom_kernel_main_execute);
}
#endif
