// Auto-generated at 2026-04-28 18:43:37.740996 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ store7_p = (double *)(args[0].data) + base0 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("temper_kernel_eqC", args, 4, 561, dim, 0, range, block, temper_kernel_eqC_execute);
}
#endif
