// Auto-generated at 2026-04-28 18:43:32.194966 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ bcl5yl_p = (double *)(args[6].data) + base6 - 1; // Subtracting 1 to convert to C-style

    int base7 = getDatBaseFromOpsArg3D(&args[7], start_indx, 1);
    double * __restrict__ ova2yl_p = (double *)(args[7].data) + base7 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("bounds_kernel_eqW_yl", args, 8, 415, dim, 0, range, block, bounds_kernel_eqW_yl_execute);
}
#endif
