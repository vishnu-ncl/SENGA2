// Auto-generated at 2026-04-28 18:43:36.842470 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ strdy_p = (double *)(args[4].data) + base4 - 1; // Subtracting 1 to convert to C-style

    int base5 = getDatBaseFromOpsArg3D(&args[5], start_indx, 1);
    double * __restrict__ struy_p = (double *)(args[5].data) + base5 - 1; // Subtracting 1 to convert to C-style

    int base6 = getDatBaseFromOpsArg3D(&args[6], start_indx, 1);
    double * __restrict__ strvy_p = (double *)(args[6].data) + base6 - 1; // Subtracting 1 to convert to C-style

    int base7 = getDatBaseFromOpsArg3D(&args[7], start_indx, 1);
    double * __restrict__ strwy_p = (double *)(args[7].data) + base7 - 1; // Subtracting 1 to convert to C-style
    ...
    )
{
    ...
    create_kerneldesc_and_enque("boundt_kernel_eqC_ydir", args, 8, 527, dim, 0, range, block, boundt_kernel_eqC_ydir_execute);
}
#endif
