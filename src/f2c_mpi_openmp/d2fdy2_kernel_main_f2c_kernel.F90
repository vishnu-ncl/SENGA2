! Auto-generated at 2026-04-28 18:43:15.367132 by ops-translator
...
SUBROUTINE d2fdy2_kernel_main_host_c(name, args, nargs, dim, range, block) BIND(C,name='d2fdy2_kernel_main_host_c')
...
END SUBROUTINE d2fdy2_kernel_main_host_c
...
SUBROUTINE d2fdy2_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL d2fdy2_kernel_main_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE d2fdy2_kernel_main_host
