// Auto-generated at 2026-04-28 18:43:37.721322 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__ tderiv_p = (double *)(args[1].data) + base1 - 1; // Subtracting 1 to convert to C-style

    int base2 = getDatBaseFromOpsArg3D(&args[2], start_indx, 1);
    int * __restrict__ itndex_p = (int *)(args[2].data) + base2 - 1; // Subtracting 1 to convert to C-style

    int base3 = getDatBaseFromOpsArg3D(&args[3], start_indx, 1);
    double * __restrict__ yrhs_p = (double *)(args[3].data) + base3 - 1; // Subtracting 1 to convert to C-style

    double * __restrict__  amascp = (double *)args[4].data;
    double * __restrict__  amasct = (double *)args[5].data;
    int * __restrict__  ncpoly = (int *)args[6].data;
    int * __restrict__  ncenth = (int *)args[7].data;
    int * __restrict__  ipower = (int *)args[8].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("temper_kernel_eqB", args, 12, 560, dim, 0, range, block, temper_kernel_eqB_execute);
}
#endif
