// Auto-generated at 2026-04-28 18:43:37.342432 by ops-translator
...
//  =======================================================
    ...
    double * __restrict__  amolgb = (double *)args[3].data;
    int * __restrict__  ncpoly = (int *)args[4].data;
    int * __restrict__  ncpom1 = (int *)args[5].data;
    int * __restrict__  ncenth = (int *)args[6].data;
    int * __restrict__  ncenpy = (int *)args[7].data;
    double * __restrict__  diffmu = (double *)args[8].data;
    int * __restrict__  isspec = (int *)args[9].data;
    int * __restrict__  ispec = (int *)args[10].data;
    int * __restrict__  istep = (int *)args[11].data;
    int * __restrict__  ipower = (int *)args[12].data;
    int * __restrict__  icoef1 = (int *)args[13].data;
    int * __restrict__  icoef2 = (int *)args[14].data;
    ...
    )
{
    ...
    create_kerneldesc_and_enque("maths_kernel_eqBN", args, 15, 544, dim, 0, range, block, maths_kernel_eqBN_execute);
}
#endif
