...
! Auto-generated at 2024-04-21 01:16:15.986984 by ops-translator
SUBROUTINE dfbydx(functn, fderiv)

  USE ops_fortran_declarations
  USE ops_fortran_rt_support
  USE dfbydx_kernel_main_module
  ...
  CALL dfbydx_kernel_main_host("dfbydx_main_scheme", senga_grid, 3, rangexyz, &
