// Auto-generated at 2026-04-28 18:44:57.515320 by ops-translator
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class boundt_kernel_eqE_ydir_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
...
// =========
    ...
    itint = 1;
    while (strty(0, 0, 0) > tinthi[(itint-1)+(ispec[0]-1)*ntinmx_sycl[0]] && itint < ntint[ispec[0]-1]) {
        itint = itint + 1;
    }
