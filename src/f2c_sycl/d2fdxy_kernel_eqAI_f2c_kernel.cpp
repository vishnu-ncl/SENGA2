// Auto-generated at 2026-04-28 18:44:36.973304 by ops-translator
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "d2fdxy_kernel_eqAI");
#endif
...
//  ======================================================
    int xdim0_d2fdxy_kernel_eqAI = args[0].dat->size[0];
    int ydim0_d2fdxy_kernel_eqAI = args[0].dat->size[1];
    int xdim1_d2fdxy_kernel_eqAI = args[1].dat->size[0];
    int ydim1_d2fdxy_kernel_eqAI = args[1].dat->size[1];
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class d2fdxy_kernel_eqAI_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                const  ACC<double> functn(xdim0_d2fdxy_kernel_eqAI, ydim0_d2fdxy_kernel_eqAI, functn_p + (n_x * 1) + (n_y * xdim0_d2fdxy_kernel_eqAI * 1) + (n_z * xdim0_d2fdxy_kernel_eqAI * ydim0_d2fdxy_kernel_eqAI * 1));
                 ACC<double> fderiv(xdim1_d2fdxy_kernel_eqAI, ydim1_d2fdxy_kernel_eqAI, fderiv_p + (n_x * 1) + (n_y * xdim1_d2fdxy_kernel_eqAI * 1) + (n_z * xdim1_d2fdxy_kernel_eqAI * ydim1_d2fdxy_kernel_eqAI * 1));
...
// =========
    ...
    fderiv(0, 0, 0) = acf4xy_sycl[0] * fdiffa + bcf4xy_sycl[0] * fdiffb + ccf4xy_sycl[0] * fdiffc;
