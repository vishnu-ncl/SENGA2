// Auto-generated at 2026-04-28 18:44:33.287828 by ops-translator
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "set_zero_kernel_xdir");
#endif
...
//  ======================================================
    int xdim0_set_zero_kernel_xdir = args[0].dat->size[0];
    int ydim0_set_zero_kernel_xdir = args[0].dat->size[1];
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class set_zero_kernel_xdir_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                int n_x = item.get_global_id()[2];
                 ...
                 ACC<double> farray(xdim0_set_zero_kernel_xdir, ydim0_set_zero_kernel_xdir, farray_p + (n_x * 0) + (n_y * xdim0_set_zero_kernel_xdir * 1) + (n_z * xdim0_set_zero_kernel_xdir * ydim0_set_zero_kernel_xdir * 1));
