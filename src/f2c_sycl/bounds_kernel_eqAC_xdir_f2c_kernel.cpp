// Auto-generated at 2026-04-28 18:44:50.535329 by ops-translator
...
//  =======================================================
    ...
    double xgdlen_val = *(double *)args[6].data;

    double nrieta6_val = *(double *)args[7].data;
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class bounds_kernel_eqAC_xdir_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                const double *nrieta6 = &nrieta6_val;
