! Auto-generated at 2026-04-28 18:44:33.460341 by ops-translator
...
SUBROUTINE dfbydx_kernel_main_host_c(name, args, nargs, dim, range, block) BIND(C,name='dfbydx_kernel_main_host_c')
...
END SUBROUTINE dfbydx_kernel_main_host_c
...
SUBROUTINE dfbydx_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL dfbydx_kernel_main_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE dfbydx_kernel_main_host
