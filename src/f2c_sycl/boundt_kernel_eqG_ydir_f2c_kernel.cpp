// Auto-generated at 2026-04-28 18:44:57.763530 by ops-translator
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "boundt_kernel_eqG_ydir");
#endif
...
//  ======================================================
    int xdim0_boundt_kernel_eqG_ydir = args[0].dat->size[0];
    int ydim0_boundt_kernel_eqG_ydir = args[0].dat->size[1];
    int xdim1_boundt_kernel_eqG_ydir = args[1].dat->size[0];
    int ydim1_boundt_kernel_eqG_ydir = args[1].dat->size[1];
    int xdim2_boundt_kernel_eqG_ydir = args[2].dat->size[0];
    int ydim2_boundt_kernel_eqG_ydir = args[2].dat->size[1];
    int xdim3_boundt_kernel_eqG_ydir = args[3].dat->size[0];
    int ydim3_boundt_kernel_eqG_ydir = args[3].dat->size[1];
...
//  =======================================================
    ...
    int icoef1_val = *(int *)args[10].data;

    int icoef2_val = *(int *)args[11].data;
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class boundt_kernel_eqG_ydir_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                int n_x = item.get_global_id()[2];
                 ...
                 ACC<double> erhs(xdim0_boundt_kernel_eqG_ydir, ydim0_boundt_kernel_eqG_ydir, erhs_p + (n_x * 1) + (n_y * xdim0_boundt_kernel_eqG_ydir * 1) + (n_z * xdim0_boundt_kernel_eqG_ydir * ydim0_boundt_kernel_eqG_ydir * 1));
                const  ACC<double> yrhs(xdim1_boundt_kernel_eqG_ydir, ydim1_boundt_kernel_eqG_ydir, yrhs_p + (n_x * 1) + (n_y * xdim1_boundt_kernel_eqG_ydir * 1) + (n_z * xdim1_boundt_kernel_eqG_ydir * ydim1_boundt_kernel_eqG_ydir * 1));
                const  ACC<int> itndex(xdim2_boundt_kernel_eqG_ydir, ydim2_boundt_kernel_eqG_ydir, itndex_p + (n_x * 1) + (n_y * xdim2_boundt_kernel_eqG_ydir * 1) + (n_z * xdim2_boundt_kernel_eqG_ydir * ydim2_boundt_kernel_eqG_ydir * 1));
                const  ACC<double> strty(xdim3_boundt_kernel_eqG_ydir, ydim3_boundt_kernel_eqG_ydir, strty_p + (n_x * 1) + (n_y * xdim3_boundt_kernel_eqG_ydir * 0) + (n_z * xdim3_boundt_kernel_eqG_ydir * ydim3_boundt_kernel_eqG_ydir * 1));

                const double *amasch = arg4_data_d;
                const double *rgspec = arg5_data_d;
