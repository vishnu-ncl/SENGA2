! Auto-generated at 2026-04-28 18:44:58.431722 by ops-translator
...
SUBROUTINE boundt_kernel_eqB_zdir_host_c(name, args, nargs, dim, range, block) BIND(C,name='boundt_kernel_eqB_zdir_host_c')
...
END SUBROUTINE boundt_kernel_eqB_zdir_host_c
...
SUBROUTINE boundt_kernel_eqB_zdir_host( userSubroutine, block, dim, range, &
    ...
    CALL boundt_kernel_eqB_zdir_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    5, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE boundt_kernel_eqB_zdir_host
