// Auto-generated at 2026-04-28 18:44:35.293126 by ops-translator
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "d2fdxy_kernel_eqG");
#endif
...
//  ======================================================
    int xdim0_d2fdxy_kernel_eqG = args[0].dat->size[0];
    int ydim0_d2fdxy_kernel_eqG = args[0].dat->size[1];
    int xdim1_d2fdxy_kernel_eqG = args[1].dat->size[0];
    int ydim1_d2fdxy_kernel_eqG = args[1].dat->size[1];
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class d2fdxy_kernel_eqG_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                const  ACC<double> functn(xdim0_d2fdxy_kernel_eqG, ydim0_d2fdxy_kernel_eqG, functn_p + (n_x * 1) + (n_y * xdim0_d2fdxy_kernel_eqG * 1) + (n_z * xdim0_d2fdxy_kernel_eqG * ydim0_d2fdxy_kernel_eqG * 1));
                 ACC<double> fderiv(xdim1_d2fdxy_kernel_eqG, ydim1_d2fdxy_kernel_eqG, fderiv_p + (n_x * 1) + (n_y * xdim1_d2fdxy_kernel_eqG * 1) + (n_z * xdim1_d2fdxy_kernel_eqG * ydim1_d2fdxy_kernel_eqG * 1));
