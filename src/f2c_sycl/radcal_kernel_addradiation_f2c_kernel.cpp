// Auto-generated at 2026-04-28 18:44:58.610176 by ops-translator
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            auto foursb_sycl = (*foursb_p).template get_access<cl::sycl::access::mode::read>(cgh);
            auto trfrth_sycl = (*trfrth_p).template get_access<cl::sycl::access::mode::read>(cgh);

            cgh.parallel_for<class radcal_kernel_addradiation_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
...
// =========
    ...
    erhs(0, 0, 0) = erhs(0, 0, 0) - foursb_sycl[0] * store1(0, 0, 0) * (fornow - trfrth_sycl[0]);
