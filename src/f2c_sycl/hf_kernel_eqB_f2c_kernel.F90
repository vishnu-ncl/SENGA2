! Auto-generated at 2026-04-28 18:44:45.877733 by ops-translator
...
SUBROUTINE hf_kernel_eqB_host_c(name, args, nargs, dim, range, block) BIND(C,name='hf_kernel_eqB_host_c')
...
END SUBROUTINE hf_kernel_eqB_host_c
...
SUBROUTINE hf_kernel_eqB_host( userSubroutine, block, dim, range, &
    ...
    CALL hf_kernel_eqB_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE hf_kernel_eqB_host
