// Auto-generated at 2026-04-28 18:44:49.154844 by ops-translator
...
//  =======================================================
    ...
    double init_val1_val = *(double *)args[6].data;

    double init_val2_val = *(double *)args[7].data;
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class bcut_kernel_xdir_eqG_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                const double *init_val1 = &init_val1_val;
                const double *init_val2 = &init_val2_val;
