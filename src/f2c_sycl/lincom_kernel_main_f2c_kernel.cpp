// Auto-generated at 2026-04-28 18:44:48.700444 by ops-translator
...
//  =======================================================
    ...
    int irkstp_val = *(int *)args[6].data;
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class lincom_kernel_main_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                const double *rkrhs = arg5_data_d;
                const int *irkstp = &irkstp_val;
