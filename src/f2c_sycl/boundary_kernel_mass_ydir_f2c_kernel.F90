! Auto-generated at 2026-04-28 18:44:46.282207 by ops-translator
...
SUBROUTINE boundary_kernel_mass_ydir_host_c(name, args, nargs, dim, range, block) BIND(C,name='boundary_kernel_mass_ydir_host_c')
...
END SUBROUTINE boundary_kernel_mass_ydir_host_c
...
SUBROUTINE boundary_kernel_mass_ydir_host( userSubroutine, block, dim, range, &
    ...
    CALL boundary_kernel_mass_ydir_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    10, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE boundary_kernel_mass_ydir_host
