! Auto-generated at 2026-04-28 18:44:43.819727 by ops-translator
...
SUBROUTINE d2fdyz_kernel_eqAG_host_c(name, args, nargs, dim, range, block) BIND(C,name='d2fdyz_kernel_eqAG_host_c')
...
END SUBROUTINE d2fdyz_kernel_eqAG_host_c
...
SUBROUTINE d2fdyz_kernel_eqAG_host( userSubroutine, block, dim, range, &
    ...
    CALL d2fdyz_kernel_eqAG_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE d2fdyz_kernel_eqAG_host
