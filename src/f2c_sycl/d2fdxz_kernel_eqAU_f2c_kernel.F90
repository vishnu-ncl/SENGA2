! Auto-generated at 2026-04-28 18:44:41.216456 by ops-translator
...
SUBROUTINE d2fdxz_kernel_eqAU_host_c(name, args, nargs, dim, range, block) BIND(C,name='d2fdxz_kernel_eqAU_host_c')
...
END SUBROUTINE d2fdxz_kernel_eqAU_host_c
...
SUBROUTINE d2fdxz_kernel_eqAU_host( userSubroutine, block, dim, range, &
    ...
    CALL d2fdxz_kernel_eqAU_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE d2fdxz_kernel_eqAU_host
