// Auto-generated at 2026-04-28 18:44:51.179140 by ops-translator
...
//  =======================================================
    ...
    double cobcxr_val = *(double *)args[14].data;

    double pinfxr_val = *(double *)args[15].data;

    double xgdlen_val = *(double *)args[16].data;

    double bet_val = *(double *)args[17].data;

    int flag_bet_xr_val = *(int *)args[18].data;

    int flag_pio_xr_val = *(int *)args[19].data;
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class bounds_kernel_eqH_xr_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                const int *flag_bet_xr = &flag_bet_xr_val;
...
// =========
    ...
    if (flag_bet_xr[0] == 1) {
        ...
        bet_now = cl::sycl::sqrt(bet_now) / acouxr(0, 0, 0);
    }
