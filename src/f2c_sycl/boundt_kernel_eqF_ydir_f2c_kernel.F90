! Auto-generated at 2026-04-28 18:44:58.329448 by ops-translator
...
SUBROUTINE boundt_kernel_eqF_ydir_host_c(name, args, nargs, dim, range, block) BIND(C,name='boundt_kernel_eqF_ydir_host_c')
...
END SUBROUTINE boundt_kernel_eqF_ydir_host_c
...
SUBROUTINE boundt_kernel_eqF_ydir_host( userSubroutine, block, dim, range, &
    ...
    CALL boundt_kernel_eqF_ydir_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    14, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE boundt_kernel_eqF_ydir_host
