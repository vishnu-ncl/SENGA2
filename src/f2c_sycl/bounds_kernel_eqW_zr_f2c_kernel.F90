! Auto-generated at 2026-04-28 18:44:56.914298 by ops-translator
...
SUBROUTINE bounds_kernel_eqW_zr_host_c(name, args, nargs, dim, range, block) BIND(C,name='bounds_kernel_eqW_zr_host_c')
...
END SUBROUTINE bounds_kernel_eqW_zr_host_c
...
SUBROUTINE bounds_kernel_eqW_zr_host( userSubroutine, block, dim, range, &
    ...
    CALL bounds_kernel_eqW_zr_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    8, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE bounds_kernel_eqW_zr_host
