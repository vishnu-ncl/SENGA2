! Auto-generated at 2026-04-28 18:44:48.692737 by ops-translator
...
SUBROUTINE lincom_kernel_main_host_c(name, args, nargs, dim, range, block) BIND(C,name='lincom_kernel_main_host_c')
...
END SUBROUTINE lincom_kernel_main_host_c
...
SUBROUTINE lincom_kernel_main_host( userSubroutine, block, dim, range, &
    ...
    CALL lincom_kernel_main_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE lincom_kernel_main_host
