// Auto-generated at 2026-04-28 18:44:58.488839 by ops-translator
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "boundt_kernel_eqF_zdir");
#endif
...
//  ======================================================
    int xdim0_boundt_kernel_eqF_zdir = args[0].dat->size[0];
    int ydim0_boundt_kernel_eqF_zdir = args[0].dat->size[1];
    int xdim1_boundt_kernel_eqF_zdir = args[1].dat->size[0];
    int ydim1_boundt_kernel_eqF_zdir = args[1].dat->size[1];
    int xdim2_boundt_kernel_eqF_zdir = args[2].dat->size[0];
    int ydim2_boundt_kernel_eqF_zdir = args[2].dat->size[1];
    int xdim3_boundt_kernel_eqF_zdir = args[3].dat->size[0];
    int ydim3_boundt_kernel_eqF_zdir = args[3].dat->size[1];
    int xdim4_boundt_kernel_eqF_zdir = args[4].dat->size[0];
    int ydim4_boundt_kernel_eqF_zdir = args[4].dat->size[1];
    int xdim5_boundt_kernel_eqF_zdir = args[5].dat->size[0];
    int ydim5_boundt_kernel_eqF_zdir = args[5].dat->size[1];
...
//  =============
    ...
    if ((end_0-start_0)>0 && (end_1-start_1)>0 && (end_2-start_2)>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class boundt_kernel_eqF_zdir_sycl>(
                cl::sycl::nd_range<3>(
                    cl::sycl::range<3>(
            ...
            , [=](cl::sycl::nd_item<3> item
                ...
                int n_x = item.get_global_id()[2];
                 ...
                 ACC<double> erhs(xdim0_boundt_kernel_eqF_zdir, ydim0_boundt_kernel_eqF_zdir, erhs_p + (n_x * 1) + (n_y * xdim0_boundt_kernel_eqF_zdir * 1) + (n_z * xdim0_boundt_kernel_eqF_zdir * ydim0_boundt_kernel_eqF_zdir * 1));
                 ACC<double> yrhs(xdim1_boundt_kernel_eqF_zdir, ydim1_boundt_kernel_eqF_zdir, yrhs_p + (n_x * 1) + (n_y * xdim1_boundt_kernel_eqF_zdir * 1) + (n_z * xdim1_boundt_kernel_eqF_zdir * ydim1_boundt_kernel_eqF_zdir * 1));
                const  ACC<int> itndex(xdim2_boundt_kernel_eqF_zdir, ydim2_boundt_kernel_eqF_zdir, itndex_p + (n_x * 1) + (n_y * xdim2_boundt_kernel_eqF_zdir * 1) + (n_z * xdim2_boundt_kernel_eqF_zdir * ydim2_boundt_kernel_eqF_zdir * 1));
                const  ACC<double> drhs(xdim3_boundt_kernel_eqF_zdir, ydim3_boundt_kernel_eqF_zdir, drhs_p + (n_x * 1) + (n_y * xdim3_boundt_kernel_eqF_zdir * 1) + (n_z * xdim3_boundt_kernel_eqF_zdir * ydim3_boundt_kernel_eqF_zdir * 1));
                const  ACC<double> strtz(xdim4_boundt_kernel_eqF_zdir, ydim4_boundt_kernel_eqF_zdir, strtz_p + (n_x * 1) + (n_y * xdim4_boundt_kernel_eqF_zdir * 1) + (n_z * xdim4_boundt_kernel_eqF_zdir * ydim4_boundt_kernel_eqF_zdir * 0));
                const  ACC<double> stryz(xdim5_boundt_kernel_eqF_zdir, ydim5_boundt_kernel_eqF_zdir, stryz_p + (n_x * 1) + (n_y * xdim5_boundt_kernel_eqF_zdir * 1) + (n_z * xdim5_boundt_kernel_eqF_zdir * ydim5_boundt_kernel_eqF_zdir * 0));
