! Auto-generated at 2026-04-28 18:44:49.369845 by ops-translator
...
SUBROUTINE bcyt_kernel_xdir_eqD_host_c(name, args, nargs, dim, range, block) BIND(C,name='bcyt_kernel_xdir_eqD_host_c')
...
END SUBROUTINE bcyt_kernel_xdir_eqD_host_c
...
SUBROUTINE bcyt_kernel_xdir_eqD_host( userSubroutine, block, dim, range, &
    ...
    CALL bcyt_kernel_xdir_eqD_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    6, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE bcyt_kernel_xdir_eqD_host
