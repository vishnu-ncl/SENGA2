! Auto-generated at 2026-04-28 18:44:59.196198 by ops-translator
...
SUBROUTINE turbin_kernel_eqB_host_c(name, args, nargs, dim, range, block) BIND(C,name='turbin_kernel_eqB_host_c')
...
END SUBROUTINE turbin_kernel_eqB_host_c
...
SUBROUTINE turbin_kernel_eqB_host( userSubroutine, block, dim, range, &
    ...
    CALL turbin_kernel_eqB_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    2, dim, c_loc(range_tmp), &
                                    block%blockCptr)

END SUBROUTINE turbin_kernel_eqB_host
