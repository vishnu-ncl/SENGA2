! Auto-generated at 2026-04-28 18:43:14.061206 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: bountt_kernel_eqF_zdir
#endif
...
SUBROUTINE bountt_kernel_eqF_zdir_wrap( &
    ...
    INTEGER(KIND=4), DIMENSION(*), INTENT(IN) :: opsDat16Local
...
END SUBROUTINE bountt_kernel_eqF_zdir_wrap
...
SUBROUTINE bountt_kernel_eqF_zdir_host_execute( descPtr )
    ...
    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat16Local
