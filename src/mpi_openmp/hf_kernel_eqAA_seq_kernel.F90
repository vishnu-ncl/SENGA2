! Auto-generated at 2024-04-21 01:07:42.704695 by ops-translator

MODULE HF_KERNEL_EQAA_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: hf_kernel_eqAA
...
SUBROUTINE hf_kernel_eqAA_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE hf_kernel_eqAA_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE hf_kernel_eqAA_host_execute( descPtr )
...
SUBROUTINE hf_kernel_eqAA_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    8, 271, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(hf_kernel_eqAA_host_execute))

END SUBROUTINE
#endif

END MODULE HF_KERNEL_EQAA_MODULE
