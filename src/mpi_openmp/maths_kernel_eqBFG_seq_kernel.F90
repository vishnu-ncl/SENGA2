! Auto-generated at 2026-04-28 18:43:11.537302 by ops-translator
...
#define OPS_ACC_MD5(d,x,y,z) ((x) + (xdim5*(y)) + (xdim5*ydim5*(z)) + (xdim5*ydim5*zdim5*(d-1)) + 1)
...
!DEC$ ATTRIBUTES FORCEINLINE :: maths_kernel_eqBFG
#endif
...
SUBROUTINE maths_kernel_eqBFG_wrap( &
    ...
    INTEGER(KIND=4), DIMENSION(*), INTENT(IN) :: opsDat13Local
    INTEGER(KIND=4), INTENT(IN) :: dat13_base

    INTEGER(KIND=4), DIMENSION(*), INTENT(IN) :: opsDat14Local
...
END SUBROUTINE maths_kernel_eqBFG_wrap
...
SUBROUTINE maths_kernel_eqBFG_host_execute( descPtr )
    ...
    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat13Local
    INTEGER(KIND=4) :: dat13_base

    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat14Local
...
!   ==========================
    ...
    multi_d5 = getDatDimFromOpsArg(opsArg5) ! dimension of the multi-dim dat
