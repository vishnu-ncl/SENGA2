! Auto-generated at 2026-04-28 18:43:14.268213 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: turbin_kernel_eqA
#endif
...
SUBROUTINE turbin_kernel_eqA_wrap( &
    ...
    !$OMP PARALLEL DO PRIVATE(n_x,n_y,n_z) REDUCTION(+:opsDat7Local) 
...
END SUBROUTINE turbin_kernel_eqA_wrap
...
!   ==========================
    ...
    CALL c_f_pointer(getReductionPtrFromOpsArg(opsArg7,block), opsDat7Local, [opsArg7%dim])
    dat7_base = 1
