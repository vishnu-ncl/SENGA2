! Auto-generated at 2026-04-28 18:43:13.070882 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: bounds_kernel_eqP_yr
#endif
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                opsDat11Local(dat11_base + ((n_x-1)*1) + ((n_y-1)*xdim11*0) + ((n_z-1)*ydim11*xdim11*1)), &

                opsDat12Local(dat12_base + ((n_x-1)*1) + ((n_y-1)*xdim12*0) + ((n_z-1)*ydim12*xdim12*1)), &
                ...
                opsDat17Local(dat17_base + ((n_x-1)*1) + ((n_y-1)*xdim17*0) + ((n_z-1)*ydim17*xdim17*1)), &
...
END SUBROUTINE bounds_kernel_eqP_yr_wrap
