! Auto-generated at 2024-04-21 01:07:44.834431 by ops-translator

MODULE MATHS_KERNEL_PRINT_ERHS_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: maths_kernel_print_erhs
...
SUBROUTINE maths_kernel_print_erhs_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    dat1_base, &
    dat2_base, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE maths_kernel_print_erhs_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2 &
    )
...
#else
SUBROUTINE maths_kernel_print_erhs_host_execute( descPtr )
    ...
    kernelName = "maths_kernel_print_erhs"
...
!   ==============================
    CALL maths_kernel_print_erhs_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        dat1_base, &
                        dat2_base, &
...
SUBROUTINE maths_kernel_print_erhs_host( userSubroutine, block, dim, range, &
    ...
    namelit = "maths_kernel_print_erhs"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    2, 546, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(maths_kernel_print_erhs_host_execute))

END SUBROUTINE
#endif

END MODULE MATHS_KERNEL_PRINT_ERHS_MODULE
