! Auto-generated at 2024-04-21 01:07:42.566746 by ops-translator

MODULE MATHS_KERNEL_EQBF_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: maths_kernel_eqBF
...
SUBROUTINE maths_kernel_eqBF_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE maths_kernel_eqBF_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE maths_kernel_eqBF_host_execute( descPtr )
...
SUBROUTINE maths_kernel_eqBF_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    14, 234, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(maths_kernel_eqBF_host_execute))

END SUBROUTINE
#endif

END MODULE MATHS_KERNEL_EQBF_MODULE
