! Auto-generated at 2026-04-28 18:43:11.887831 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: adaptt_kernel_err_eval
#endif
...
SUBROUTINE adaptt_kernel_err_eval_wrap( &
    ...
    !$OMP PARALLEL DO PRIVATE(n_x,n_y,n_z) REDUCTION(MAX:opsDat4Local) 
...
END SUBROUTINE adaptt_kernel_err_eval_wrap
...
!   ==========================
    ...
    CALL c_f_pointer(getReductionPtrFromOpsArg(opsArg4,block), opsDat4Local, [opsArg4%dim])
    dat4_base = 1
