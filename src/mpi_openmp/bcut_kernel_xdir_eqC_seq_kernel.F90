! Auto-generated at 2024-04-21 01:07:42.937034 by ops-translator

MODULE BCUT_KERNEL_XDIR_EQC_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: bcut_kernel_xdir_eqC
...
SUBROUTINE bcut_kernel_xdir_eqC_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bcut_kernel_xdir_eqC_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4 &
...
#else
SUBROUTINE bcut_kernel_xdir_eqC_host_execute( descPtr )
    ...
    kernelName = "bcut_kernel_xdir_eqC"
...
!   ==============================
    CALL bcut_kernel_xdir_eqC_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
SUBROUTINE bcut_kernel_xdir_eqC_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    4, 328, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bcut_kernel_xdir_eqC_host_execute))

END SUBROUTINE
#endif

END MODULE BCUT_KERNEL_XDIR_EQC_MODULE
