! Auto-generated at 2026-04-28 18:43:13.701479 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: bounds_kernel_eqP_zr
#endif
...
SUBROUTINE bounds_kernel_eqP_zr_wrap( &
    ...
    INTEGER(KIND=4), DIMENSION(*), INTENT(IN) :: opsDat18Local
...
END SUBROUTINE bounds_kernel_eqP_zr_wrap
...
SUBROUTINE bounds_kernel_eqP_zr_host_execute( descPtr )
    ...
    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat18Local
...
!   ==============
#ifndef OPS_LAZY
    CALL ops_H_D_exchanges_host(opsArgArray, 18)
...
#ifndef OPS_LAZY
    CALL ops_set_dirtybit_host(opsArgArray, 18)
