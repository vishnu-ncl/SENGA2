! Auto-generated at 2026-04-28 18:43:14.031193 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: bountt_kernel_eqC_ydir
#endif
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                opsDat13Local(dat13_base + ((n_x-1)*1) + ((n_y-1)*xdim13*0) + ((n_z-1)*ydim13*xdim13*1)), &

                opsDat14Local(dat14_base + ((n_x-1)*1) + ((n_y-1)*xdim14*0) + ((n_z-1)*ydim14*xdim14*1)), &

                opsDat15Local(dat15_base + ((n_x-1)*1) + ((n_y-1)*xdim15*0) + ((n_z-1)*ydim15*xdim15*1)), &

                opsDat16Local(dat16_base + ((n_x-1)*1) + ((n_y-1)*xdim16*0) + ((n_z-1)*ydim16*xdim16*1)) &
               )
...
END SUBROUTINE bountt_kernel_eqC_ydir_wrap
