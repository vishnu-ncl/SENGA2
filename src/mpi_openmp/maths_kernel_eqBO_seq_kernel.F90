! Auto-generated at 2026-04-28 18:43:14.203599 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: maths_kernel_eqBO
#endif
...
SUBROUTINE maths_kernel_eqBO_wrap( &
    ...
    INTEGER(KIND=4), DIMENSION(*), INTENT(INOUT) :: opsDat1Local
...
END SUBROUTINE maths_kernel_eqBO_wrap
...
SUBROUTINE maths_kernel_eqBO_host_execute( descPtr )
    ...
    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat1Local
