! Auto-generated at 2024-04-21 01:07:43.108200 by ops-translator

MODULE BCYT_KERNEL_XDIR_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: bcyt_kernel_xdir
SUBROUTINE bcyt_kernel_xdir(stryx,dydtx,yrin,ispec)
...
SUBROUTINE bcyt_kernel_xdir_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bcyt_kernel_xdir_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4 &
...
#else
SUBROUTINE bcyt_kernel_xdir_host_execute( descPtr )
...
SUBROUTINE bcyt_kernel_xdir_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    ...
                                    block%blockCptr, c_funloc(bcyt_kernel_xdir_host_execute))

END SUBROUTINE
#endif

END MODULE BCYT_KERNEL_XDIR_MODULE
