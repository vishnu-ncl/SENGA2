! Auto-generated at 2024-04-21 01:07:42.928912 by ops-translator

MODULE BCUT_KERNEL_XDIR_CONST_UVEL_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: bcut_kernel_xdir_const_uvel
...
SUBROUTINE bcut_kernel_xdir_const_uvel_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                CALL bcut_kernel_xdir_const_uvel( &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bcut_kernel_xdir_const_uvel_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE bcut_kernel_xdir_const_uvel_host_execute( descPtr )
    ...
    kernelName = "bcut_kernel_xdir_const_uvel"
...
!   ==============================
    CALL bcut_kernel_xdir_const_uvel_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
SUBROUTINE bcut_kernel_xdir_const_uvel_host( userSubroutine, block, dim, range, &
    ...
    namelit = "bcut_kernel_xdir_const_uvel"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    7, 324, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bcut_kernel_xdir_const_uvel_host_execute))

END SUBROUTINE
#endif

END MODULE BCUT_KERNEL_XDIR_CONST_UVEL_MODULE
