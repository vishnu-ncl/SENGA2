! Auto-generated at 2026-04-28 18:43:14.311043 by ops-translator
...
#define OPS_ACC_MD7(d,x,y,z) ((x) + (xdim7*(y)) + (xdim7*ydim7*(z)) + (xdim7*ydim7*zdim7*(d-1)) + 1)
...
END SUBROUTINE tempin_kernel_main_wrap
...
!   ==========================
    ...
    multi_d7 = getDatDimFromOpsArg(opsArg7) ! dimension of the multi-dim dat
