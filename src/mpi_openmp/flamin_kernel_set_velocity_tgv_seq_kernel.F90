! Auto-generated at 2024-04-21 01:07:44.657329 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: flamin_kernel_set_velocity_tgv
...
SUBROUTINE flamin_kernel_set_velocity_tgv_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        ...
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                CALL flamin_kernel_set_velocity_tgv( &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE flamin_kernel_set_velocity_tgv_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE flamin_kernel_set_velocity_tgv_host_execute( descPtr )
    ...
    kernelName = "flamin_kernel_set_velocity_tgv"
...
!   ==============================
    CALL flamin_kernel_set_velocity_tgv_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        opsDat4Local, &
...
SUBROUTINE flamin_kernel_set_velocity_tgv_host( userSubroutine, block, dim, range, &
    ...
    namelit = "flamin_kernel_set_velocity_tgv"
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    14, 514, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(flamin_kernel_set_velocity_tgv_host_execute))

END SUBROUTINE
#endif

END MODULE FLAMIN_KERNEL_SET_VELOCITY_TGV_MODULE
