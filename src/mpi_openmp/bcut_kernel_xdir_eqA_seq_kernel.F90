! Auto-generated at 2024-04-21 01:07:42.933045 by ops-translator

MODULE BCUT_KERNEL_XDIR_EQA_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: bcut_kernel_xdir_eqA
...
SUBROUTINE bcut_kernel_xdir_eqA_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    dat1_base, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bcut_kernel_xdir_eqA_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3 &
    )
...
#else
SUBROUTINE bcut_kernel_xdir_eqA_host_execute( descPtr )
    ...
    kernelName = "bcut_kernel_xdir_eqA"
...
!   ==============================
    CALL bcut_kernel_xdir_eqA_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        opsDat3Local, &
                        dat1_base, &
...
SUBROUTINE bcut_kernel_xdir_eqA_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    3, 326, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bcut_kernel_xdir_eqA_host_execute))

END SUBROUTINE
#endif

END MODULE BCUT_KERNEL_XDIR_EQA_MODULE
