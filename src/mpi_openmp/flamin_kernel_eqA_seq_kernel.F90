! Auto-generated at 2024-04-21 01:07:44.659492 by ops-translator

MODULE FLAMIN_KERNEL_EQA_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: flamin_kernel_eqA
...
SUBROUTINE flamin_kernel_eqA_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    dat1_base, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE flamin_kernel_eqA_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3 &
    )
...
#else
SUBROUTINE flamin_kernel_eqA_host_execute( descPtr )
...
SUBROUTINE flamin_kernel_eqA_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    3, 515, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(flamin_kernel_eqA_host_execute))

END SUBROUTINE
#endif

END MODULE FLAMIN_KERNEL_EQA_MODULE
