! Auto-generated at 2024-04-21 01:07:42.941526 by ops-translator

MODULE BCUT_KERNEL_XDIR_EQE_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: bcut_kernel_xdir_eqE
...
SUBROUTINE bcut_kernel_xdir_eqE_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    dat1_base, &
    dat2_base, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE bcut_kernel_xdir_eqE_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2 &
    )
...
#else
SUBROUTINE bcut_kernel_xdir_eqE_host_execute( descPtr )
    ...
    kernelName = "bcut_kernel_xdir_eqE"
...
!   ==============================
    CALL bcut_kernel_xdir_eqE_wrap( &
                        opsDat1Local, &
                        opsDat2Local, &
                        dat1_base, &
                        dat2_base, &
...
SUBROUTINE bcut_kernel_xdir_eqE_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    2, 330, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(bcut_kernel_xdir_eqE_host_execute))

END SUBROUTINE
#endif

END MODULE BCUT_KERNEL_XDIR_EQE_MODULE
