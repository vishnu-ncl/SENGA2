! Auto-generated at 2026-04-28 18:43:14.180930 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: maths_kernel_eqBN
#endif
...
SUBROUTINE maths_kernel_eqBN_wrap( &
    ...
    INTEGER(KIND=4), DIMENSION(*), INTENT(IN) :: opsDat15Local
...
END SUBROUTINE maths_kernel_eqBN_wrap
...
SUBROUTINE maths_kernel_eqBN_host_execute( descPtr )
    ...
    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat15Local
