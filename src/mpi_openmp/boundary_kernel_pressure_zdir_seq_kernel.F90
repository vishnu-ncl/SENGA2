! Auto-generated at 2026-04-28 18:43:11.780607 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: boundary_kernel_pressure_zdir
#endif
...
SUBROUTINE boundary_kernel_pressure_zdir_wrap( &
    ...
    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat6Local
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                opsDat14Local(dat14_base + ((n_x-1)*1) + ((n_y-1)*xdim14*1) + ((n_z-1)*ydim14*xdim14*1)), &

                opsDat15Local(dat15_base + ((n_x-1)*1) + ((n_y-1)*xdim15*1) + ((n_z-1)*ydim15*xdim15*1)) &
               )
...
END SUBROUTINE boundary_kernel_pressure_zdir_wrap
...
!   ==============
#ifndef OPS_LAZY
    CALL ops_H_D_exchanges_host(opsArgArray, 15)
...
#ifndef OPS_LAZY
    CALL ops_set_dirtybit_host(opsArgArray, 15)
