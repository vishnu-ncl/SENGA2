! Auto-generated at 2024-04-21 01:07:42.733037 by ops-translator

MODULE MATHS_KERNEL_EQBJ_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: maths_kernel_eqBJ
...
SUBROUTINE maths_kernel_eqBJ_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE maths_kernel_eqBJ_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE maths_kernel_eqBJ_host_execute( descPtr )
...
SUBROUTINE maths_kernel_eqBJ_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    ...
                                    block%blockCptr, c_funloc(maths_kernel_eqBJ_host_execute))

END SUBROUTINE
#endif

END MODULE MATHS_KERNEL_EQBJ_MODULE
