! Auto-generated at 2026-04-28 18:43:11.776438 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: boundary_kernel_pressure_ydir
#endif
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1*0) + ((n_z-1)*ydim1*xdim1*1)), &

                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2*0) + ((n_z-1)*ydim2*xdim2*1)), &
...
END SUBROUTINE boundary_kernel_pressure_ydir_wrap
