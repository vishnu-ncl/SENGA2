! Auto-generated at 2026-04-28 18:43:14.299624 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: temper_kernel_eqE
#endif
...
SUBROUTINE temper_kernel_eqE_wrap( &
    ...
    INTEGER(KIND=4), DIMENSION(*), INTENT(INOUT) :: opsDat2Local
...
END SUBROUTINE temper_kernel_eqE_wrap
...
SUBROUTINE temper_kernel_eqE_host_execute( descPtr )
    ...
    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat2Local
