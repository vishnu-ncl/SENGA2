! Auto-generated at 2026-04-28 18:43:11.890697 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: adaptt_kernel_err_eval_MD
#endif
...
SUBROUTINE adaptt_kernel_err_eval_MD_wrap( &
    ...
    !$OMP PARALLEL DO PRIVATE(n_x,n_y,n_z) REDUCTION(MAX:opsDat5Local) 
...
END SUBROUTINE adaptt_kernel_err_eval_MD_wrap
...
!   ==========================
    ...
    CALL c_f_pointer(getReductionPtrFromOpsArg(opsArg5,block), opsDat5Local, [opsArg5%dim])
    dat5_base = 1
