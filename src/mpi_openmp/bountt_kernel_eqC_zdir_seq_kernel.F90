! Auto-generated at 2026-04-28 18:43:14.065155 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: bountt_kernel_eqC_zdir
#endif
...
SUBROUTINE bountt_kernel_eqC_zdir_wrap( &
    ...
    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat3Local
    ...
    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat7Local
    INTEGER(KIND=4), INTENT(IN) :: dat7_base

    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat8Local
    INTEGER(KIND=4), INTENT(IN) :: dat8_base

    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat9Local
    INTEGER(KIND=4), INTENT(IN) :: dat9_base

    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat10Local
    INTEGER(KIND=4), INTENT(IN) :: dat10_base

    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat11Local
    INTEGER(KIND=4), INTENT(IN) :: dat11_base

    REAL(KIND=8), DIMENSION(*), INTENT(OUT) :: opsDat12Local
...
END SUBROUTINE bountt_kernel_eqC_zdir_wrap
...
!   ==============
#ifndef OPS_LAZY
    CALL ops_H_D_exchanges_host(opsArgArray, 16)
...
#ifndef OPS_LAZY
    CALL ops_set_dirtybit_host(opsArgArray, 16)
