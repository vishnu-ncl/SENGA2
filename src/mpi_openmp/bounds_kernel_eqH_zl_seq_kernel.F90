! Auto-generated at 2026-04-28 18:43:13.405854 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: bounds_kernel_eqH_zl
#endif
...
SUBROUTINE bounds_kernel_eqH_zl_wrap( &
    ...
    INTEGER(KIND=4), DIMENSION(*), INTENT(IN) :: opsDat19Local
    INTEGER(KIND=4), INTENT(IN) :: dat19_base

    INTEGER(KIND=4), DIMENSION(*), INTENT(IN) :: opsDat20Local
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                opsDat1Local(dat1_base + ((n_x-1)*1) + ((n_y-1)*xdim1*1) + ((n_z-1)*ydim1*xdim1*0)), &

                opsDat2Local(dat2_base + ((n_x-1)*1) + ((n_y-1)*xdim2*1) + ((n_z-1)*ydim2*xdim2*0)), &

                opsDat3Local(dat3_base + ((n_x-1)*1) + ((n_y-1)*xdim3*1) + ((n_z-1)*ydim3*xdim3*0)), &

                opsDat4Local(dat4_base + ((n_x-1)*1) + ((n_y-1)*xdim4*1) + ((n_z-1)*ydim4*xdim4*0)), &

                opsDat5Local(dat5_base + ((n_x-1)*1) + ((n_y-1)*xdim5*1) + ((n_z-1)*ydim5*xdim5*0)), &

                opsDat6Local(dat6_base + ((n_x-1)*1) + ((n_y-1)*xdim6*1) + ((n_z-1)*ydim6*xdim6*0)), &

                opsDat7Local(dat7_base + ((n_x-1)*1) + ((n_y-1)*xdim7*1) + ((n_z-1)*ydim7*xdim7*0)), &

                opsDat8Local(dat8_base + ((n_x-1)*1) + ((n_y-1)*xdim8*1) + ((n_z-1)*ydim8*xdim8*0)), &

                opsDat9Local(dat9_base + ((n_x-1)*1) + ((n_y-1)*xdim9*1) + ((n_z-1)*ydim9*xdim9*0)), &

                opsDat10Local(dat10_base + ((n_x-1)*1) + ((n_y-1)*xdim10*1) + ((n_z-1)*ydim10*xdim10*0)), &

                opsDat11Local(dat11_base + ((n_x-1)*1) + ((n_y-1)*xdim11*1) + ((n_z-1)*ydim11*xdim11*0)), &

                opsDat12Local(dat12_base + ((n_x-1)*1) + ((n_y-1)*xdim12*1) + ((n_z-1)*ydim12*xdim12*0)), &

                opsDat13Local(dat13_base + ((n_x-1)*1) + ((n_y-1)*xdim13*1) + ((n_z-1)*ydim13*xdim13*0)), &

                opsDat14Local(dat14_base + ((n_x-1)*1) + ((n_y-1)*xdim14*1) + ((n_z-1)*ydim14*xdim14*0)), &
...
END SUBROUTINE bounds_kernel_eqH_zl_wrap
...
SUBROUTINE bounds_kernel_eqH_zl_host_execute( descPtr )
    ...
    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat19Local
    INTEGER(KIND=4) :: dat19_base

    INTEGER(KIND=4), POINTER, DIMENSION(:) :: opsDat20Local
...
!   ==============
#ifndef OPS_LAZY
    CALL ops_H_D_exchanges_host(opsArgArray, 20)
...
#ifndef OPS_LAZY
    CALL ops_set_dirtybit_host(opsArgArray, 20)
