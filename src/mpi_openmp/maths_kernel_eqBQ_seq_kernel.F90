! Auto-generated at 2024-04-21 01:07:44.846276 by ops-translator

MODULE MATHS_KERNEL_EQBQ_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: maths_kernel_eqBQ
...
SUBROUTINE maths_kernel_eqBQ_wrap( &
    opsDat1Local, &
    opsDat2Local, &
    opsDat3Local, &
    opsDat4Local, &
    ...
    REAL(KIND=8), DIMENSION(1), INTENT(INOUT) :: opsDat8Local
...
!   ===============
#ifndef OPS_LAZY
SUBROUTINE maths_kernel_eqBQ_host( userSubroutine, block, dim, range, &
    opsArg1, &
    opsArg2, &
    opsArg3, &
    opsArg4, &
...
#else
SUBROUTINE maths_kernel_eqBQ_host_execute( descPtr )
...
!   ==========================
    ...
    CALL c_f_pointer(getReductionPtrFromOpsArg(opsArg8,block), opsDat8Local, (/opsArg8%dim/))
    dat8_base = 1
...
SUBROUTINE maths_kernel_eqBQ_host( userSubroutine, block, dim, range, &
    ...
    CALL create_kerneldesc_and_enque(namelit//c_null_char, c_loc(opsArgArray), &
                                    8, 548, dim, 0, c_loc(range_tmp), &
                                    block%blockCptr, c_funloc(maths_kernel_eqBQ_host_execute))

END SUBROUTINE
#endif

END MODULE MATHS_KERNEL_EQBQ_MODULE
