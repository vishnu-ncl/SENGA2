! Auto-generated at 2024-04-21 01:07:44.231336 by ops-translator
...
!DEC$ ATTRIBUTES FORCEINLINE :: bounds_kernel_eqN_zl
    ...
    DO n_z = 1, end_indx(3)-start_indx(3)+1
        DO n_y = 1, end_indx(2)-start_indx(2)+1
            ...
            DO n_x = 1, end_indx(1)-start_indx(1)+1
                ...
                opsDat15Local(dat15_base + ((n_x-1)*1) + ((n_y-1)*xdim15*1) + ((n_z-1)*ydim15*xdim15*0)), &

                opsDat16Local(dat16_base + ((n_x-1)*1) + ((n_y-1)*xdim16*1) + ((n_z-1)*ydim16*xdim16*0)), &

                opsDat17Local(dat17_base + ((n_x-1)*1) + ((n_y-1)*xdim17*1) + ((n_z-1)*ydim17*xdim17*0)) &
               )
