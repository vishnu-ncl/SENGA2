! Auto-generated at 2026-04-28 18:43:14.294273 by ops-translator
...
#define OPS_ACC_MD3(d,x,y,z) ((x) + (xdim3*(y)) + (xdim3*ydim3*(z)) + (xdim3*ydim3*zdim3*(d-1)) + 1)
...
END SUBROUTINE temper_kernel_eqD_wrap
...
!   ==========================
    ...
    multi_d3 = getDatDimFromOpsArg(opsArg3) ! dimension of the multi-dim dat
