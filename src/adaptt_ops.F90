...
! Auto-generated at 2026-04-28 18:43:09.225674 by ops-translator
SUBROUTINE adaptt
...
ops_arg_reduce(h_erytot, 1, "real(kind=8)", OPS_MAX))
    ...
    !       PID-CONTROLLER
    tratio = ctmult * EXP(ctalph * LOG(errtol / errmax) + ctbeta * LOG(errold / errtol) + ctgama * LOG(errtol / errldr))
    errldr = errold
    errold = errmax
