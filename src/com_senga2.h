...
C     GLOBAL GRID SIZE
      ...
      PARAMETER(NXGLBL=200, NYGLBL=200, NZGLBL=1)
      INTEGER NGZMAX
...
C     NUMBER OF PROCESSORS
      ...
      PARAMETER(NXPROC=5, NYPROC=2, NZPROC=1)
      INTEGER NPRMAX
...
C     LOCAL GRID SIZE
      ...
      PARAMETER(NXSIZE=40, NYSIZE=100, NZSIZE=1)
      INTEGER NSZMAX
...
C     SIZE OF HALO
      ...
      PARAMETER(NHALOX=5,NHALOY=5,NHALOZ=1)
