...
C     GLOBAL GRID SIZE
      ...
      PARAMETER(NXGLBL=1440, NYGLBL=720, NZGLBL=1)
      INTEGER NGZMAX
...
C     NUMBER OF PROCESSORS
      ...
      PARAMETER(NXPROC=32, NYPROC=4, NZPROC=1)
      INTEGER NPRMAX
...
C     LOCAL GRID SIZE
      ...
      PARAMETER(NXSIZE=45, NYSIZE=180, NZSIZE=1)
      INTEGER NSZMAX
...
C     SIZE OF HALO
      ...
      PARAMETER(NHALOX=5,NHALOY=5,NHALOZ=0)
...
C     INFLOW TURBULENCE GENERATOR BY SYNTHETIC DIGITAL FILTERING
      INTEGER NFZ,NFY,LNX,LNY,LNZ
      PARAMETER(LNX=30,LNY=30,LNZ=30)
C     NFY AND NFZ ARE TWICE OF LNY AND LNZ
...
C     RUNGE-KUTTA PARAMETERS
      ...
      DOUBLE PRECISION ERROLD,ERRLDR,BTIME
     ...
     +              IRKSTP,NRKSTP,NRKSM1,INDERR,FUPELC
...
C     X-DIRECTION LEFT-HAND END
     ...
     +              UINF1,UINF2,VINF1,VINF2,WINF1,WINF2,USTEAD,
     +              YINF1,YINF2
...
C     STATIS-------------------------------------------------------------------
C     FY - FOR NON REFLECTING INFLOW 
      
      INTEGER NBCPRC
      PARAMETER(NBCPRC=9)
      DOUBLE PRECISION RXLPRC(NBCPRC)
