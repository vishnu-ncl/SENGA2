...
! Auto-generated at 2026-04-28 18:43:09.425880 by ops-translator
SUBROUTINE bounds
  ...
  USE bounds_kernel_eqaa_xdir_module
  USE copy_kernel_xxdir_module
  USE set_zero_kernel_xdir_module
  USE bounds_kernel_eqd_xdir_module
  USE bounds_kernel_eqf_xdir_module
  USE bounds_kernel_eqh_xl_module
  USE bounds_kernel_eqp_xl_module
  USE bounds_kernel_eqq_xl_module
  USE bounds_kernel_eqi_xl_module
  USE bounds_kernel_eqj_xl_module
  USE bounds_kernel_eqr_xl_module
  USE bounds_kernel_eqs_xl_module
  USE bounds_kernel_eqe_xdir_module
  USE bounds_kernel_eqg_xdir_module
  USE bounds_kernel_eqk_xl_module
  USE bounds_kernel_eqt_xl_module
  USE bounds_kernel_eql_xl_module
  USE bounds_kernel_equ_xl_module
  USE bounds_kernel_eqv_xl_module
  USE bounds_kernel_eqab_xdir_module
  USE bounds_kernel_eqac_xdir_module
  USE bounds_kernel_eqad_xdir_module
  USE bounds_kernel_eqae_xdir_module
  USE bounds_kernel_eqaf_xl_module
  USE bounds_kernel_eqag_xdir_module
  USE bounds_kernel_eqah_xdir_module
  USE bounds_kernel_eqm_xl_module
  USE bounds_kernel_eqw_xl_module
  USE bounds_kernel_eqx_xl_module
  USE bounds_kernel_eqn_xl_module
  USE bounds_kernel_eqo_xl_module
  USE bounds_kernel_eqy_xl_module
  USE bounds_kernel_eqz_xl_module
  USE bounds_kernel_eqh_xr_module
  USE bounds_kernel_eqp_xr_module
  USE bounds_kernel_eqq_xr_module
  USE bounds_kernel_eqi_xr_module
  USE bounds_kernel_eqj_xr_module
  USE bounds_kernel_eqr_xr_module
  USE bounds_kernel_eqs_xr_module
  USE bounds_kernel_eqk_xr_module
  USE bounds_kernel_eqt_xr_module
  USE bounds_kernel_eql_xr_module
  USE bounds_kernel_equ_xr_module
  USE bounds_kernel_eqv_xr_module
  USE bounds_kernel_eqaf_xr_module
  USE bounds_kernel_eqm_xr_module
  USE bounds_kernel_eqw_xr_module
  USE bounds_kernel_eqx_xr_module
  USE bounds_kernel_eqn_xr_module
  USE bounds_kernel_eqo_xr_module
  USE bounds_kernel_eqy_xr_module
  USE bounds_kernel_eqz_xr_module
  USE bounds_kernel_eqa_ydir_module
  USE bounds_kernel_eqb_ydir_module
  USE bounds_kernel_eqc_ydir_module
  USE bounds_kernel_eqaa_ydir_module
  USE copy_kernel_yydir_module
  USE set_zero_kernel_ydir_module
  USE bounds_kernel_eqd_ydir_module
  USE bounds_kernel_eqf_ydir_module
  USE bounds_kernel_eqh_yl_module
  USE bounds_kernel_eqp_yl_module
  USE bounds_kernel_eqq_yl_module
  USE bounds_kernel_eqi_yl_module
  USE bounds_kernel_eqj_yl_module
  USE bounds_kernel_eqr_yl_module
  USE bounds_kernel_eqs_yl_module
  USE bounds_kernel_eqe_ydir_module
  USE bounds_kernel_eqg_ydir_module
  USE bounds_kernel_eqk_yl_module
  USE bounds_kernel_eqt_yl_module
  USE bounds_kernel_eql_yl_module
  USE bounds_kernel_equ_yl_module
  USE bounds_kernel_eqv_yl_module
  USE bounds_kernel_eqaf_yl_module
  USE bounds_kernel_eqag_ydir_module
  USE bounds_kernel_eqah_ydir_module
  USE bounds_kernel_eqm_yl_module
  USE bounds_kernel_eqw_yl_module
  USE bounds_kernel_eqx_yl_module
  USE bounds_kernel_eqn_yl_module
  USE bounds_kernel_eqo_yl_module
  USE bounds_kernel_eqy_yl_module
  USE bounds_kernel_eqz_yl_module
  USE bounds_kernel_eqh_yr_module
  USE bounds_kernel_eqp_yr_module
  USE bounds_kernel_eqq_yr_module
  USE bounds_kernel_eqi_yr_module
  USE bounds_kernel_eqj_yr_module
  USE bounds_kernel_eqr_yr_module
  USE bounds_kernel_eqs_yr_module
  USE bounds_kernel_eqk_yr_module
  USE bounds_kernel_eqt_yr_module
  USE bounds_kernel_eql_yr_module
  USE bounds_kernel_equ_yr_module
  USE bounds_kernel_eqv_yr_module
  USE bounds_kernel_eqaf_yr_module
  USE bounds_kernel_eqm_yr_module
  USE bounds_kernel_eqw_yr_module
  USE bounds_kernel_eqx_yr_module
  USE bounds_kernel_eqn_yr_module
  USE bounds_kernel_eqo_yr_module
  USE bounds_kernel_eqy_yr_module
  USE bounds_kernel_eqz_yr_module
  USE bounds_kernel_eqa_zdir_module
  USE bounds_kernel_eqb_zdir_module
  USE bounds_kernel_eqc_zdir_module
  USE bounds_kernel_eqaa_zdir_module
  USE copy_kernel_zzdir_module
  USE set_zero_kernel_zdir_module
  USE bounds_kernel_eqd_zdir_module
  USE bounds_kernel_eqf_zdir_module
  USE bounds_kernel_eqh_zl_module
  USE bounds_kernel_eqp_zl_module
  USE bounds_kernel_eqq_zl_module
  USE bounds_kernel_eqi_zl_module
  USE bounds_kernel_eqj_zl_module
  USE bounds_kernel_eqr_zl_module
  USE bounds_kernel_eqs_zl_module
  USE bounds_kernel_eqe_zdir_module
  USE bounds_kernel_eqg_zdir_module
  USE bounds_kernel_eqk_zl_module
  USE bounds_kernel_eqt_zl_module
  USE bounds_kernel_eql_zl_module
  USE bounds_kernel_equ_zl_module
  USE bounds_kernel_eqv_zl_module
  USE bounds_kernel_eqaf_zl_module
  USE bounds_kernel_eqag_zdir_module
  USE bounds_kernel_eqah_zdir_module
  USE bounds_kernel_eqm_zl_module
  USE bounds_kernel_eqw_zl_module
  USE bounds_kernel_eqx_zl_module
  USE bounds_kernel_eqn_zl_module
  USE bounds_kernel_eqo_zl_module
  USE bounds_kernel_eqy_zl_module
  USE bounds_kernel_eqz_zl_module
  USE bounds_kernel_eqh_zr_module
  USE bounds_kernel_eqp_zr_module
  USE bounds_kernel_eqq_zr_module
  USE bounds_kernel_eqi_zr_module
  USE bounds_kernel_eqj_zr_module
  USE bounds_kernel_eqr_zr_module
  USE bounds_kernel_eqs_zr_module
  USE bounds_kernel_eqk_zr_module
  USE bounds_kernel_eqt_zr_module
  USE bounds_kernel_eql_zr_module
  USE bounds_kernel_equ_zr_module
  USE bounds_kernel_eqv_zr_module
  USE bounds_kernel_eqaf_zr_module
  USE bounds_kernel_eqm_zr_module
  USE bounds_kernel_eqw_zr_module
  USE bounds_kernel_eqx_zr_module
  USE bounds_kernel_eqn_zr_module
  USE bounds_kernel_eqo_zr_module
  USE bounds_kernel_eqy_zr_module
  USE bounds_kernel_eqz_zr_module
  ...
  IF (fxlcnv) THEN
      ...
      CALL bounds_kernel_eqa_xdir_host("REDUCED SPECIES ENTHALPY", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(ispec, 1, "integer(kind=4)", OPS_READ))
    ...
    !       GAMMA-1, 1/(GAMMA-1)
    rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
    CALL bounds_kernel_eqb_xdir_host("REDUCED INTERNAL ENERGY", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strtxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    ...
    !       --------------
    rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
    CALL bounds_kernel_eqc_xdir_host("SPEED OF SOUND", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strtxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    ...
    rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
    CALL bounds_kernel_eqaa_xdir_host("SPEED OF SOUND", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_acouxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    ...
    rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
    CALL copy_kernel_xxdir_host("copy", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_t6bxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    END DO
      ...
      flag_pio_xl = nxlprm(1)
      ! 0
      flag_bet_xl = nxlprm(2)
      ! 1
...
ops_arg_dat(d_sorpxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqd_xdir_host("A_yz = A_yz + B_mulditim_yz*C_multidim_yz", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_ratexl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqf_xdir_host("A_yz = -A_yz*B_yz", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_gam1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))

      !           SPECIFY L5X AS REQUIRED
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqh_xl_host("OUTFLOW BC1 XL", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(flag_pio_xl, 1, "integer(kind=4)", OPS_READ))
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqp_xl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(flag_pio_xl, 1, "integer(kind=4)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqq_xl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_gam1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L2X-L5X
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqi_xl_host("L2X to L5X", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl5xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(pinfxl, 1, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqj_xl_host("LYX", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strdxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqr_xl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_ovgmxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqs_xl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strhxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_sorpxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqe_xdir_host("A_yz = A_yz + B_mulditim_yz*val1", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_ratexl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqg_xdir_host("A_yz = A_yz/B_yz", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_gam1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L1X,L2X,L5X
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqk_xl_host("L1X L2X L5X", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_sydtxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqt_xl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    ...
    END IF
      ...
      !           L1X-L5X
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eql_xl_host("L1X to L5X", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_dwdtxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_equ_xl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl3xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl4xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_acouxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqv_xl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_ratexl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_dydtxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_struxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    ...
    END IF
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL copy_kernel_xxdir_host("copy - BOUNDS 511", senga_grid, 3, rangexyz, &
ops_arg_dat(d_stluxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_struxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      CALL copy_kernel_xxdir_host("copy - BOUNDS 514", senga_grid, 3, rangexyz, &
ops_arg_dat(d_stlvxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_strvxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      CALL copy_kernel_xxdir_host("copy - BOUNDS 517", senga_grid, 3, rangexyz, &
ops_arg_dat(d_stlwxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_strwxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      CALL copy_kernel_xxdir_host("copy - BOUNDS 520", senga_grid, 3, rangexyz, &
ops_arg_dat(d_stltxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_strtxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      DO ispec = 1, nspec
        CALL copy_kernel_xxdir_host("copy - BOUNDS 524", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_stryxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqab_xdir_host("bounds_kernel_eqAB_xdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl5xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(m2max, 1, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqac_xdir_host("bounds_kernel_eqAC_xdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bclyxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(nrieta6, 1, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqad_xdir_host("bounds_kernel_eqAD_xdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_strexl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqae_xdir_host("bounds_kernel_eqAE_xdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_stlyxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_sorpxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE))
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      DO ispec = 1, nspec
        CALL bounds_kernel_eqag_xdir_host("bounds_kernel_eqAG_xdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strhxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ratexl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      END DO
      ...
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqah_xdir_host("bounds_kernel_eqAH_xdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpxl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_gam1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L1X-L5X
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqm_xl_host("bounds_kernel_eqM_xl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_bclyxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqw_xl_host("bounds_kernel_eqW_xl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_ova2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqx_xl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L1X-L5X
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqn_xl_host("bounds_kernel_eqN_xl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_ova2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqo_xl_host("bounds_kernel_eqO_xl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bclyxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqy_xl_host("bounds_kernel_eqY_xl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, 1, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqz_xl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryxl(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5xl, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_t6bxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    END DO
      ...
      flag_pio_xr = nxrprm(1)
      ! 0
      flag_bet_xr = nxrprm(2)
      ! 1
...
ops_arg_dat(d_gam1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqh_xr_host("OUTFLOW BC1 XR", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(flag_pio_xr, 1, "integer(kind=4)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqp_xr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_gbl(flag_pio_xr, 1, "integer(kind=4)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqq_xr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strdxr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_struxr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L1X-L4X
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqi_xr_host("L1X-L4X", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(pinfxr, 1, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqj_xr_host("LYX", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strdxr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqr_xr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_ovgmxr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqs_xr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strhxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L1X,L2X,L5X
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqk_xr_host("L1X L2X L5X", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_sydtxr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqt_xr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
    ...
    END IF
      ...
      !           L1X-L5X
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eql_xr_host("L1X to L5X", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_dwdtxr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_equ_xr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl3xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_acouxr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqv_xr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_ratexr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_dydtxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L1X,L3X-L5X
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqm_xr_host("bounds_kernel_eqM_xr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_bclyxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqw_xr_host("bounds_kernel_eqW_xr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
...
ops_arg_dat(d_ova2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqx_xr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
      ...
      !           L1X-L5X
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqn_xr_host("bounds_kernel_eqN_xr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_ova2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqo_xr_host("bounds_kernel_eqO_xr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bclyxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqy_xr_host("bounds_kernel_eqY_xr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [nxglbl, nxglbl, 1, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqz_xr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryxr(ispec), 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2xr, 1, s3d_000_strid3d_yz, "real(kind=8)", OPS_READ))
  ...
  !   X-DIRECTION RIGHT-HAND END
    ...
    IF (fylcnv) THEN
      ...
      CALL bounds_kernel_eqa_ydir_host("REDUCED SPECIES ENTHALPY", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(ispec, 1, "integer(kind=4)", OPS_READ))
    ...
    !       GAMMA-1, 1/(GAMMA-1)
    rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
    CALL bounds_kernel_eqb_ydir_host("REDUCED INTERNAL ENERGY", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strtyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
    ...
    !       --------------
    rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
    CALL bounds_kernel_eqc_ydir_host("SPEED OF SOUND", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strtyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
    ...
    rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
    CALL bounds_kernel_eqaa_ydir_host("SPEED OF SOUND", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_acouyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
    ...
    rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
    CALL copy_kernel_yydir_host("copy", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_t6byl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
    END DO
      ...
      flag_pio_yl = nylprm(1)
      ! 0
      flag_bet_yl = nylprm(2)
      ! 1
...
ops_arg_dat(d_sorpyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqd_ydir_host("A_xz = A_xz + B_mulditim_xz*C_multidim_xz", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_rateyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqf_ydir_host("A_xz = -A_xz*B_xz", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_gam1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))

      !           SPECIFY L5Y AS REQUIRED
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqh_yl_host("OUTFLOW BC1 YL", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(flag_pio_yl, 1, "integer(kind=4)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqp_yl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_gbl(flag_pio_yl, 1, "integer(kind=4)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqq_yl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strdyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strvyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L2Y-L5Y
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqi_yl_host("L2Y to L5Y", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl5yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(pinfyl, 1, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqj_yl_host("LYY", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strdyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqr_yl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_ovgmyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqs_yl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strhyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_sorpyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqe_ydir_host("A_xz = A_xz + B_mulditim_xz*val1", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_rateyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqg_ydir_host("A_xz = A_xz/B_xz", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_gam1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L1Y,L2Y,L5Y
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqk_yl_host("L1Y L2Y L5Y", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_sydtyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqt_yl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
    ...
    END IF
      ...
      !           L1Y-L5Y
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eql_yl_host("L1Y to L5Y", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_dwdtyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_equ_yl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl3yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl4yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_acouyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqv_yl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_rateyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_dydtyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_sorpyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_WRITE))
      ...
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      DO ispec = 1, nspec
        CALL bounds_kernel_eqag_ydir_host("bounds_kernel_eqAG_ydir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strhyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_rateyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      END DO
      ...
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqah_ydir_host("bounds_kernel_eqAH_ydir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpyl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_gam1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L1Y,L3Y-L5Y
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqm_yl_host("bounds_kernel_eqM_yl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_bclyyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqw_yl_host("bounds_kernel_eqW_yl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
...
ops_arg_dat(d_ova2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqx_yl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L1Y-L5Y
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqn_yl_host("bounds_kernel_eqN_yl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_ova2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqo_yl_host("bounds_kernel_eqO_yl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bclyyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
      CALL bounds_kernel_eqy_yl_host("bounds_kernel_eqY_yl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, 1, 1, nzglbl]
        CALL bounds_kernel_eqz_yl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryyl(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5yl, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_t6byr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
    END DO
      ...
      flag_pio_yr = nyrprm(1)
      ! 0
      flag_bet_yr = nyrprm(2)
      ! 1
...
ops_arg_dat(d_gam1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqh_yr_host("OUTFLOW BC1 YR", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(flag_pio_yr, 1, "integer(kind=4)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqp_yr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_gbl(flag_pio_yr, 1, "integer(kind=4)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqq_yr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strdyr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strvyr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L1Y-L4Y
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqi_yr_host("L1Y-L4Y", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(pinfyr, 1, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqj_yr_host("LYY", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strdyr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqr_yr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_ovgmyr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqs_yr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strhyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L1Y,L2Y,L5Y
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqk_yr_host("L1Y L2Y L5Y", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_sydtyr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqt_yr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
    ...
    END IF
      ...
      !           L1Y-L5Y
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eql_yr_host("L1Y to L5Y", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_dwdtyr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_equ_yr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl3yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_acouyr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqv_yr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_rateyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_dydtyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L1Y,L3Y-L5Y
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqm_yr_host("bounds_kernel_eqM_yr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_bclyyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqw_yr_host("bounds_kernel_eqW_yr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
...
ops_arg_dat(d_ova2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqx_yr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
      ...
      !           L1Y-L5Y
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqn_yr_host("bounds_kernel_eqN_yr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_ova2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqo_yr_host("bounds_kernel_eqO_yr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bclyyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
      CALL bounds_kernel_eqy_yr_host("bounds_kernel_eqY_yr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, nyglbl, nyglbl, 1, nzglbl]
        CALL bounds_kernel_eqz_yr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryyr(ispec), 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2yr, 1, s3d_000_strid3d_xz, "real(kind=8)", OPS_READ))
  ...
  !   Y-DIRECTION RIGHT-HAND END
    ...
    IF (fzlcnv) THEN
      ...
      CALL bounds_kernel_eqa_zdir_host("REDUCED SPECIES ENTHALPY", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(ispec, 1, "integer(kind=4)", OPS_READ))
    ...
    !       GAMMA-1, 1/(GAMMA-1)
    rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
    CALL bounds_kernel_eqb_zdir_host("REDUCED INTERNAL ENERGY", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strtzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
    ...
    !       --------------
    rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
    CALL bounds_kernel_eqc_zdir_host("SPEED OF SOUND", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strtzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
    ...
    rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
    CALL bounds_kernel_eqaa_zdir_host("SPEED OF SOUND", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_acouzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
    ...
    rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
    CALL copy_kernel_zzdir_host("copy", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_t6bzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
    END DO
      ...
      flag_pio_zl = nzlprm(1)
      ! 0
      flag_bet_zl = nzlprm(2)
      ! 1
...
ops_arg_dat(d_sorpzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqd_zdir_host("A_xy = A_xy + B_mulditim_xy*C_multidim_xy", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_ratezl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqf_zdir_host("A_xy = -A_xy*B_xy", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_gam1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))

      !           SPECIFY L5Z AS REQUIRED
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqh_zl_host("OUTFLOW BC1 ZL", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(flag_pio_zl, 1, "integer(kind=4)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqp_zl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_gbl(flag_pio_zl, 1, "integer(kind=4)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqq_zl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strdzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strwzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L2Z-L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqi_zl_host("L2Z to L5Z", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl5zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(pinfzl, 1, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqj_zl_host("LYZ", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strdzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqr_zl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_ovgmzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqs_zl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strhzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_sorpzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqe_zdir_host("A_xy = A_xy + B_mulditim_xy*val1", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_ratezl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqg_zdir_host("A_xy = A_xy/B_xy", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_gam1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L1Z,L2Z,L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqk_zl_host("L1Z L2Z L5Z", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_sydtzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqt_zl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
    ...
    END IF
      ...
      !           L1Z-L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eql_zl_host("L1Z to L5Z", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_dwdtzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_equ_zl_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl3zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl4zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_acouzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqv_zl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_ratezl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_dydtzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_sorpzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_WRITE))
      ...
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      DO ispec = 1, nspec
        CALL bounds_kernel_eqag_zdir_host("bounds_kernel_eqAG_zdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strhzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ratezl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      END DO
      ...
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqah_zdir_host("bounds_kernel_eqAH_zdir", senga_grid, 3, rangexyz, &
ops_arg_dat(d_sorpzl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_gam1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L1Z,L3Z-L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqm_zl_host("bounds_kernel_eqM_zl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_bclyzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqw_zl_host("bounds_kernel_eqW_zl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
...
ops_arg_dat(d_ova2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqx_zl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L1Z-L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqn_zl_host("bounds_kernel_eqN_zl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_ova2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqo_zl_host("bounds_kernel_eqO_zl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bclyzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
      CALL bounds_kernel_eqy_zl_host("bounds_kernel_eqY_zl", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, 1, 1]
        CALL bounds_kernel_eqz_zl_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryzl(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl5zl, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_t6bzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
    END DO
      ...
      flag_pio_zr = nzrprm(1)
      ! 0
      flag_bet_zr = nzrprm(2)
      ! 1
...
ops_arg_dat(d_gam1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqh_zr_host("OUTFLOW BC1 ZR", senga_grid, 3, rangexyz, &
...
ops_arg_gbl(flag_pio_zr, 1, "integer(kind=4)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqp_zr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_gbl(flag_pio_zr, 1, "integer(kind=4)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
        CALL bounds_kernel_eqq_zr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_strdzr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strwzr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L1Z-L4Z
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqi_zr_host("L1Z-L4Z", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_gbl(pinfzr, 1, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
        CALL bounds_kernel_eqj_zr_host("LYZ", senga_grid, 3, rangexyz, &
...
ops_arg_dat(d_strdzr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqr_zr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
...
ops_arg_dat(d_ovgmzr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
        CALL bounds_kernel_eqs_zr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_strhzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L1Z,L2Z,L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqk_zr_host("L1Z L2Z L5Z", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_sydtzr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqt_zr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
    ...
    END IF
      ...
      !           L1Z-L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eql_zr_host("L1Z to L5Z", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_dwdtzr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_equ_zr_host("ADD TO CONSERVATIVE SOURCE TERMS", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl3zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_acouzr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
        CALL bounds_kernel_eqv_zr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bclyzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_ratezr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_dydtzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L1Z,L3Z-L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqm_zr_host("bounds_kernel_eqM_zr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_bclyzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqw_zr_host("bounds_kernel_eqW_zr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_urhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_vrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
ops_arg_dat(d_wrhs, 1, s3d_000, "real(kind=8)", OPS_WRITE), &
...
ops_arg_dat(d_ova2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
        CALL bounds_kernel_eqx_zr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_gam1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
      ...
      !           L1Z-L5Z
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqn_zr_host("bounds_kernel_eqN_zr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl3zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
ops_arg_dat(d_bcl4zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_RW), &
...
ops_arg_dat(d_ova2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
        CALL bounds_kernel_eqo_zr_host("bounds_kernel_eqO_zr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_bclyzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_WRITE))
      ...
      !           ADD TO CONSERVATIVE SOURCE TERMS
      rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
      CALL bounds_kernel_eqy_zr_host("bounds_kernel_eqY_zr", senga_grid, 3, rangexyz, &
ops_arg_dat(d_drhs, 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_ova2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
...
ops_arg_dat(d_erhs, 1, s3d_000, "real(kind=8)", OPS_WRITE))
        ...
        DO ispec = 1, nspec
        rangexyz = [1, nxglbl, 1, nyglbl, nzglbl, nzglbl]
        CALL bounds_kernel_eqz_zr_host("EVALUATE ALL SPECIES", senga_grid, 3, rangexyz, &
ops_arg_dat(d_yrhs(ispec), 1, s3d_000, "real(kind=8)", OPS_INC), &
ops_arg_dat(d_stryzr(ispec), 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl1zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
ops_arg_dat(d_bcl2zr, 1, s3d_000_strid3d_xy, "real(kind=8)", OPS_READ), &
