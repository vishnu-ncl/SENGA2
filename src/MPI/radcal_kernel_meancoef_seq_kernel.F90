...
SUBROUTINE radcal_kernel_meancoef(store2,trun,akprad,nkprad,nkprm1,jspec)
    ...
    integer, dimension(nspcmx), intent(in) :: nkprad, nkprm1
...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 508, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(radcal_kernel_meancoef_host_execute))
end subroutine
#endif
