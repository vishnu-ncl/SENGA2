...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 289, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundary_kernel_velderiv_zdir_host_execute))
end subroutine
#endif
