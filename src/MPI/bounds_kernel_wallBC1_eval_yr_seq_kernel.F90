...
SUBROUTINE bounds_kernel_wallBC1_eval_yr(yrhs,stryyr,bcl1yr,ova2yr)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 413, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC1_eval_yr_host_execute))
