...
SUBROUTINE bounds_kernel_outflowBC1_eval_zl(yrhs,stryzl,bcl5zl,ova2zl)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 425, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_outflowBC1_eval_zl_host_execute))
