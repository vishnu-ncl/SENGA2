...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 61, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdxy_kernel_rh_ydir_corner_eqC_host_execute))
end subroutine
#endif
