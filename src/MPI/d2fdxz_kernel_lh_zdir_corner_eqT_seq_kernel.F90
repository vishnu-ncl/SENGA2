...
subroutine d2fdxz_kernel_lh_zdir_corner_eqT_host_execute( descPtr )
  ...
  call setKernelTime(112,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(112,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 112, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdxz_kernel_lh_zdir_corner_eqT_host_execute))
end subroutine
#endif
