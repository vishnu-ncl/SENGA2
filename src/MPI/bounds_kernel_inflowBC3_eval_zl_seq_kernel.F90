...
SUBROUTINE bounds_kernel_inflowBC3_eval_zl(erhs,bclyzl,ratezl,dydtzl,strhzl,strdzl,strwzl)
    use data_types
    implicit none
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 436, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC3_eval_zl_host_execute))
