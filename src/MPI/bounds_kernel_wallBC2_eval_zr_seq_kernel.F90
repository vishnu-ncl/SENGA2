...
SUBROUTINE bounds_kernel_wallBC2_eval_zr(yrhs,stryzr,bcl1zr,bcl2zr,ova2zr)
    use data_types
    implicit none
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 462, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_eval_zr_host_execute))
