...
& opsArg9)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 9, 272, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqBJ_host_execute))
