...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 316, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(adaptt_kernel_err_eval_host_execute))
end subroutine
#endif
