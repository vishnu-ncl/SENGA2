...
!  Set from kernel descriptor
  ...
  call setKernelTime(308,userSubroutine,0.0_8,0.0_8,0.0_4,1)
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 308, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(adaptt_kernel_err_eval_host_execute))
