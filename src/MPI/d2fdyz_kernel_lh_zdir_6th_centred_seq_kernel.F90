...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 152, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdyz_kernel_lh_zdir_6th_centred_host_execute))
end subroutine
#endif
