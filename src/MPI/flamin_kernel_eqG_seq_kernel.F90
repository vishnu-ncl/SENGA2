...
!
MODULE FLAMIN_KERNEL_EQG_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: flamin_kernel_eqG
...
subroutine flamin_kernel_eqG_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& dat1_base, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine flamin_kernel_eqG_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3)
  IMPLICIT NONE
...
#else
subroutine flamin_kernel_eqG_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg3)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 3, 518, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(flamin_kernel_eqG_host_execute))
end subroutine
#endif
