...
!  Set from kernel descriptor
  ...
  call setKernelTime(515,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call setKernelTime(515,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 515, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqF_host_execute))
