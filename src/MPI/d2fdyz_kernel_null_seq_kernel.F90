...
& opsArg1)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 1, 137, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdyz_kernel_null_host_execute))
end subroutine
#endif
