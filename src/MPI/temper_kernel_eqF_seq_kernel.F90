...
!  Set from kernel descriptor
  ...
  call setKernelTime(531,userSubroutine,0.0_8,0.0_8,0.0_4,1)
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 531, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(temper_kernel_eqF_host_execute))
