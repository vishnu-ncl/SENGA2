...
!
MODULE BOUNDS_KERNEL_WALLBC2_LYZ_ZL_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: bounds_kernel_wallBC2_LYZ_zl
...
SUBROUTINE bounds_kernel_wallBC2_LYZ_zl(bclyzl,bcl2zl,ratezl,strwzl,strdzl,strrzl,rgspec,ispec)
    ...
    bcl2zl(OPS_ACC2(0,0,0)) = bcl2zl(OPS_ACC2(0,0,0)) + (ratezl(OPS_ACC_MD3(ispec,0,0,0))  &
              - strdzl(OPS_ACC5(0,0,0))*bclyzl(OPS_ACC_MD1(ispec,0,0,0))) *rgspec(ispec)/strrzl(OPS_ACC6(0,0,0))
...
subroutine bounds_kernel_wallBC2_LYZ_zl_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
  ...
  DO n_z = 1, end(3)-start(3)+1
    DO n_y = 1, end(2)-start(2)+1
      ...
      DO n_x = 1, end(1)-start(1)+1
        call bounds_kernel_wallBC2_LYZ_zl( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine bounds_kernel_wallBC2_LYZ_zl_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine bounds_kernel_wallBC2_LYZ_zl_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
  ...
  call bounds_kernel_wallBC2_LYZ_zl_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & opsDat3Local, &
  & opsDat4Local, &
...
& opsArg8)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 8, 449, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_LYZ_zl_host_execute))
end subroutine
#endif
