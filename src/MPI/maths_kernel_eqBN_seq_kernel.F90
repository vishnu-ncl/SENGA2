...
!  Set from kernel descriptor
  ...
  call setKernelTime(513,userSubroutine,0.0_8,0.0_8,0.0_4,1)
...
& opsArg15)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 15, 513, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqBN_host_execute))
