...
MODULE D2FDYZ_KERNEL_RH_ZDIR_CORNER_EQB_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: d2fdyz_kernel_rh_zdir_corner_eqB
...
subroutine d2fdyz_kernel_rh_zdir_corner_eqB_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& dat1_base, &
& dat2_base, &
  ...
  DO n_z = 1, end_indx(3)-start_indx(3)+1
    DO n_y = 1, end_indx(2)-start_indx(2)+1
      ...
      DO n_x = 1, end_indx(1)-start_indx(1)+1
        ...
        call d2fdyz_kernel_rh_zdir_corner_eqB( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine d2fdyz_kernel_rh_zdir_corner_eqB_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2)
...
#else
subroutine d2fdyz_kernel_rh_zdir_corner_eqB_host_execute( descPtr )
...
!  Set from kernel descriptor
  ...
  call setKernelTime(174,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call d2fdyz_kernel_rh_zdir_corner_eqB_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & dat1_base, &
  & dat2_base, &
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(174,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 174, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdyz_kernel_rh_zdir_corner_eqB_host_execute))
