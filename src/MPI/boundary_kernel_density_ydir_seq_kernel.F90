...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 280, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundary_kernel_density_ydir_host_execute))
end subroutine
#endif
