...
!  Set from kernel descriptor
  ...
  call setKernelTime(276,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(276,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 276, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundary_kernel_density_ydir_host_execute))
