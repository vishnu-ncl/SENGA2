...
!
MODULE HEAT_FLUX_KERNEL_ENTHALPY_FZRDFW_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: heat_flux_kernel_enthalpy_fzrdfw
...
subroutine heat_flux_kernel_enthalpy_fzrdfw_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
  ...
  DO n_z = 1, end(3)-start(3)+1
    DO n_y = 1, end(2)-start(2)+1
      ...
      DO n_x = 1, end(1)-start(1)+1
        call heat_flux_kernel_enthalpy_fzrdfw( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine heat_flux_kernel_enthalpy_fzrdfw_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine heat_flux_kernel_enthalpy_fzrdfw_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
  ...
  call heat_flux_kernel_enthalpy_fzrdfw_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & opsDat3Local, &
  & opsDat4Local, &
...
& opsArg11)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 11, 263, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(heat_flux_kernel_enthalpy_fzrdfw_host_execute))
end subroutine
#endif
