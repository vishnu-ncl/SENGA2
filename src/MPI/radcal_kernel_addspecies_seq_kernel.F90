...
SUBROUTINE radcal_kernel_addspecies(store1,yrhs,trun,store2,rgspec,ispec)
    ...
    fornow = yrhs(OPS_ACC_MD2(ispec,0,0,0))*rgspec(ispec)*trun(OPS_ACC3(0,0,0))
...
subroutine radcal_kernel_addspecies_host_execute( descPtr )
  ...
  call setKernelTime(509,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(509,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 509, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(radcal_kernel_addspecies_host_execute))
end subroutine
#endif
