...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 501, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(radcal_kernel_addspecies_host_execute))
