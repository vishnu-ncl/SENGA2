...
!
MODULE MATH_MD_KERNEL_EQR_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: math_MD_kernel_eqR
...
subroutine math_MD_kernel_eqR_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine math_MD_kernel_eqR_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4)
...
#else
subroutine math_MD_kernel_eqR_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 524, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(math_MD_kernel_eqR_host_execute))
end subroutine
#endif
