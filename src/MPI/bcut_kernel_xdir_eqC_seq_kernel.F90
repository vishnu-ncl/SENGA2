...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 328, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bcut_kernel_xdir_eqC_host_execute))
end subroutine
#endif
