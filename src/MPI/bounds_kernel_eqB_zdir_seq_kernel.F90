...
SUBROUTINE bounds_kernel_eqB_zdir(sydtz,dydtz,rgspec,ispec)
    ...
    sydtz(OPS_ACC1(0,0,0)) = sydtz(OPS_ACC1(0,0,0)) + dydtz(OPS_ACC_MD2(ispec,0,0,0))*rgspec(ispec)
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 438, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_eqB_zdir_host_execute))
end subroutine
#endif
