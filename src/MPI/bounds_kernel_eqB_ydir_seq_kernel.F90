...
SUBROUTINE bounds_kernel_eqB_ydir(sydty,dydty,rgspec,ispec)
    ...
    sydty(OPS_ACC1(0,0,0)) = sydty(OPS_ACC1(0,0,0)) + dydty(OPS_ACC_MD2(ispec,0,0,0))*rgspec(ispec)
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 393, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_eqB_ydir_host_execute))
end subroutine
#endif
