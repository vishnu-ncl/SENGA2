...
& opsArg8)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 8, 240, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqAI_host_execute))
