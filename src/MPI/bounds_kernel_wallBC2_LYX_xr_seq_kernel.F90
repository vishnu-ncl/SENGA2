...
!
MODULE BOUNDS_KERNEL_WALLBC2_LYX_XR_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: bounds_kernel_wallBC2_LYX_xr
...
SUBROUTINE bounds_kernel_wallBC2_LYX_xr(bclyxr,bcl2xr,ratexr,struxr,strdxr,strrxr,rgspec,ispec)
    ...
    bcl2xr(OPS_ACC2(0,0,0)) = bcl2xr(OPS_ACC2(0,0,0)) + (ratexr(OPS_ACC_MD3(ispec,0,0,0))  &
              - strdxr(OPS_ACC5(0,0,0))*bclyxr(OPS_ACC_MD1(ispec,0,0,0))) *rgspec(ispec)/strrxr(OPS_ACC6(0,0,0))
...
subroutine bounds_kernel_wallBC2_LYX_xr_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
  ...
  DO n_z = 1, end(3)-start(3)+1
    DO n_y = 1, end(2)-start(2)+1
      ...
      DO n_x = 1, end(1)-start(1)+1
        call bounds_kernel_wallBC2_LYX_xr( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine bounds_kernel_wallBC2_LYX_xr_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine bounds_kernel_wallBC2_LYX_xr_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
  ...
  call setKernelTime(378,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call bounds_kernel_wallBC2_LYX_xr_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & opsDat3Local, &
  & opsDat4Local, &
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(378,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg8)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 8, 378, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_LYX_xr_host_execute))
end subroutine
#endif
