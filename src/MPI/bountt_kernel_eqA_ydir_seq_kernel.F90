...
& opsArg13)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 13, 472, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bountt_kernel_eqA_ydir_host_execute))
