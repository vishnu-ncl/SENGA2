...
!
MODULE BOUNDS_KERNEL_INFLOWBC3_COMPUTEL_ZR_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: bounds_kernel_inflowBC3_computeL_zr
...
subroutine bounds_kernel_inflowBC3_computeL_zr_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
  ...
  DO n_z = 1, end(3)-start(3)+1
    DO n_y = 1, end(2)-start(2)+1
      ...
      DO n_x = 1, end(1)-start(1)+1
        call bounds_kernel_inflowBC3_computeL_zr( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine bounds_kernel_inflowBC3_computeL_zr_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine bounds_kernel_inflowBC3_computeL_zr_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
  ...
  call setKernelTime(461,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call bounds_kernel_inflowBC3_computeL_zr_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & opsDat3Local, &
  & opsDat4Local, &
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(461,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg13)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 13, 461, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC3_computeL_zr_host_execute))
end subroutine
#endif
