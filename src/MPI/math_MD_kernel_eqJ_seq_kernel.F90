...
!
MODULE MATH_MD_KERNEL_EQJ_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: math_MD_kernel_eqJ
...
subroutine math_MD_kernel_eqJ_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine math_MD_kernel_eqJ_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine math_MD_kernel_eqJ_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg8)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 8, 233, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(math_MD_kernel_eqJ_host_execute))
end subroutine
#endif
