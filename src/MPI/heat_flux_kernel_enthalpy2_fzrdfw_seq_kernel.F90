...
SUBROUTINE heat_flux_kernel_enthalpy2_fzrdfw(rate,erhs,vtmp,utmp,store7,arr1,acbczr)
    use data_types
    implicit none
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 246, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(heat_flux_kernel_enthalpy2_fzrdfw_host_execute))
