...
MODULE HEAT_FLUX_KERNEL_SORET_FZLCNW_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: heat_flux_kernel_soret_fzlcnw


SUBROUTINE heat_flux_kernel_soret_fzlcnw(erhs,trun,tdrmix,store7,td1z,acbczl,rgspec,ispec)
    use data_types
    implicit none
...
subroutine heat_flux_kernel_soret_fzlcnw_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
  ...
  DO n_z = 1, end_indx(3)-start_indx(3)+1
    DO n_y = 1, end_indx(2)-start_indx(2)+1
      ...
      DO n_x = 1, end_indx(1)-start_indx(1)+1
        ...
        call heat_flux_kernel_soret_fzlcnw( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine heat_flux_kernel_soret_fzlcnw_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine heat_flux_kernel_soret_fzlcnw_host_execute( descPtr )
...
!  Set from kernel descriptor
  ...
  call setKernelTime(262,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call heat_flux_kernel_soret_fzlcnw_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & opsDat3Local, &
  & opsDat4Local, &
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(262,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg8)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 8, 262, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(heat_flux_kernel_soret_fzlcnw_host_execute))
