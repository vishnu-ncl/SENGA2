...
SUBROUTINE bounds_kernel_wallBC2_eval_xr(yrhs,stryxr,bcl1xr,bcl2xr,ova2xr)
    use data_types
    implicit none
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 372, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_eval_xr_host_execute))
