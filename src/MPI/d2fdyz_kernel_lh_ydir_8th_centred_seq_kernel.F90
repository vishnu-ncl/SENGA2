...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 143, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdyz_kernel_lh_ydir_8th_centred_host_execute))
end subroutine
#endif
