...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 250, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqY_host_execute))
