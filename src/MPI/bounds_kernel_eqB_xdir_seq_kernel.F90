...
SUBROUTINE bounds_kernel_eqB_xdir(sydtx,dydtx,rgspec,ispec)
    ...
    sydtx(OPS_ACC1(0,0,0)) = sydtx(OPS_ACC1(0,0,0)) + dydtx(OPS_ACC_MD2(ispec,0,0,0))*rgspec(ispec)
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 348, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_eqB_xdir_host_execute))
end subroutine
#endif
