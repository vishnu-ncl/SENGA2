...
& opsArg3)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 3, 467, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bountt_kernel_eqD_host_execute))
