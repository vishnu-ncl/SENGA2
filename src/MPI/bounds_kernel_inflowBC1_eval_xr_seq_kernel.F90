...
SUBROUTINE bounds_kernel_inflowBC1_eval_xr(erhs,yrhs,bclyxr,strhxr,stryxr,strdxr,bcl2xr,bcl1xr,ova2xr)
    use data_types
    implicit none
...
!  Set from kernel descriptor
  ...
  call setKernelTime(360,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(360,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg9)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 9, 360, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC1_eval_xr_host_execute))
