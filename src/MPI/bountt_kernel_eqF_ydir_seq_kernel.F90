...
& opsArg16)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 16, 474, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bountt_kernel_eqF_ydir_host_execute))
