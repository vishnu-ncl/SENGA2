...
!  Set from kernel descriptor
  ...
  call setKernelTime(316,userSubroutine,0.0_8,0.0_8,0.0_4,1)
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 316, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bcut_kernel_xdir_const_uvel_host_execute))
