...
SUBROUTINE bounds_kernel_inflowBC3_eval_zr(erhs,bclyzr,ratezr,dydtzr,strhzr,strdzr,strwzr)
    use data_types
    implicit none
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 455, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC3_eval_zr_host_execute))
