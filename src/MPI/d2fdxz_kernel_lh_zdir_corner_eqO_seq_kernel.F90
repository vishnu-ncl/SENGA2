...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 107, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdxz_kernel_lh_zdir_corner_eqO_host_execute))
end subroutine
#endif
