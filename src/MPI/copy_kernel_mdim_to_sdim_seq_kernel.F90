...
& opsArg3)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 3, 534, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(copy_kernel_mdim_to_sdim_host_execute))
