...
SUBROUTINE bounds_kernel_inflowBC3_eval_yl(erhs,bclyyl,rateyl,dydtyl,strhyl,strdyl,strvyl)
    use data_types
    implicit none
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 391, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC3_eval_yl_host_execute))
