...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 512, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(flamin_kernel_eqA_host_execute))
end subroutine
#endif
