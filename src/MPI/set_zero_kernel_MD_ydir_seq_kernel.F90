...
!
MODULE SET_ZERO_KERNEL_MD_YDIR_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: set_zero_kernel_MD_ydir
...
subroutine set_zero_kernel_MD_ydir_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& dat1_base, &
& dat2_base, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine set_zero_kernel_MD_ydir_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2)
  IMPLICIT NONE
...
#else
subroutine set_zero_kernel_MD_ydir_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
  ...
  call setKernelTime(7,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call set_zero_kernel_MD_ydir_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & dat1_base, &
  & dat2_base, &
  ...
  call setKernelTime(7,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 7, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(set_zero_kernel_MD_ydir_host_execute))
end subroutine
#endif
