...
SUBROUTINE bounds_kernel_wallBC2_eval_yr(yrhs,stryyr,bcl1yr,bcl2yr,ova2yr)
    use data_types
    implicit none
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 417, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_eval_yr_host_execute))
