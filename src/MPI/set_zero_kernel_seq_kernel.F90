...
!  Set from kernel descriptor
  ...
  call setKernelTime(0,userSubroutine,0.0_8,0.0_8,0.0_4,1)
...
& opsArg1)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 1, 0, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(set_zero_kernel_host_execute))
