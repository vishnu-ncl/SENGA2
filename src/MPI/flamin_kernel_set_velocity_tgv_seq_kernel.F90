...
!  Set from kernel descriptor
  ...
  call setKernelTime(503,userSubroutine,0.0_8,0.0_8,0.0_4,1)
...
& opsArg14)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 14, 503, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(flamin_kernel_set_velocity_tgv_host_execute))
