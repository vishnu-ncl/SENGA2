...
!
MODULE MATH_KERNEL_EQAG_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: math_kernel_eqAG
...
subroutine math_kernel_eqAG_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine math_kernel_eqAG_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine math_kernel_eqAG_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 298, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(math_kernel_eqAG_host_execute))
end subroutine
#endif
