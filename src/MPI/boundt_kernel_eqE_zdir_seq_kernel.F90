...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 478, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundt_kernel_eqE_zdir_host_execute))
