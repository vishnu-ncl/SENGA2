...
subroutine heat_flux_kernel_isothermal_fxradw_host_execute( descPtr )
  ...
  call setKernelTime(271,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(271,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg8)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 8, 271, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(heat_flux_kernel_isothermal_fxradw_host_execute))
end subroutine
#endif
