...
& opsArg3)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 3, 323, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bcdt_kernel_zdir_eqA_host_execute))
end subroutine
#endif
