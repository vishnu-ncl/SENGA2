...
& opsArg14)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 14, 492, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundt_kernel_eqF_ydir_host_execute))
