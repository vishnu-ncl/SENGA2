...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 484, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bountt_kernel_eqE_ydir_host_execute))
end subroutine
#endif
