...
& opsArg19)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 19, 509, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqAY_host_execute))
