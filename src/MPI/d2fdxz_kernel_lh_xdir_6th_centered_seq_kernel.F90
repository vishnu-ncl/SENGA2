...
MODULE D2FDXZ_KERNEL_LH_XDIR_6TH_CENTERED_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: d2fdxz_kernel_lh_xdir_6th_centered
...
subroutine d2fdxz_kernel_lh_xdir_6th_centered_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& dat1_base, &
& dat2_base, &
  ...
  DO n_z = 1, end_indx(3)-start_indx(3)+1
    DO n_y = 1, end_indx(2)-start_indx(2)+1
      ...
      DO n_x = 1, end_indx(1)-start_indx(1)+1
        ...
        call d2fdxz_kernel_lh_xdir_6th_centered( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine d2fdxz_kernel_lh_xdir_6th_centered_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2)
...
#else
subroutine d2fdxz_kernel_lh_xdir_6th_centered_host_execute( descPtr )
...
!  Set from kernel descriptor
  ...
  call setKernelTime(79,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call d2fdxz_kernel_lh_xdir_6th_centered_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & dat1_base, &
  & dat2_base, &
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(79,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 79, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdxz_kernel_lh_xdir_6th_centered_host_execute))
