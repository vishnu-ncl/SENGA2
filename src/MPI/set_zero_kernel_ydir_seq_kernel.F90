...
!  Set from kernel descriptor
  ...
  call setKernelTime(2,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call setKernelTime(2,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg1)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 1, 2, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(set_zero_kernel_ydir_host_execute))
