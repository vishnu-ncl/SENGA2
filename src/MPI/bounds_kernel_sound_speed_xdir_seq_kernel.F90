...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 338, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_sound_speed_xdir_host_execute))
end subroutine
#endif
