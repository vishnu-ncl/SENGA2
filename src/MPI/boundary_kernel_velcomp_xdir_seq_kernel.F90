...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 283, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundary_kernel_velcomp_xdir_host_execute))
end subroutine
#endif
