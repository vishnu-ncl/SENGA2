...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 216, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(heat_flux_kernel_thermal_fyrcnw_host_execute))
end subroutine
#endif
