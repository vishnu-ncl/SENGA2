...
& opsArg8)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 8, 267, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(heat_flux_kernel_soret_fyrcnw_host_execute))
end subroutine
#endif
