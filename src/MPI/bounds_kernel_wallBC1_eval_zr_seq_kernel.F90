...
SUBROUTINE bounds_kernel_wallBC1_eval_zr(yrhs,stryzr,bcl1zr,ova2zr)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 458, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC1_eval_zr_host_execute))
