...
SUBROUTINE bounds_kernel_wallBC2_eval_zl(yrhs,stryzl,bcl2zl,bcl5zl,ova2zl)
    use data_types
    implicit none
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 443, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_eval_zl_host_execute))
