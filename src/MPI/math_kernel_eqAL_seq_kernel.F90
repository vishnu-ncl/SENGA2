...
!
MODULE MATH_KERNEL_EQAL_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: math_kernel_eqAL
...
subroutine math_kernel_eqAL_wrap( &
& opsDat1Local, &
& dat1_base, &
& start, &
& end )
...
!host subroutine
#ifndef OPS_LAZY
subroutine math_kernel_eqAL_host( userSubroutine, block, dim, range, &
& opsArg1)
  IMPLICIT NONE
...
#else
subroutine math_kernel_eqAL_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg1)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 1, 527, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(math_kernel_eqAL_host_execute))
end subroutine
#endif
