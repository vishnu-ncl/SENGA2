...
!
MODULE MATH_KERNEL_EQAA_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: math_kernel_eqAA
...
subroutine math_kernel_eqAA_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine math_kernel_eqAA_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine math_kernel_eqAA_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 212, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(math_kernel_eqAA_host_execute))
end subroutine
#endif
