...
& opsArg3)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 3, 516, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqE_host_execute))
