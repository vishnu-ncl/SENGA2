...
!
MODULE SET_ZERO_KERNEL_MD_INT_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: set_zero_kernel_MD_int
...
subroutine set_zero_kernel_MD_int_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& dat1_base, &
& dat2_base, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine set_zero_kernel_MD_int_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2)
  IMPLICIT NONE
...
#else
subroutine set_zero_kernel_MD_int_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
  ...
  integer, POINTER, DIMENSION(:) :: opsDat1Local
  ...
  call set_zero_kernel_MD_int_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & dat1_base, &
  & dat2_base, &
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 5, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(set_zero_kernel_MD_int_host_execute))
end subroutine
#endif
