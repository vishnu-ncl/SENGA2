...
SUBROUTINE dfbydy_kernel_main(functn, fderiv, nyglbl, nendyl, nendyr, nbound, idx)
    ...
    integer, intent(in) :: nyglbl, nendyl, nendyr, nbound
    integer, dimension(3), intent(in) :: idx
    integer :: jc, jstart, jfinis
...
subroutine dfbydy_kernel_main_host_execute( descPtr )
  ...
  call setKernelTime(12,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(12,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 12, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(dfbydy_kernel_main_host_execute))
end subroutine
#endif
