...
!  Set from kernel descriptor
  ...
  call setKernelTime(482,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(482,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg16)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 16, 482, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bountt_kernel_eqC_zdir_host_execute))
