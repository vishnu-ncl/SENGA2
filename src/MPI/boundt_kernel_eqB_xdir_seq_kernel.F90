...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 486, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundt_kernel_eqB_xdir_host_execute))
