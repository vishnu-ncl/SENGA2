...
MODULE SET_ZERO_KERNEL_MD6_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: set_zero_kernel_MD6
...
subroutine set_zero_kernel_MD6_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& dat1_base, &
& dat2_base, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine set_zero_kernel_MD6_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2)
...
#else
subroutine set_zero_kernel_MD6_host_execute( descPtr )
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 525, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(set_zero_kernel_MD6_host_execute))
