...
SUBROUTINE bounds_kernel_outflowBC1_eval_yl(yrhs,stryyl,bcl5yl,ova2yl)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 380, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_outflowBC1_eval_yl_host_execute))
