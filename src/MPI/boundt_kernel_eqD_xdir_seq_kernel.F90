...
& opsArg3)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 3, 489, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundt_kernel_eqD_xdir_host_execute))
