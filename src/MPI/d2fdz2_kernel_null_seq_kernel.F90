...
!  Set from kernel descriptor
  ...
  call setKernelTime(13,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call setKernelTime(13,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg1)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 1, 13, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdz2_kernel_null_host_execute))
