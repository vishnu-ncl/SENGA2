...
SUBROUTINE bounds_kernel_inflowBC1_eval_xl(erhs,yrhs,bclyxl,strhxl,stryxl,strdxl,bcl2xl,bcl5xl,ova2xl)
    use data_types
    implicit none
...
!  Set from kernel descriptor
  ...
  call setKernelTime(339,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(339,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg9)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 9, 339, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC1_eval_xl_host_execute))
