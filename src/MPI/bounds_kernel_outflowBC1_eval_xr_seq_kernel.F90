...
SUBROUTINE bounds_kernel_outflowBC1_eval_xr(yrhs,stryxr,bcl1xr,ova2xr)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 356, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_outflowBC1_eval_xr_host_execute))
