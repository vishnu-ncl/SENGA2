...
subroutine dfbydy_kernel_null_host_execute( descPtr )
  ...
  call setKernelTime(11,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call setKernelTime(11,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg1)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 1, 11, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(dfbydy_kernel_null_host_execute))
end subroutine
#endif
