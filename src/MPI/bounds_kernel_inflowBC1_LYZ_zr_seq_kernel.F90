...
SUBROUTINE bounds_kernel_inflowBC1_LYZ_zr(bclyzr,ratezr,strwzr,strdzr)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 448, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC1_LYZ_zr_host_execute))
