...
!  Set from kernel descriptor
  ...
  call setKernelTime(328,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(328,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 328, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_reduced_enthalpy_xdir_host_execute))
