...
!  Set from kernel descriptor
  ...
  call setKernelTime(321,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call setKernelTime(321,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 321, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bcut_kernel_xdir_eqD_host_execute))
