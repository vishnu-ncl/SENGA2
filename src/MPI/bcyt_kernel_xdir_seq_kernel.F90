...
SUBROUTINE bcyt_kernel_xdir(stryx,dydtx,yrin,ispec)
    ...
    stryx(OPS_ACC_MD1(ispec,0,0,0)) = yrin(ispec)
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 333, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bcyt_kernel_xdir_host_execute))
end subroutine
#endif
