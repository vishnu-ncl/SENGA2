...
SUBROUTINE bounds_kernel_wallBC2_eval_yl(yrhs,stryyl,bcl2yl,bcl5yl,ova2yl)
    use data_types
    implicit none
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 398, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_eval_yl_host_execute))
