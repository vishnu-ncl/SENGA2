...
!
MODULE D2FDXY_KERNEL_RH_YDIR_CORNER_EQT_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: d2fdxy_kernel_rh_ydir_corner_eqT


SUBROUTINE d2fdxy_kernel_rh_ydir_corner_eqT(functn, fderiv, nxglbl, nyglbl, idx)
    use data_types
    implicit none
    ...
    integer, intent(in) :: nxglbl, nyglbl
...
subroutine d2fdxy_kernel_rh_ydir_corner_eqT_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
  ...
  DO n_z = 1, end(3)-start(3)+1
    ...
    DO n_y = 1, end(2)-start(2)+1
      ...
      DO n_x = 1, end(1)-start(1)+1
        ...
        call d2fdxy_kernel_rh_ydir_corner_eqT( &
...
!host subroutine
#ifndef OPS_LAZY
subroutine d2fdxy_kernel_rh_ydir_corner_eqT_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4, &
...
#else
subroutine d2fdxy_kernel_rh_ydir_corner_eqT_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
  ...
  call setKernelTime(76,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  call d2fdxy_kernel_rh_ydir_corner_eqT_wrap( &
  & opsDat1Local, &
  & opsDat2Local, &
  & opsDat3Local, &
  & opsDat4Local, &
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(76,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 76, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdxy_kernel_rh_ydir_corner_eqT_host_execute))
end subroutine
#endif
