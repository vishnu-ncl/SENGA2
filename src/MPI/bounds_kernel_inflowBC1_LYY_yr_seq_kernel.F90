...
SUBROUTINE bounds_kernel_inflowBC1_LYY_yr(bclyyr,rateyr,strvyr,strdyr)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 403, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_inflowBC1_LYY_yr_host_execute))
