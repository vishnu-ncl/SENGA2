...
!
MODULE FLAMIN_KERNEL_EQF_MODULE
...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: flamin_kernel_eqF
...
subroutine flamin_kernel_eqF_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& opsDat4Local, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine flamin_kernel_eqF_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3, &
& opsArg4)
...
#else
subroutine flamin_kernel_eqF_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 517, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(flamin_kernel_eqF_host_execute))
end subroutine
#endif
