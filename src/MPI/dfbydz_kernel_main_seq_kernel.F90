...
& opsArg7)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 7, 14, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(dfbydz_kernel_main_host_execute))
end subroutine
#endif
