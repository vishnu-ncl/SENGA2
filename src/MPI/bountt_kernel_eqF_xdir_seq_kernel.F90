...
subroutine bountt_kernel_eqF_xdir_host_execute( descPtr )
  ...
  call setKernelTime(474,userSubroutine,0.0_8,0.0_8,0.0_4,1)
...
& opsArg17)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 17, 474, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bountt_kernel_eqF_xdir_host_execute))
end subroutine
#endif
