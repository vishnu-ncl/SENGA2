...
SUBROUTINE boundt_kernel_eqE_ydir(strty,itndex,tinthi,ntint)
    use data_types
    implicit none
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 479, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundt_kernel_eqE_ydir_host_execute))
end subroutine
#endif
