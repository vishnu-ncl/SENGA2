...
SUBROUTINE bcyt_kernel_zdir(stryz,dydtz,yrin,ispec)
    ...
    stryz(OPS_ACC_MD1(ispec,0,0,0)) = yrin(ispec)
...
subroutine bcyt_kernel_zdir_host_execute( descPtr )
  ...
  call setKernelTime(335,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(335,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg4)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 4, 335, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bcyt_kernel_zdir_host_execute))
end subroutine
#endif
