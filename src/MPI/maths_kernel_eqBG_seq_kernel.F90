...
& opsArg11)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 11, 231, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(maths_kernel_eqBG_host_execute))
