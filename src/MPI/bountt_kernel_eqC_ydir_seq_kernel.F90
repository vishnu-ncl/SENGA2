...
& end_indx )
  ...
  integer(4) :: dat6_base
  real(kind=8), dimension(*), intent(inout) :: opsDat7Local
  integer(4) :: dat7_base
  real(kind=8), dimension(*), intent(inout) :: opsDat8Local
  integer(4) :: dat8_base
  real(kind=8), dimension(*), intent(inout) :: opsDat9Local
  integer(4) :: dat9_base
  real(kind=8), dimension(*), intent(inout) :: opsDat10Local
  integer(4) :: dat10_base
  real(kind=8), dimension(*), intent(inout) :: opsDat11Local
  integer(4) :: dat11_base
  real(kind=8), dimension(*), intent(inout) :: opsDat12Local
...
!  Set from kernel descriptor
  ...
  call setKernelTime(475,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(475,userSubroutine,t3-t2,t2-t1,transfer_total,0)
...
& opsArg16)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 16, 475, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bountt_kernel_eqC_ydir_host_execute))
