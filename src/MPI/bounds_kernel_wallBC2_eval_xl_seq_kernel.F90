...
SUBROUTINE bounds_kernel_wallBC2_eval_xl(yrhs,stryxl,bcl2xl,bcl5xl,ova2xl)
    use data_types
    implicit none
...
& opsArg5)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 5, 353, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_wallBC2_eval_xl_host_execute))
