...
subroutine d2fdxy_kernel_rh_ydir_corner_eqR_host_execute( descPtr )
  ...
  call setKernelTime(74,userSubroutine,0.0_8,0.0_8,0.0_4,1)
  ...
  transfer_total = transfer_total + transfer
  call setKernelTime(74,userSubroutine,t3-t2,t2-t1,transfer_total,0)
end subroutine
...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 74, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(d2fdxy_kernel_rh_ydir_corner_eqR_host_execute))
end subroutine
#endif
