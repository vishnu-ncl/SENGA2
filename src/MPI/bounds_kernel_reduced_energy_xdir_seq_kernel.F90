...
& opsArg6)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 6, 337, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(bounds_kernel_reduced_energy_xdir_host_execute))
end subroutine
#endif
