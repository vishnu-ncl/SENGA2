...
& opsArg2)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 2, 236, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(boundary_kernel_speciesH_ydir_host_execute))
