...
!user function
!DEC$ ATTRIBUTES FORCEINLINE :: math_kernel_eqK
...
subroutine math_kernel_eqK_wrap( &
& opsDat1Local, &
& opsDat2Local, &
& opsDat3Local, &
& dat1_base, &
...
!host subroutine
#ifndef OPS_LAZY
subroutine math_kernel_eqK_host( userSubroutine, block, dim, range, &
& opsArg1, &
& opsArg2, &
& opsArg3)
  IMPLICIT NONE
...
#else
subroutine math_kernel_eqK_host_execute( descPtr )
  use iso_c_binding
  IMPLICIT NONE
...
& opsArg3)
  ...
  call create_kerneldesc_and_enque(userSubroutine//c_null_char, c_loc(opsArgArray), 3, 301, dim, 0, c_loc(range_tmp), block%blockCptr, c_funloc(math_kernel_eqK_host_execute))
end subroutine
#endif
