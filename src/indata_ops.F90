...
SUBROUTINE indata
  ...
  use MATH_KERNEL_EQAM_MODULE
  use MATH_MD_KERNEL_EQT_MODULE
  use MATH_KERNEL_EQAN_MODULE
  use MATH_MD_KERNEL_EQPP_MODULE
  use MATH_KERNEL_EQU_MODULE
  use MATH_KERNEL_EQT_MODULE
  use MATH_MD_KERNEL_EQAC_MODULE
  use MATH_MD_KERNEL_EQAD_MODULE
  use MATH_KERNEL_EQAO_MODULE
  use MATH_MD_KERNEL_EQU_MODULE
  use MATH_MD_KERNEL_EQB_MODULE
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqAM_host("A = A + var", senga_grid, 3, rangexyz, &
    ...
    DO ispec = 1,nspec
        rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
        call math_MD_kernel_eqT_host("A_multidim = var", senga_grid, 3, rangexyz, &
    ...
    call math_kernel_eqAN_host("A = var", senga_grid, 3, rangexyz, &
    ...
    DO ispec = 1,nspec
        rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
        call math_MD_kernel_eqPP_host("A = A + var(d)*B_multidim", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1-nhalox,nxglbl+nhalox,1-nhaloy,nyglbl+nhaloy,1-nhaloz,nzglbl+nhaloz/)
    call math_MD_kernel_eqAC_host("INTERNAL ENERGY FIELD", senga_grid, 3, rangexyz, &
    ...
    DO ispec = 1,nspec
        ...
        rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
        call math_MD_kernel_eqAD_host("INITIALISE INTERNAL ENERGY", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqAO_host("A = A - B + half*(C*C+D*D+E*E)", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_erun, 1, s3d_000, "real(8)", OPS_INC), &
                      & ops_arg_dat(d_store1, 1, s3d_000, "real(8)", OPS_READ), &
    ...
    DO ispec = 1,nspec
        rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
        call math_MD_kernel_eqU_host("A_multidim = B*A_multidim", senga_grid, 3, rangexyz, &
