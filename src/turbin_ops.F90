...
! Auto-generated at 2026-04-28 18:43:09.618668 by ops-translator
SUBROUTINE turbin
  ...
  !   =========================================================================
  WRITE(*, '(a)') "Using the arrays not allocated by OPS,                         Please implement the function in OPS first, turbin.F90: ID=84"
  STOP
      ...
      DO jc = 1, nyglbl
        DO ic = 1, nxglbl
          ...
          flrank = (kc >= kgstal) .AND. (kc <= kgstol)
            ...
            WRITE(*, '(a)') "Using the arrays not allocated by OPS,                         Please implement the function in OPS first, turbin.F90: line number 190"
            STOP
    ...
    DO jc = 1, nysize
      DO ic = 1, nxsize
        ...
        IF (flagim) THEN
          ...
          WRITE(6, '(3I5,3(1PE12.4))') ic, jc, kc, utmp(ic, jc, kc), vtmp(ic, jc, kc), wtmp(ic, jc, kc)
        END IF
