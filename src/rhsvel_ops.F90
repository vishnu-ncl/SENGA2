...
SUBROUTINE rhsvel
  ...
  use MATH_KERNEL_EQJ_MODULE
  use BOUNDARY_KERNEL_VELDERIV_XDIR_MODULE
  use BOUNDARY_KERNEL_VELDERIV_YDIR_MODULE
  use BOUNDARY_KERNEL_VELDERIV_ZDIR_MODULE
  use MATH_KERNEL_EQQ_MODULE
  use MATH_KERNEL_EQAC_MODULE
  use MATH_KERNEL_GETVAL_MODULE
  use MATH_KERNEL_EQG_MODULE
  ...
  use MATH_KERNEL_EQAG_MODULE
  use MATH_KERNEL_EQAF_MODULE
  use MATH_KERNEL_EQC_MODULE
  use COPY_KERNEL_MODULE
  use MATH_KERNEL_EQK_MODULE
  use MATH_KERNEL_EQI_MODULE
  use MATH_KERNEL_EQP_MODULE
  use MATH_KERNEL_EQU_MODULE
  use MATH_KERNEL_EQN_MODULE
  use MATH_KERNEL_EQAE_MODULE
  use MATH_KERNEL_EQE_MODULE
  use MATH_KERNEL_EQX_MODULE
  use MATH_KERNEL_EQR_MODULE
  use MATH_KERNEL_EQO_MODULE
  use MATH_KERNEL_EQTAU_MODULE
  use MATH_KERNEL_EQB_MODULE
    ...
    call math_kernel_eqT_host("A=B/C", senga_grid, 3, rangexyz, &
    ...
    call math_kernel_eqJ_host("A=A+B", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqQ_host("A=B+C*D", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_store7, 1, s3d_000, "real(8)", OPS_WRITE), &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqAC_host("A = -half*(B+C)", senga_grid, 3, rangexyz, &
    ...
    call math_kernel_getval_host("Get value", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1-nhalox,nxglbl+nhalox,1-nhaloy,nyglbl+nhaloy,1-nhaloz,nzglbl+nhaloz/)
    call math_kernel_eqG_host("A = B-var", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_store7, 1, s3d_000, "real(8)", OPS_WRITE), &
                      & ops_arg_dat(d_prun, 1, s3d_000, "real(8)", OPS_READ), &
    ...
    call math_kernel_eqAG_host("A = A-B*C-D*E-F*G", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqAF_host("A = A-B*(C+D+E)", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_erhs, 1, s3d_000, "real(8)", OPS_INC), &
                      & ops_arg_dat(d_prun, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_store1, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_store2, 1, s3d_000, "real(8)", OPS_READ), &
    ...
    rangexyz = (/1-nhalox,nxglbl+nhalox,1-nhaloy,nyglbl+nhaloy,1-nhaloz,nzglbl+nhaloz/)
    call math_kernel_eqC_host("A = A*var", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqK_host("A=B+C", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_store6, 1, s3d_000, "real(8)", OPS_WRITE), &
                      & ops_arg_dat(d_store2, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_store3, 1, s3d_000, "real(8)", OPS_READ))

    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqI_host("A = var1*B-var2*A", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqP_host("A = A+B*C*D", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_erhs, 1, s3d_000, "real(8)", OPS_INC), &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqAE_host("A = A-half*B*C*D", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_urhs, 1, s3d_000, "real(8)", OPS_INC), &
                      & ops_arg_dat(d_drhs, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_vtmp, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_store1, 1, s3d_000, "real(8)", OPS_READ))
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqE_host("A = var*B*C", senga_grid, 3, rangexyz, &
    ...
    call math_kernel_eqX_host("A = A-B*C", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_erhs, 1, s3d_000, "real(8)", OPS_INC), &
                      & ops_arg_dat(d_utmp, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_store3, 1, s3d_000, "real(8)", OPS_READ))
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqR_host("A = A*B+C*D", senga_grid, 3, rangexyz, &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqO_host("A = A+B*C*C", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_erhs, 1, s3d_000, "real(8)", OPS_INC), &
                      & ops_arg_dat(d_transp, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_store7, 1, s3d_000, "real(8)", OPS_READ))
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqtau_host("TAU", senga_grid, 3, rangexyz, &
                      & ops_arg_dat(d_urhs, 1, s3d_000, "real(8)", OPS_INC), &
                      & ops_arg_dat(d_erhs, 1, s3d_000, "real(8)", OPS_INC), &
                      & ops_arg_dat(d_transp, 1, s3d_000, "real(8)", OPS_READ), &
                      & ops_arg_dat(d_store1, 1, s3d_000, "real(8)", OPS_READ), &
    ...
    rangexyz = (/1,nxglbl,1,nyglbl,1,nzglbl/)
    call math_kernel_eqB_host("A = -B", senga_grid, 3, rangexyz, &
