...
C     ==========
      ...
      INTEGER ICM4,ICM3,ICM2,ICM1,ICP1,ICP2,ICP3,ICP4
      INTEGER JCM4,JCM3,JCM2,JCM1,JCP1,JCP2,JCP3,JCP4
...
C       TENTH ORDER EXPLICIT DIFFERENCES
        DO JC = JSTART,JFINIS
          DO IC = ISTART,IFINIS
            ...
            FDIFFA = FUNCTN(IC+1,JC+1,KC) - FUNCTN(IC+1,JC-1,KC) 
     +             - FUNCTN(IC-1,JC+1,KC) + FUNCTN(IC-1,JC-1,KC) 
            FDIFFB = FUNCTN(IC+2,JC+2,KC) - FUNCTN(IC+2,JC-2,KC) 
     +             - FUNCTN(IC-2,JC+2,KC) + FUNCTN(IC-2,JC-2,KC) 
            FDIFFC = FUNCTN(IC+3,JC+3,KC) - FUNCTN(IC+3,JC-3,KC) 
     +             - FUNCTN(IC-3,JC+3,KC) + FUNCTN(IC-3,JC-3,KC) 
            FDIFFD = FUNCTN(IC+4,JC+4,KC) - FUNCTN(IC+4,JC-4,KC) 
     +             - FUNCTN(IC-4,JC+4,KC) + FUNCTN(IC-4,JC-4,KC) 
            FDIFFE = FUNCTN(IC+5,JC+5,KC) - FUNCTN(IC+5,JC-5,KC) 
     +             - FUNCTN(IC-5,JC+5,KC) + FUNCTN(IC-5,JC-5,KC) 
...
C           LH POINT: 4TH ORDER ONE-SIDED/CENTRED
            FDIFFA =
     +          ACOFY1*(FUNCTN(ISTAP1,JC+1,KC) - FUNCTN(ISTAP1,JC-1,KC)
     +                - FUNCTN(ISTAL,JC+1,KC)  + FUNCTN(ISTAL,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTAP1,JC+2,KC) - FUNCTN(ISTAP1,JC-2,KC)
     +                - FUNCTN(ISTAL,JC+2,KC)  + FUNCTN(ISTAL,JC-2,KC))
            FDIFFB =
     +          ACOFY1*(FUNCTN(ISTAP2,JC+1,KC) - FUNCTN(ISTAP2,JC-1,KC)
     +                - FUNCTN(ISTAL,JC+1,KC)  + FUNCTN(ISTAL,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTAP2,JC+2,KC) - FUNCTN(ISTAP2,JC-2,KC)
     +                - FUNCTN(ISTAL,JC+2,KC)  + FUNCTN(ISTAL,JC-2,KC))
            FDIFFC =
     +          ACOFY1*(FUNCTN(ISTAP3,JC+1,KC) - FUNCTN(ISTAP3,JC-1,KC)
     +                - FUNCTN(ISTAL,JC+1,KC)  + FUNCTN(ISTAL,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTAP3,JC+2,KC) - FUNCTN(ISTAP3,JC-2,KC)
     +                - FUNCTN(ISTAL,JC+2,KC)  + FUNCTN(ISTAL,JC-2,KC))
            FDIFFD =
     +          ACOFY1*(FUNCTN(ISTAP4,JC+1,KC) - FUNCTN(ISTAP4,JC-1,KC)
     +                - FUNCTN(ISTAL,JC+1,KC)  + FUNCTN(ISTAL,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTAP4,JC+2,KC) - FUNCTN(ISTAP4,JC-2,KC)
     +                - FUNCTN(ISTAL,JC+2,KC)  + FUNCTN(ISTAL,JC-2,KC))
...
C           LH POINT PLUS 1: 4TH ORDER MIXED/CENTRED
            FDIFFA =
     +          ACOFY1*(FUNCTN(ISTAL,JC+1,KC)  - FUNCTN(ISTAL,JC-1,KC)
     +                - FUNCTN(ISTAP1,JC+1,KC) + FUNCTN(ISTAP1,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTAL,JC+2,KC)  - FUNCTN(ISTAL,JC-2,KC)
     +                - FUNCTN(ISTAP1,JC+2,KC) + FUNCTN(ISTAP1,JC-2,KC))
            FDIFFB =
     +          ACOFY1*(FUNCTN(ISTAP2,JC+1,KC) - FUNCTN(ISTAP2,JC-1,KC)
     +                - FUNCTN(ISTAP1,JC+1,KC) + FUNCTN(ISTAP1,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTAP2,JC+2,KC) - FUNCTN(ISTAP2,JC-2,KC)
...
C           LH POINT PLUS 2: 4TH ORDER CENTRED
            FDIFFA = FUNCTN(ISTAP3,JC+1,KC) - FUNCTN(ISTAP3,JC-1,KC) 
     +             - FUNCTN(ISTAP1,JC+1,KC) + FUNCTN(ISTAP1,JC-1,KC) 
            FDIFFB = FUNCTN(ISTAP4,JC+2,KC) - FUNCTN(ISTAP4,JC-2,KC) 
     +             - FUNCTN(ISTAL,JC+2,KC)  + FUNCTN(ISTAL,JC-2,KC) 
            FDERIV(ISTAP2,JC,KC) = ACF3XY*FDIFFA
     +                           + BCF3XY*FDIFFB

C           LH POINT PLUS 3: 6TH ORDER CENTRED
            FDIFFA = FUNCTN(ISTAP4,JC+1,KC) - FUNCTN(ISTAP4,JC-1,KC) 
     +             - FUNCTN(ISTAP2,JC+1,KC) + FUNCTN(ISTAP2,JC-1,KC) 
            FDIFFB = FUNCTN(ISTAP5,JC+2,KC) - FUNCTN(ISTAP5,JC-2,KC) 
     +             - FUNCTN(ISTAP1,JC+2,KC) + FUNCTN(ISTAP1,JC-2,KC) 
            FDIFFC = FUNCTN(ISTAP6,JC+3,KC) - FUNCTN(ISTAP6,JC-3,KC) 
     +             - FUNCTN(ISTAL,JC+3,KC)  + FUNCTN(ISTAL,JC-3,KC) 
            FDERIV(ISTAP3,JC,KC) = ACF4XY*FDIFFA
     +                           + BCF4XY*FDIFFB
     +                           + CCF4XY*FDIFFC

C           LH POINT PLUS 4: 8TH ORDER CENTRED
            FDIFFA = FUNCTN(ISTAP5,JC+1,KC) - FUNCTN(ISTAP5,JC-1,KC) 
     +             - FUNCTN(ISTAP3,JC+1,KC) + FUNCTN(ISTAP3,JC-1,KC) 
            FDIFFB = FUNCTN(ISTAP6,JC+2,KC) - FUNCTN(ISTAP6,JC-2,KC) 
     +             - FUNCTN(ISTAP2,JC+2,KC) + FUNCTN(ISTAP2,JC-2,KC) 
            FDIFFC = FUNCTN(ISTAP7,JC+3,KC) - FUNCTN(ISTAP7,JC-3,KC) 
     +             - FUNCTN(ISTAP1,JC+3,KC) + FUNCTN(ISTAP1,JC-3,KC) 
            FDIFFD = FUNCTN(ISTAP8,JC+4,KC) - FUNCTN(ISTAP8,JC-4,KC) 
     +             - FUNCTN(ISTAL,JC+4,KC)  + FUNCTN(ISTAL,JC-4,KC) 
...
C           RH POINT MINUS 4: 8TH ORDER CENTRED
            FDIFFA = FUNCTN(ISTOM3,JC+1,KC) - FUNCTN(ISTOM3,JC-1,KC) 
     +             - FUNCTN(ISTOM5,JC+1,KC) + FUNCTN(ISTOM5,JC-1,KC) 
            FDIFFB = FUNCTN(ISTOM2,JC+2,KC) - FUNCTN(ISTOM2,JC-2,KC) 
     +             - FUNCTN(ISTOM6,JC+2,KC) + FUNCTN(ISTOM6,JC-2,KC) 
            FDIFFC = FUNCTN(ISTOM1,JC+3,KC) - FUNCTN(ISTOM1,JC-3,KC) 
     +             - FUNCTN(ISTOM7,JC+3,KC) + FUNCTN(ISTOM7,JC-3,KC) 
            FDIFFD = FUNCTN(ISTOL,JC+4,KC)  - FUNCTN(ISTOL,JC-4,KC) 
     +             - FUNCTN(ISTOM8,JC+4,KC) + FUNCTN(ISTOM8,JC-4,KC) 
...
C           RH POINT MINUS 3: 6TH ORDER CENTRED
            FDIFFA = FUNCTN(ISTOM2,JC+1,KC) - FUNCTN(ISTOM2,JC-1,KC) 
     +             - FUNCTN(ISTOM4,JC+1,KC) + FUNCTN(ISTOM4,JC-1,KC) 
            FDIFFB = FUNCTN(ISTOM1,JC+2,KC) - FUNCTN(ISTOM1,JC-2,KC) 
     +             - FUNCTN(ISTOM5,JC+2,KC) + FUNCTN(ISTOM5,JC-2,KC) 
            FDIFFC = FUNCTN(ISTOL,JC+3,KC)  - FUNCTN(ISTOL,JC-3,KC) 
     +             - FUNCTN(ISTOM6,JC+3,KC) + FUNCTN(ISTOM6,JC-3,KC) 
            FDERIV(ISTOM3,JC,KC) = ACF4XY*FDIFFA
     +                           + BCF4XY*FDIFFB
     +                           + CCF4XY*FDIFFC
      
C           RH POINT MINUS 2: 4TH ORDER CENTRED
            FDIFFA = FUNCTN(ISTOM1,JC+1,KC) - FUNCTN(ISTOM1,JC-1,KC) 
     +             - FUNCTN(ISTOM3,JC+1,KC) + FUNCTN(ISTOM3,JC-1,KC) 
            FDIFFB = FUNCTN(ISTOL,JC+2,KC)  - FUNCTN(ISTOL,JC-2,KC) 
     +             - FUNCTN(ISTOM4,JC+2,KC) + FUNCTN(ISTOM4,JC-2,KC) 
            FDERIV(ISTOM2,JC,KC) = ACF3XY*FDIFFA
     +                           + BCF3XY*FDIFFB
      
C           RH POINT MINUS 1: 4TH ORDER MIXED/CENTRED
            FDIFFA =
     +          ACOFY1*(FUNCTN(ISTOM1,JC+1,KC) - FUNCTN(ISTOM1,JC-1,KC)
     +                - FUNCTN(ISTOL,JC+1,KC)  + FUNCTN(ISTOL,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTOM1,JC+2,KC) - FUNCTN(ISTOM1,JC-2,KC)
     +                - FUNCTN(ISTOL,JC+2,KC)  + FUNCTN(ISTOL,JC-2,KC))
            FDIFFB =
     +          ACOFY1*(FUNCTN(ISTOM1,JC+1,KC) - FUNCTN(ISTOM1,JC-1,KC)
     +                - FUNCTN(ISTOM2,JC+1,KC) + FUNCTN(ISTOM2,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTOM1,JC+2,KC) - FUNCTN(ISTOM1,JC-2,KC)
     +                - FUNCTN(ISTOM2,JC+2,KC) + FUNCTN(ISTOM2,JC-2,KC))
            FDIFFC =
     +          ACOFY1*(FUNCTN(ISTOM1,JC+1,KC) - FUNCTN(ISTOM1,JC-1,KC)
     +                - FUNCTN(ISTOM3,JC+1,KC) + FUNCTN(ISTOM3,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTOM1,JC+2,KC) - FUNCTN(ISTOM1,JC-2,KC)
     +                - FUNCTN(ISTOM3,JC+2,KC) + FUNCTN(ISTOM3,JC-2,KC))
            FDIFFD =
     +          ACOFY1*(FUNCTN(ISTOM1,JC+1,KC) - FUNCTN(ISTOM1,JC-1,KC)
     +                - FUNCTN(ISTOM4,JC+1,KC) + FUNCTN(ISTOM4,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTOM1,JC+2,KC) - FUNCTN(ISTOM1,JC-2,KC)
...
C           RH POINT: 4TH ORDER ONE-SIDED/CENTRED
            FDIFFA =
     +          ACOFY1*(FUNCTN(ISTOL,JC+1,KC)  - FUNCTN(ISTOL,JC-1,KC)
     +                - FUNCTN(ISTOM1,JC+1,KC) + FUNCTN(ISTOM1,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTOL,JC+2,KC)  - FUNCTN(ISTOL,JC-2,KC)
     +                - FUNCTN(ISTOM1,JC+2,KC) + FUNCTN(ISTOM1,JC-2,KC))
            FDIFFB =
     +          ACOFY1*(FUNCTN(ISTOL,JC+1,KC)  - FUNCTN(ISTOL,JC-1,KC)
     +                - FUNCTN(ISTOM2,JC+1,KC) + FUNCTN(ISTOM2,JC-1,KC))
     +        + BCOFY1*(FUNCTN(ISTOL,JC+2,KC)  - FUNCTN(ISTOL,JC-2,KC)
